...
#region Fields
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\music\\c03_intra1_01_mus", 3822912103U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_01_fol", 3822977640U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2010_mr3", 3823043177U), marine_01.Entity, 1F);
        ...
        public async Task c03_2020_mr4()
        {
            ...
            await sleep(200);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2020_mr4", 3823108714U), marine_02.Entity, 1F);
        ...
        {
            await sleep(278);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2030_mr4", 3823174251U), marine_02.Entity, 1F);
        ...
        public async Task c03_intra1_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\music\\c03_intra1_01_mus", 3822912103U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_01_fol", 3822977640U));
            wake(new ScriptMethodReference(c03_intra1_problem_actors));
            await sleep(this.prediction_offset);
            await this.c03_intra1_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_01", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_01", false, anchor_intra1.Entity);
            custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_01", false, anchor_intra1.Entity);
            custom_animation_relative(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_01", false, anchor_intra1.Entity);
            custom_animation_relative(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_01", false, anchor_intra1.Entity);
            custom_animation_relative(pelican_01a.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intra1\\03_intra1", 3823501936U), "pelican_01", false, anchor_intra1.Entity);
            scenery_animation_start_relative(scarab_01.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\03_intra1\\03_intra1", 3823567473U), "scarab_01", anchor_intra1.Entity);
            await sleep(45);
            fade_in(1F, 1F, 1F, 15);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_02a_fol", 3823633010U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_02a_fol", 3823633010U), default(IGameObject), 1F);
        ...
        {
            await sleep(115);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2040_jon", 3823698547U), johnson.Entity, 1F);
        ...
        {
            await sleep(161);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2050_mr4", 3823764084U), marine_02.Entity, 1F);
        ...
        {
            await sleep(200);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2060_mr3", 3823829621U), marine_01.Entity, 1F);
        ...
        {
            await sleep(288);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2070_jon", 3823895158U), johnson.Entity, 1F);
        ...
        {
            await sleep(328);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2080_mr3", 3823960695U), marine_01.Entity, 1F);
        ...
        {
            await sleep(370);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2090_jon", 3824026232U), johnson.Entity, 1F);
        ...
        public async Task c03_intra1_scene_02a()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_02a", default(IUnit), anchor_flag_intra1);
            custom_animation_relative_loop(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02a", false, anchor_intra1.Entity);
            custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02a", false, anchor_intra1.Entity);
            custom_animation_relative_loop(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02a", false, anchor_intra1.Entity);
            custom_animation_relative_loop(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02a", false, anchor_intra1.Entity);
            custom_animation_relative(pelican_01a.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intra1\\03_intra1", 3823501936U), "pelican_02a", false, anchor_intra1.Entity);
            custom_animation_relative_loop(scorpion_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\scorpion\\03_intra1\\03_intra1", 3824091769U), "scorpion_02a", false, anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            custom_animation_relative_loop(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02b_easy", false, anchor_intra1.Entity);
            custom_animation_relative_loop(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02b", false, anchor_intra1.Entity);
            custom_animation_relative_loop(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02b", false, anchor_intra1.Entity);
            custom_animation_relative_loop(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02b", false, anchor_intra1.Entity);
            await sleep(5);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2097_jon", 3824157306U), default(IGameObject), 1F);
        ...
        public async Task c03_intra1_speech_normal()
        {
            ...
            custom_animation_relative_loop(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02b", false, anchor_intra1.Entity);
            await sleep(5);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2091_jon", 3824222843U), default(IGameObject), 1F);
        ...
        public async Task c03_intra1_speech_heroic()
        {
            ...
            custom_animation_relative_loop(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02b", false, anchor_intra1.Entity);
            await sleep(5);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2093_jon", 3824288380U), default(IGameObject), 1F);
        ...
        public async Task c03_intra1_speech_legendary()
        {
            ...
            custom_animation_relative_loop(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02b", false, anchor_intra1.Entity);
            await sleep(5);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2095_jon", 3824353917U), default(IGameObject), 1F);
        ...
        public async Task c03_intra1_scene_02b()
        {
            ...
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_02c_fol", 3824419454U));
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_02c_fol", 3824419454U), default(IGameObject), 1F);
        ...
        {
            await sleep(4);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2092_jon", 3824484991U), johnson.Entity, 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2094_jon", 3824550528U), johnson.Entity, 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2096_jon", 3824616065U), johnson.Entity, 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2098_jon", 3824681602U), johnson.Entity, 1F);
        ...
        {
            await sleep(81);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2100_mr4", 3824747139U), marine_02.Entity, 1F);
        ...
        {
            await sleep(119);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2110_jon", 3824812676U), johnson.Entity, 1F);
        ...
        {
            await sleep(235);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2120_jon", 3824878213U), johnson.Entity, 1F);
        ...
        {
            await sleep(301);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2130_mr4", 3824943750U), marine_02.Entity, 1F);
        ...
        {
            await sleep(352);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2140_cor", 3825009287U), default(IGameObject), 1F, "radio_default_in");
        ...
        {
            await sleep(366);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2140_cor", 3825009287U), default(IGameObject), 1F, "radio_default_loop");
            cinematic_subtitle("c03_2140_cor", 3F);
        }
        ...
        public async Task c03_intra1_scene_02c()
        {
            ...
            if (GameDifficulty.Easy() == game_difficulty_get_real())
            {
                ...
                camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_02ce", default(IUnit), anchor_flag_intra1);
                custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02ce", false, anchor_intra1.Entity);
                custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02ce", false, anchor_intra1.Entity);
                custom_animation_relative(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02ce", false, anchor_intra1.Entity);
                custom_animation_relative(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02ce", false, anchor_intra1.Entity);
                scenery_animation_start_relative(cigar.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_good\\03_intra1\\03_intra1", 3825074824U), "cigar_02e", anchor_intra1.Entity);
            }
            ...
            if (GameDifficulty.Normal() == game_difficulty_get_real())
            {
                ...
                wake(new ScriptMethodReference(c03_2140_cor));
                wake(new ScriptMethodReference(c03_intra1_foley_02c));
                camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_02cn", default(IUnit), anchor_flag_intra1);
                custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02cn", false, anchor_intra1.Entity);
                custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02cn", false, anchor_intra1.Entity);
                custom_animation_relative(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02cn", false, anchor_intra1.Entity);
                custom_animation_relative(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02cn", false, anchor_intra1.Entity);
                scenery_animation_start_relative(cigar.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_good\\03_intra1\\03_intra1", 3825074824U), "cigar_02n", anchor_intra1.Entity);
            }
            ...
            if (GameDifficulty.Heroic() == game_difficulty_get_real())
            {
                ...
                wake(new ScriptMethodReference(c03_2140_cor));
                wake(new ScriptMethodReference(c03_intra1_foley_02c));
                camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_02ch", default(IUnit), anchor_flag_intra1);
                custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02ch", false, anchor_intra1.Entity);
                custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02ch", false, anchor_intra1.Entity);
                custom_animation_relative(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02ch", false, anchor_intra1.Entity);
                custom_animation_relative(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02ch", false, anchor_intra1.Entity);
                scenery_animation_start_relative(cigar.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_good\\03_intra1\\03_intra1", 3825074824U), "cigar_02h", anchor_intra1.Entity);
            }
            ...
            if (GameDifficulty.Legendary() == game_difficulty_get_real())
            {
                ...
                wake(new ScriptMethodReference(c03_intra1_foley_02c));
                camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_02cl", default(IUnit), anchor_flag_intra1);
                custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intra1\\03_intra1", 3823305325U), "chief_02cl", false, anchor_intra1.Entity);
                custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_02cl", false, anchor_intra1.Entity);
                custom_animation_relative(marine_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine01_02cl", false, anchor_intra1.Entity);
                custom_animation_relative(marine_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "marine02_02cl", false, anchor_intra1.Entity);
                scenery_animation_start_relative(cigar.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_good\\03_intra1\\03_intra1", 3825074824U), "cigar_02l", anchor_intra1.Entity);
            }
            ...
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_03_fol", 3825140361U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intra1\\foley\\c03_intra1_03_fol", 3825140361U), default(IGameObject), 1F);
        ...
        {
            await sleep(59);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_2150_jon", 3825205898U), johnson.Entity, 1F);
        ...
        public async Task c03_intra1_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intra1\\03_intra1", 3823239788U), "03_intra1_03", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intra1\\03_intra1", 3823370862U), "johnson_03", false, anchor_intra1.Entity);
            custom_animation_relative(pelican_01b.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intra1\\03_intra1", 3823501936U), "pelican_03", false, anchor_intra1.Entity);
            scenery_animation_start_relative(rear_gun.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\03_intra1\\03_intra1", 3825271435U), "rear_gun_03", anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - 15));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_01_fol", 3825336972U), default(IGameObject), 1F);
        ...
        {
            await sleep(484);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0010_jon", 3825402509U), johnson.Entity, 1F, "radio_default");
        ...
        {
            await sleep(552);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0020_mir", 3825468046U), default(IGameObject), 1F, "radio_default");
        ...
        public async Task effect_scarab_death()
        {
            await sleep(27);
            print("blow main-gun");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion_mouth", 3825533583U), scarab_02.Entity, "primary_trigger");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "head_destroyed_cine");
            await sleep(2);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "neck_destroyed_cine");
            await sleep(3);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "neck_destroyed2_cine");
            await sleep(5);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "knee_destroyed_cine");
            await sleep(2);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "belly_destroyed_cine");
            await sleep(3);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "calf_destroyed_cine");
            await sleep(5);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_death_explosion", 3827172008U), scarab_02.Entity, "knee_destroyed02_cine");
        }
        ...
        public async Task x03_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_01_fol", 3825336972U));
            await sleep(this.prediction_offset);
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_01", default(IUnit), anchor_flag_x03_01);
            await this.x03_01_setup();
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x03\\x03", 3827303082U), "chief_01", false, anchor_x03_01.Entity);
            custom_animation_relative(johnson_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "johnson_01", false, anchor_x03_01.Entity);
            custom_animation_relative(pilot.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "pilot_01", false, anchor_x03_01.Entity);
            custom_animation_relative(pelican_01a.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\x03\\x03", 3827434156U), "pelican_01", false, anchor_x03_01.Entity);
            scenery_animation_start_relative(scarab_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\x03\\x03", 3827499693U), "scarab_01", anchor_x03_01.Entity);
            scenery_animation_start_relative(carrier.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_01", anchor_x03_01.Entity);
            await sleep(15);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_02_fol", 3827630767U));
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_02_fol", 3827630767U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0030_mir", 3827696304U), miranda.Entity, 1F);
        ...
        {
            await sleep(73);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0040_jon", 3827761841U), johnson_03.Entity, 1F, "radio_default");
        ...
        {
            await sleep(106);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0050_lhd", 3827827378U), hood.Entity, 1F, "radio_default");
        ...
        {
            await sleep(133);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0060_mir", 3827892915U), miranda.Entity, 1F);
        ...
        public async Task x03_texture_camera_scene_02()
        {
            ...
            scenery_animation_start_relative(texture_camera.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\x03\\x03", 3827958452U), "texture_camera_02", anchor_x03_02.Entity);
        }
        ...
        public async Task x03_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_02", default(IUnit), anchor_flag_x03_02);
            custom_animation_relative(miranda.Entity, GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x03\\x03", 3828023989U), "miranda_02", false, anchor_x03_02.Entity);
            custom_animation_relative(johnson_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "johnson_02", false, anchor_x03_02.Entity);
            custom_animation_relative(pilot_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "pilot_02", false, anchor_x03_02.Entity);
            custom_animation_relative(hood.Entity, GetTag<AnimationGraphTag>("objects\\characters\\lord_hood\\x03\\x03", 3832546042U), "hood_02", false, anchor_x03_02.Entity);
            custom_animation_relative(pelican_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\x03\\x03", 3827434156U), "pelican_02", false, anchor_x03_02.Entity);
            scenery_animation_start_relative(iac_bridge.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x03\\x03", 3832677116U), "iacbridge_02", anchor_x03_02.Entity);
            await sleep(20);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x03_03_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\music\\x03_03_mus", 3832742653U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_03_fol", 3832808190U));
            await sleep((short)((float)camera_time() - 15));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\music\\x03_03_mus", 3832742653U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_03_fol", 3832808190U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0070_lhd", 3832873727U), default(IGameObject), 1F, "radio_default");
        ...
        {
            await sleep(50);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0080_lhd", 3832939264U), default(IGameObject), 1F, "radio_default");
        ...
        {
            await sleep(195);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0090_nv1", 3833004801U), default(IGameObject), 1F);
        ...
        public async Task effect_slipspace_open()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\03\\slipspace_open", 3833070338U), carrier_02.Entity, "bow");
        }
        ...
        public async Task x03_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_03", default(IUnit), anchor_flag_x03_02);
            scenery_animation_start_relative(iac.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x03\\x03", 3833791245U), "iac_03", anchor_x03_02.Entity);
            scenery_animation_start_relative(carrier_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_03", anchor_x03_02.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x03_04_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_04_fol", 3833856782U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_04_fol", 3833856782U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0100_nv1", 3833922319U), nav_officer.Entity, 1F);
        ...
        public async Task x03_0110_mir()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0110_mir", 3833987856U), miranda.Entity, 1F);
        ...
        {
            await sleep(175);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0120_lhd", 3834053393U), hood.Entity, 1F, "radio_default");
        ...
        public async Task x03_texture_camera_scene_04()
        {
            ...
            object_create_anew(texture_camera);
            texture_camera_set_object_marker(texture_camera.Entity, "marker", 50F);
            scenery_animation_start_relative(texture_camera.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\x03\\x03", 3827958452U), "texture_camera_04", anchor_x03_02.Entity);
        }
        ...
        public async Task x03_scene_04()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_04", default(IUnit), anchor_flag_x03_02);
            custom_animation_relative(miranda.Entity, GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x03\\x03", 3828023989U), "miranda_04", false, anchor_x03_02.Entity);
            custom_animation_relative(hood.Entity, GetTag<AnimationGraphTag>("objects\\characters\\lord_hood\\x03\\x03", 3832546042U), "hood_04", false, anchor_x03_02.Entity);
            custom_animation_relative(nav_officer.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "nav_04", false, anchor_x03_02.Entity);
            scenery_animation_start_relative(iac_bridge.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x03\\x03", 3832677116U), "iacbridge_04", anchor_x03_02.Entity);
            scenery_animation_start_relative(carrier_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_04", anchor_x03_02.Entity);
            await sleep(10);
            fade_in(1F, 1F, 1F, 5);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x03_05_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_05_fol", 3834118930U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_05_fol", 3834118930U), default(IGameObject), 1F);
        ...
        {
            await sleep(94);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0130_mir", 3834184467U), default(IGameObject), 1F);
        ...
        public async Task effect_iac_engines()
        {
            await sleep(112);
            print("effect - engine");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\03\\iac_engine_fire", 3834250004U), iac.Entity, "");
        }
        ...
        {
            await sleep(0);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\03\\slipspace_widening", 3834577689U), carrier_02.Entity, "bow");
        ...
        public async Task x03_scene_05()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_05", default(IUnit), anchor_flag_x03_02);
            custom_animation_relative(pelican_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\x03\\x03", 3827434156U), "pelican_05", false, anchor_x03_02.Entity);
            scenery_animation_start_relative(iac.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x03\\x03", 3833791245U), "iac_05", anchor_x03_02.Entity);
            scenery_animation_start_relative(carrier_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_05", anchor_x03_02.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x03_06_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_06_fol", 3834643226U));
            await sleep((short)((float)camera_time() - 5));
            fade_out(1F, 1F, 1F, 5);
            await sleep(5);
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_06_fol", 3834643226U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0140_nv1", 3834708763U), nav_officer.Entity, 1F);
        ...
        {
            await sleep(55);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\x03_0150_mir", 3834774300U), miranda.Entity, 1F);
        ...
        public async Task x03_texture_camera_scene_06()
        {
            ...
            object_create_anew(texture_camera);
            texture_camera_set_object_marker(texture_camera.Entity, "marker", 50F);
            scenery_animation_start_relative(texture_camera.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\x03\\x03", 3827958452U), "texture_camera_06", anchor_x03_02.Entity);
        }
        ...
        public async Task x03_scene_06()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_06", default(IUnit), anchor_flag_x03_02);
            custom_animation_relative(miranda.Entity, GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x03\\x03", 3828023989U), "miranda_06", false, anchor_x03_02.Entity);
            custom_animation_relative(nav_officer.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x03\\x03", 3827368619U), "nav_06", false, anchor_x03_02.Entity);
            scenery_animation_start_relative(iac_bridge.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x03\\x03", 3832677116U), "iacbridge_06", anchor_x03_02.Entity);
            scenery_animation_start_relative(carrier_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_06", anchor_x03_02.Entity);
            await sleep(10);
            fade_in(1F, 1F, 1F, 5);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x03_07_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_07_fol", 3834839837U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\x03\\foley\\x03_07_fol", 3834839837U), default(IGameObject), 1F);
        ...
        public async Task x03_scene_07()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_07", default(IUnit), anchor_flag_x03_02);
            scenery_animation_start_relative(iac.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x03\\x03", 3833791245U), "iac_07", anchor_x03_02.Entity);
            scenery_animation_start_relative(carrier_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x03\\x03", 3827565230U), "carrier_07", anchor_x03_02.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        public async Task x03_scene_08()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x03\\x03", 3827237545U), "x03_08", default(IUnit), anchor_flag_x03_03);
            scenery_animation_start_relative(x03_bus.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\civilian\\bus\\x03\\x03", 3834905374U), "bus_08", anchor_x03_03.Entity);
            scenery_animation_start_relative(x03_truck.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\civilian\\panel_truck\\x03\\x03", 3834970911U), "panel_truck_08", anchor_x03_03.Entity);
            scenery_animation_start_relative(x03_generator.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\earthcity\\streetobjects\\streetobj_big_generator\\x03\\x03", 3835036448U), "big_generator_08", anchor_x03_03.Entity);
            scenery_animation_start_relative(x03_dumpster.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\earthcity\\streetobjects\\streetobj_dumpster\\x03\\x03", 3835101985U), "dumpster_08", anchor_x03_03.Entity);
            await sleep(10);
            fade_in(1F, 1F, 1F, 5);
            await sleep((short)((float)camera_time() - 5));
            fade_out(0F, 0F, 0F, 5);
        ...
        public async Task music_03b_01_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_01", 2246124551U));
        }
        ...
        public async Task music_03b_01_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_01", 2246124551U), true);
        }
        ...
        public async Task music_03b_01_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_01", 2246124551U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03b_02_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_02", 2246910995U));
        }
        ...
        public async Task music_03b_02_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_02", 2246910995U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03b_03_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_03", 2247304217U));
        }
        ...
        public async Task music_03b_03_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_03", 2247304217U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03b_04_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_04", 2247828513U));
        }
        ...
        public async Task music_03b_04_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_04", 2247828513U), true);
        }
        ...
        public async Task music_03b_04_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\03b_newmombasa\\03b_music\\03b_04", 2247828513U), default(IGameObject), 1F);
        }
        ...
        public async Task cs_e23_cov_inf1_pilot_exit()
        {
            ...
            custom_animation(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4084732417U), "scarab_d_r:any:any:exit", true);
        ...
        public async Task cs_e23_cov_inf1_pilot0()
        {
            ...
            custom_animation_loop(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4084732417U), "scarab_d_r:any:any:idle:var0", false);
        ...
        public async Task e18_key()
        {
            ...
            object_create(key);
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 2169053062U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 2169053062U)));
        ...
        public async Task cs_e17_mars_inf0_drive()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4250278804U), ai_vehicle_get(this.ai_current_actor), 1.5F);
            await sleep(5);
            sound_looping_stop(GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4250278804U));
            await sleep(5);
            sound_looping_start(GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4250278804U), ai_vehicle_get(this.ai_current_actor), 1.5F);
            await sleep(15);
            sound_looping_stop(GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4250278804U));
        ...
        public async Task cs_e17_shotgun_scene()
        {
            ...
            await sleep_until(async () => !(unit_has_weapon(ai_get_unit(this.ai_current_actor), GetTag<BaseTag>("objects\\weapons\\rifle\\shotgun\\shotgun.weapon", 2164596546U))) || objects_distance_to_object(players(), ai_get_object(this.ai_current_actor)) > 5F, 15, this.one_minute);
        }
        ...
        {
            if ((short)ai_living_count(e15_mars_inf0.Squad) > 1 && !(unit_has_weapon(ai_get_unit(this.ai_current_actor), GetTag<BaseTag>("objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher.weapon", 2160992011U))))
            {
                await sleep(30);
                ai_vehicle_exit(this.ai_current_actor);
            }
        ...
        {
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 55);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 56);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 57);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 59);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 60);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 4);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 5);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 6);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bridge\\bridge", 3787784271U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 20);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 29);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 22);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 23);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_booth\\toll_booth", 3841983370U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_booth\\toll_booth", 3841983370U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_booth\\toll_booth", 3841983370U), 4);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_barrier\\toll_barrier", 3844932535U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_booth\\toll_booth", 3841983370U), 3);
            await sleep(4);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_scarab_full\\holo_scarab_full", 3844998072U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_road_signal\\sign_road_signal", 3845850053U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3847095256U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_b\\concrete_chunk_b", 3847357404U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3848602607U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 74);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 69);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3848864755U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3848864755U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3848864755U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3848864755U), 19);
            await sleep(15);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\turrets\\cannon\\cannon", 3850175495U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\turrets\\cannon\\cannon", 3850175495U), 13);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 1);
            await sleep(74);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_3b"), 4, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3851158550U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 87);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 99);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 89);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 90);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 91);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 92);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 93);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 94);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 95);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 96);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\scorpion", 3852534827U), 97);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\turrets\\cannon\\cannon", 3850175495U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\scorpion\\turrets\\cannon\\cannon", 3850175495U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3854042178U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3854042178U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_cone\\road_cone", 3854763085U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\crush_barrel\\crush_barrel\\crush_barrel", 3855156307U), 0);
            await sleep(31);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 2);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 20);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 29);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 1);
            await sleep(17);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\multi\\zanzibar\\dumpster\\dumpster", 3855811677U), 0);
            await sleep(83);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_3b"), 11, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 16);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 17);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 18);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 19);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 20);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 21);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 22);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 23);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 24);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 25);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 26);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 27);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 28);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 29);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 30);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3856073825U), 31);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_scarab_full\\holo_scarab_full", 3844998072U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_main_gun\\scarab_main_gun", 3857384565U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_rear_gun\\scarab_rear_gun", 3857712250U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3858039935U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3847095256U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3858105472U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\bridge_light_mid_garb\\bridge_light_mid_garb", 3858564231U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\bridge_light_brace_garb\\bridge_light_brace_garb", 3858826379U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3858105472U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\industrial\\crate_tech\\crate_tech", 3858891916U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\uberchassis\\uberchassis", 3859219601U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3860137119U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\uberchassis\\uberchassis", 3859219601U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\bridge_light\\bridge_light", 3860268193U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\bridge_light\\bridge_light", 3860268193U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\h_semi_trailer\\h_semi_trailer", 3860661415U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\human\\urban\\air\\air", 3861185711U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\human\\urban\\air\\air", 3861185711U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\bridge_light_lit_garb\\bridge_light_lit_garb", 3861382322U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_street_arch\\sign_street_arch", 3861513396U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\industrial\\crate_tech_giant\\crate_tech_giant", 3861710007U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\tire\\tire", 3861775544U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\uberchassis\\uberchassis_tire\\uberchassis_tire", 3862037692U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\pallet\\pallet", 3862103229U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\crate_packing_giant\\crate_packing_giant", 3862365377U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\crate_packing\\crate_packing", 3862561988U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\drum_55gal\\drum_55gal", 3862758599U), 0);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_3b"), 38, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\weapons\\smg\\smg", 3862955210U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3847095256U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 1);
            await sleep(1);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\h_semi_trailer\\h_semi_trailer", 3860661415U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 2);
            await sleep(4);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\bridge_light_mid_garb\\bridge_light_mid_garb", 3858564231U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\pallet\\pallet", 3862103229U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\crate_packing_giant\\crate_packing_giant", 3862365377U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\crate_packing\\crate_packing", 3862561988U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3840934778U), 25);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_h\\concrete_chunk_h", 3863282895U), 0);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_b\\concrete_chunk_b", 3847357404U), 0);
        }
        ...
        public async Task _03_intra1_02a_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\crush_barrel\\crush_barrel\\crush_barrel", 3855156307U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_j\\concrete_chunk_j", 3863348432U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_barrier\\toll_barrier", 3844932535U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\toll_booth\\toll_booth", 3841983370U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 2);
            await sleep(75);
        ...
        public async Task _03_intra1_02c_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3855418455U), 2);
            await sleep(35);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\cigar\\cigar_good\\cigar_good", 3863545043U), 0);
        }
        ...
        public async Task _03_intra1_03_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3854042178U), 1);
            await sleep(11);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\streetobjects\\streetobj_trashcan\\streetobj_trashcan", 3863872728U), 0);
        }
        ...
        public async Task x03_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_rear_gun\\scarab_rear_gun", 3857712250U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3858039935U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3864134876U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\powerups\\rocket_launcher_ammo\\rocket_launcher_ammo", 3864462561U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\vent_wall_a\\vent_wall_a", 3864855783U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\case_ap_turret\\case_ap_turret", 3865117931U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\human\\military\\case\\case", 3865314542U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3789422696U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3865511153U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\fixed\\h_turret_mp\\h_turret_mp", 3866559745U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\powerups\\shotgun_ammo\\shotgun_ammo", 3866821893U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\powerups\\battle_rifle_ammo\\battle_rifle_ammo", 3808821648U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3867149578U), 2);
            ...
            await sleep(10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 71);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 66);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 57);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 59);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 60);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 69);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 1);
        }
        ...
        public async Task x03_02_predict()
        {
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3871212872U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 71);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 66);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 6);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 69);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3835167522U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\lord_hood\\lord_hood", 3874227574U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\lord_hood\\lord_hood", 3874227574U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3851158550U), 3);
            await sleep(5);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788832863U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788832863U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788832863U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788832863U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788832863U), 4);
            await sleep(1);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 2, false);
            await sleep(104);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad\\inamberclad", 3875014018U), 0);
        }
        ...
        public async Task x03_04_predict()
        {
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3869771058U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3875997073U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3875997073U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3875997073U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3871212872U), 0);
            await sleep(2);
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 0, false);
        ...
        public async Task x03_07_predict()
        {
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 74, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 75, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3876324758U), 0);
            await sleep(21);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 43, true);
            await sleep(10);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 4, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3876324758U), 0);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\effects\\slipspace_shockwave_start\\slipspace_shockwave_start", 3876390295U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3847095256U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3876980128U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hor_facade\\sign_hor_facade", 3877176739U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\streetobjects\\streetobj_big_generator\\streetobj_big_generator", 3877373350U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\streetobjects\\streetobj_dumpster\\streetobj_dumpster", 3878356405U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3858105472U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 0);
        ...
        {
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\effects\\slipspace_shockwave_closeup\\slipspace_shockwave_closeup", 3879470534U), 0);
            await sleep(72);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3858105472U), 2);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 1);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\civilian\\bus\\bus", 3847881700U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3876324758U), 0);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\effects\\slipspace_shockwave\\slipspace_shockwave", 3879667145U), 0);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 65, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 51, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 43, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 75, true);
