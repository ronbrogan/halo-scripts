...
#region Fields
        ...
        public scnr_08a_deltacliffs(IScriptEngine scriptEngine)
        {
            ...
            this.g_e10_pod_impact_effect = GetTag<EffectTag>("effects\\scenarios\\solo\\earthcity\\e11_insertion_pod_impact", 4276886689U);
            ...
            this.g_e1_pod_impact_effect = GetTag<EffectTag>("effects\\scenarios\\solo\\earthcity\\e11_insertion_pod_impact", 4276886689U);
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intro\\foley\\c08_intro_01_fol", 3822781029U), default(IGameObject), 1F);
        ...
        public async Task effect_teleport()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\gameplay\\cinematic_teleport", 3822846566U), teleport.Entity, "marker");
        }
        ...
        public async Task c08_intro()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intro\\foley\\c08_intro_01_fol", 3822781029U));
            await sleep(100);
            await this.c08_intro_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intro\\08_intro", 3823501936U), "08_intro_01", default(IUnit), anchor_flag_intro);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intro\\08_intro", 3823567473U), "dervish_01", false, anchor_intro.Entity);
            fade_in(0F, 0F, 0F, 30);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_01_fol", 3823698547U), default(IGameObject), 1F);
        ...
        {
            await sleep(461);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2010_soc", 3823764084U), commander.Entity, 1F);
        ...
        public async Task c08_intra1_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_01_fol", 3823698547U));
            await sleep(this.prediction_offset);
            await this.c08_intra1_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra1\\08_intra1", 3823829621U), "08_intra1_01", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(dervish_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra1\\08_intra1", 3823895158U), "dervish_01", false, anchor_intra1.Entity);
            custom_animation_relative(commander.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\08_intra1\\08_intra1", 3823960695U), "commander_01", false, anchor_intra1.Entity);
            custom_animation_relative(wraith_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\wraith\\08_intra1\\08_intra1", 3824091769U), "wraith_01", false, anchor_intra1.Entity);
            fade_in(1F, 1F, 1F, 15);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\music\\c08_intra1_02_mus", 3824157306U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_02_fol", 3824222843U));
        ...
        {
            await sleep(337);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\music\\c08_intra1_02_mus", 3824157306U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_02_fol", 3824222843U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2020_der", 3824288380U), dervish_01.Entity, 1F);
        ...
        {
            await sleep(77);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2030_soc", 3824353917U), commander.Entity, 1F);
        ...
        public async Task c08_intra1_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra1\\08_intra1", 3823829621U), "08_intra1_02", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(dervish_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra1\\08_intra1", 3823895158U), "dervish_02", false, anchor_intra1.Entity);
            custom_animation_relative(commander.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\08_intra1\\08_intra1", 3823960695U), "commander_02", false, anchor_intra1.Entity);
            custom_animation_relative(wraith_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\wraith\\08_intra1\\08_intra1", 3824091769U), "wraith_02", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\08_intra1\\08_intra1", 3824419454U), "phantom01_02", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\08_intra1\\08_intra1", 3824419454U), "phantom02_02", false, anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._08_intra1_03_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_03_fol", 3824484991U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_03_fol", 3824484991U), default(IGameObject), 1F);
        ...
        {
            await sleep(268);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2040_tar", 3824550528U), tartarus.Entity, 1F);
        ...
        public async Task c08_intra1_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra1\\08_intra1", 3823829621U), "08_intra1_03", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra1\\08_intra1", 3824616065U), "tartarus_03", false, anchor_intra1.Entity);
            custom_animation_relative(miranda.Entity, GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra1\\08_intra1", 3824747139U), "miranda_03", false, anchor_intra1.Entity);
            custom_animation_relative(monitor.Entity, GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra1\\08_intra1", 3829531340U), "monitor_03", false, anchor_intra1.Entity);
            custom_animation_relative(brute_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra1\\08_intra1", 3824616065U), "brute01_03", false, anchor_intra1.Entity);
            custom_animation_relative(brute_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra1\\08_intra1", 3824616065U), "brute02_03", false, anchor_intra1.Entity);
            custom_animation_relative(brute_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra1\\08_intra1", 3824616065U), "brute03_03", false, anchor_intra1.Entity);
            custom_animation_relative(brute_04.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra1\\08_intra1", 3824616065U), "brute04_03", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\08_intra1\\08_intra1", 3824419454U), "phantom01_03", false, anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        ...
        public async Task music_08a_01_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_01", 4274396283U));
        }
        ...
        public async Task music_08a_01_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_01", 4274396283U), true);
        }
        ...
        public async Task music_08a_01_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_01", 4274396283U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08a_02_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_02", 4275182727U));
        }
        ...
        public async Task music_08a_02_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_02", 4275182727U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08a_03_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_03", 4275575949U));
        }
        ...
        {
            print("music 08a_01 start alt");
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_03", 4275575949U), true);
        }
        ...
        public async Task music_08a_03_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_03", 4275575949U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08a_04_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_04", 4276362393U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08a_05_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\08a_deltacliffs\\08a_music\\08a_05", 4276624541U), default(IGameObject), 1F);
        }
        ...
        {
            return unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher.weapon", 4175500973U));
        }
        ...
        public async Task e10_key()
        {
            ...
            object_create(key);
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4193261500U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4193261500U)));
        ...
        public async Task cs_e1_pro_inf0_1_patrol0()
        {
            ...
            await sleep(30);
            custom_animation(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\brute\\brute", 4052422487U), "patrol:any:any:posing:var1", true);
        ...
        {
            custom_animation_loop(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3985181526U), "combat:unarmed:mortal_wound", false);
        ...
        public async Task cs_e1_stealth_major_scene()
        {
            ...
            custom_animation(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3985181526U), "combat:sword:posing:var1", true);
            ...
            custom_animation(ai_get_unit(this.ai_current_actor), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3985181526U), "combat:sword:posing:var4", true);
        ...
        public async Task e1_pro_inf1_main()
        {
            ...
            if ((short)ai_living_count(e1_pro_inf1.Squad) > 0 && (short)ai_living_count(e1_pro_inf0) > 0)
            {
                if (this.g_e1_pro_inf1_was_alerted)
                {
                    ...
                    ;
                    await sleep(20);
                    custom_animation(ai_get_unit(e1_pro_inf1.brute0), GetTag<AnimationGraphTag>("objects\\characters\\brute\\brute", 4052422487U), "combat:support:hold", true);
        ...
        public async Task e1_cov_inf0_main()
        {
            ...
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3921807436U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3921807436U)), 10, this.one_minute);
            await sleep(20);
        ...
        public async Task _08_intro_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3830448858U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 23);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3836937021U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3830383321U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 4);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom", 3783000070U), 5);
            await sleep(9);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 44, true);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3837657928U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3837657928U), 10);
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 0);
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 131, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 138, false);
            await sleep(6);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3839492964U), 0);
            await sleep(4);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 43, true);
            await sleep(24);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 138, false);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\lightfixture_outdoor_toughy\\lightfixture_outdoor_toughy", 3839820649U), 0);
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 138, false);
            await sleep(20);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 118, false);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 1);
            await sleep(45);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 65, false);
            await sleep(93);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 22, false);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 43, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 44, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redalder\\redalder_m\\redalder_m", 3837461317U), 2);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 25, false);
            await sleep(15);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\invisible_box1x2x2\\invisible_box1x2x2", 3840213871U), 0);
            await sleep(5);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 24, true);
            await sleep(8);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 3, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 0);
            await sleep(6);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3840476019U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3840476019U), 1);
            await sleep(29);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 34, false);
            await sleep(39);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 21, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 22, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 3);
            await sleep(46);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 21, false);
            await sleep(4);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 34, false);
        ...
        public async Task _08_intra1_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redalder\\redalder_s\\redalder_s", 3836871484U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3836937021U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_low\\brute_shot\\projectiles\\grenade\\grenade", 3841524611U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\brute_plasma_rifle\\brute_plasma_rifle", 3841983370U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\brute_plasma_rifle\\brute_plasma_rifle", 3841983370U), 0);
            await sleep(1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 25, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 6, true);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_maple\\maple\\maple", 3842573203U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3830383321U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 32);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 66);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 67);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 68);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 69);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 70);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 71);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 72);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\minigun\\minigun", 3844277165U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3844342702U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3844342702U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3836937021U), 2);
            await sleep(80);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 2);
            await sleep(30);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 3);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 71);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3842966425U), 72);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\minigun\\minigun", 3844277165U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3844342702U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3844342702U), 9);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3831038691U), 27);
        ...
        public async Task _08_intra1_02_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3830383321U), 1);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3844735924U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3844735924U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3844735924U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3844735924U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3844735924U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 7);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redalder\\redalder_saplingm\\redalder_saplingm", 3837526854U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 1);
            await sleep(3);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3785162791U), 1);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 4);
            await sleep(12);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 2);
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 53, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3836937021U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 1);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 53, false);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3836937021U), 1);
            await sleep(21);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3845456831U), 4);
            await sleep(66);
        ...
        public async Task _08_intra1_03_predict()
        {
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 18, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 11, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 28);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 29);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 40);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 36);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 37);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 33);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3847947237U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3848668144U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3848668144U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 35);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3845522368U), 34);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3829596877U), 1);
            await sleep(154);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\08a_deltacliffs\\deltacontrolroom_bsp0"), 23, false);
            await sleep(21);
