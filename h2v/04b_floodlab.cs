...
#region Fields
        ...
        public scnr_04b_floodlab(IScriptEngine scriptEngine)
        {
            ...
            this.stress = Engine.GetTag<EffectTag>("effects\\scenery\\sparks\\sparking_light", 4159378871U);
            this.boom = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\wall_explosion", 4159509945U);
            this.gravity = 0F;
            ...
            this.cable_var = 0;
            this.gasleak = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\gas_leak", 3892905619U);
            this.big_boom = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\wall_explosion", 4159509945U);
            ...
            this.holo_death = Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_death", 3901097744U);
        ...
        {
            Engine.wake(new ScriptMethodReference(_04_outro2_01_predict));
        }

        [ScriptMethod(31, Lifecycle.Static)]
        public async Task _04_outro2_02_predict_stub()
        {
            Engine.wake(new ScriptMethodReference(_04_outro2_02_predict));
        }
        ...
        public async Task c04_intra0_score_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\music\\c04_intra0_01_mus", 3854959696U), default(IGameObject), 1F);
        ...
        public async Task c04_intra0_foley_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\foley\\c04_intra0_01_fol", 3855025233U), default(IGameObject), 1F);
        ...
        public async Task c04_1230_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_1230_der", 3855090770U), dervish_intra0.Entity, 1F);
        ...
        public async Task c04_1240_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_1240_soc", 3855156307U), commander_intra0.Entity, 1F);
        ...
        public async Task c04_intra0_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_intra0_score_01));
            Engine.wake(new ScriptMethodReference(c04_intra0_foley_01));
            Engine.wake(new ScriptMethodReference(c04_1230_der));
            Engine.wake(new ScriptMethodReference(c04_1240_soc));
            Engine.wake(new ScriptMethodReference(soc_blade_activate));
            Engine.wake(new ScriptMethodReference(c04_intra0_cinematic_light_01));
        }
        ...
        public async Task c04_intra0()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\music\\c04_intra0_01_mus", 3854959696U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\foley\\c04_intra0_01_fol", 3855025233U));
            await Engine.sleep(this.prediction_offset);
            await this.c04_intra0_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra0\\04_intra0", 3855221844U), "04_intra0", default(IUnit), anchor_flag_intra0);
            Engine.custom_animation_relative(dervish_intra0.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra0\\04_intra0", 3855287381U), "dervish", false, anchor_intra0.Entity);
            Engine.custom_animation_relative(commander_intra0.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "commander", false, anchor_intra0.Entity);
            Engine.custom_animation_relative(elite_intra0_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "elite01", false, anchor_intra0.Entity);
            Engine.custom_animation_relative(elite_intra0_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "elite02", false, anchor_intra0.Entity);
            Engine.custom_animation_relative(grunt_intra0_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\grunt\\04_intra0\\04_intra0", 3855549529U), "grunt01", false, anchor_intra0.Entity);
            Engine.custom_animation_relative(grunt_intra0_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\grunt\\04_intra0\\04_intra0", 3855549529U), "grunt02", false, anchor_intra0.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_01_fol", 3855615066U), default(IGameObject), 1F);
            Engine.print("c04_intra1 foley 01 start");
        }
        ...
        public async Task c04_2010_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2010_her", 3855680603U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_2020_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2020_her", 3855746140U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_2030_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2030_soc", 3855811677U), default(IGameObject), 1F);
        ...
        public async Task effect_shield_impact()
        {
            ...
            Engine.effect_new(Engine.GetTag<EffectTag>("effects\\impact\\impact_bullet_medium\\energy_shield_thin_cov", 3825402509U), flag_shield_impact);
        }
        ...
        public async Task c04_intra1_01_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_intra1_foley_01));
            Engine.wake(new ScriptMethodReference(c04_2010_her));
            Engine.wake(new ScriptMethodReference(c04_2020_her));
            Engine.wake(new ScriptMethodReference(c04_2030_soc));
            Engine.wake(new ScriptMethodReference(scale_hologram));
            Engine.wake(new ScriptMethodReference(effect_shield_impact));
            Engine.wake(new ScriptMethodReference(c04_intra1_cinematic_light_01));
        }
        ...
        public async Task c04_intra1_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_01_fol", 3855615066U));
            await Engine.sleep(this.prediction_offset);
            await this.c04_intra1_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra1\\04_intra1", 3855877214U), "04_intra1_01", default(IUnit), cinematic_anchor02);
            Engine.custom_animation_relative(dervish02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra1\\04_intra1", 3855942751U), "dervish_01", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_intra1\\04_intra1", 3856008288U), "heretic_01", false, anchor02.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_02_fol", 3856073825U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_02_fol", 3856073825U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2031_soc", 3856139362U), commander.Entity, 1F);
        ...
        public async Task c04_2040_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2040_soc", 3856204899U), commander.Entity, 1F);
        ...
        public async Task c04_2050_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2050_soc", 3856270436U), commander.Entity, 1F);
        ...
        public async Task c04_2060_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2060_der", 3856335973U), dervish02b.Entity, 1F);
        ...
        public async Task c04_2070_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2070_soc", 3856401510U), commander.Entity, 1F);
        ...
        public async Task c04_2080_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2080_der", 3856467047U), dervish02b.Entity, 1F);
        ...
        public async Task c04_2090_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2090_der", 3856532584U), dervish02b.Entity, 1F);
        ...
        {
            Engine.wake(new ScriptMethodReference(c04_intra1_foley_02));
            Engine.wake(new ScriptMethodReference(c04_2031_soc));
            Engine.wake(new ScriptMethodReference(c04_2040_soc));
            Engine.wake(new ScriptMethodReference(c04_2050_soc));
            Engine.wake(new ScriptMethodReference(c04_2060_der));
            Engine.wake(new ScriptMethodReference(c04_2070_soc));
            Engine.wake(new ScriptMethodReference(c04_2080_der));
            Engine.wake(new ScriptMethodReference(c04_2090_der));
            Engine.wake(new ScriptMethodReference(c04_intra1_cinematic_light_02));
        }
        ...
        public async Task c04_intra1_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra1\\04_intra1", 3855877214U), "04_intra1_02", default(IUnit), cinematic_anchor02);
            Engine.custom_animation_relative(dervish02b.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra1\\04_intra1", 3855942751U), "dervish_02", false, anchor02.Entity);
            Engine.custom_animation_relative(commander.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "soc_02", false, anchor02.Entity);
            Engine.custom_animation_relative(elite01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "elite01_02", false, anchor02.Entity);
            Engine.custom_animation_relative(elite02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "elite02_02", false, anchor02.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\music\\c04_outro1_01_mus", 3856663658U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_01_fol", 3856729195U), default(IGameObject), 1F);
        ...
        public async Task c04_3010_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3010_der", 3856794732U), dervish_03.Entity, 1F);
        ...
        public async Task c04_3020_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3020_her", 3856860269U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_3030_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3030_her", 3856925806U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_3040_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3040_der", 3856991343U), dervish_03.Entity, 1F);
        ...
        public async Task c04_outro1_01_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_outro1_score_01));
            Engine.wake(new ScriptMethodReference(c04_outro1_foley_01));
            Engine.wake(new ScriptMethodReference(c04_3010_der));
            Engine.wake(new ScriptMethodReference(c04_3020_her));
            Engine.wake(new ScriptMethodReference(c04_3030_her));
            Engine.wake(new ScriptMethodReference(c04_3040_der));
            Engine.wake(new ScriptMethodReference(c04_outro1_01_dof));
            Engine.wake(new ScriptMethodReference(c04_outro1_cinematic_light_01));
        }
        ...
        public async Task c04_outro1_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\music\\c04_outro1_01_mus", 3856663658U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_01_fol", 3856729195U));
            await Engine.sleep(this.prediction_offset);
            await this.c04_outro1_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_01", default(IUnit), anchor_flag_seraph);
            Engine.custom_animation_relative(dervish_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_01", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_01", false, anchor02.Entity);
            Engine.scenery_animation_start_relative(outro_seraph.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_01", anchor_seraph.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._04_outro1_02_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_02_fol", 3857319028U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_02_fol", 3857319028U), default(IGameObject), 1F);
        ...
        public async Task c04_3050_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3050_der", 3857384565U), dervish_03.Entity, 1F);
        ...
        public async Task c04_3060_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3060_gsp", 3857450102U), monitor.Entity, 1F);
        ...
        public async Task c04_3070_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3070_her", 3857515639U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_3080_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3080_gsp", 3857581176U), monitor.Entity, 1F);
        ...
        public async Task c04_outro1_02_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_outro1_foley_02));
            Engine.wake(new ScriptMethodReference(c04_3050_der));
            Engine.wake(new ScriptMethodReference(c04_3060_gsp));
            Engine.wake(new ScriptMethodReference(c04_3070_her));
            Engine.wake(new ScriptMethodReference(c04_3080_gsp));
            Engine.wake(new ScriptMethodReference(heretic_leader_fire_rifles));
            Engine.wake(new ScriptMethodReference(effect_jetpack));
        }
        ...
        public async Task c04_outro1_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_02", default(IUnit), anchor_flag_seraph);
            Engine.custom_animation_relative(dervish_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_02", false, anchor02.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro1\\04_outro1", 3857646713U), "monitor_02", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_02", false, anchor02.Entity);
            Engine.scenery_animation_start_relative(outro_seraph.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_02", anchor_seraph.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._04_outro1_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_03_fol", 3857712250U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_03_fol", 3857712250U), default(IGameObject), 1F);
            Engine.print("c04_outro1 foley 01 start");
        }
        ...
        public async Task c04_3090_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3090_her", 3857777787U), heretic_leader1.Entity, 1F);
        ...
        public async Task c04_3100_her()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3100_her", 3857843324U), heretic_leader1.Entity, 1F);
        ...
        public async Task effect_drone_activate()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), holo_drone_1.Entity, "light");
            Engine.print("effect - drone 1");
            await Engine.sleep(13);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), holo_drone_2.Entity, "light");
        ...
        public async Task effect_holograms_appear()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), holo_base_1.Entity, "marker");
            Engine.print("effect - hologram 1");
            await Engine.sleep(18);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), holo_base_2.Entity, "marker");
        ...
        public async Task c04_outro1_03_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_outro1_foley_03));
            Engine.wake(new ScriptMethodReference(c04_3090_her));
            Engine.wake(new ScriptMethodReference(c04_3100_her));
            Engine.wake(new ScriptMethodReference(arm_holograms));
            Engine.wake(new ScriptMethodReference(effect_drone_activate));
            Engine.wake(new ScriptMethodReference(effect_holograms_appear));
        }
        ...
        public async Task c04_outro1_03_holo1()
        {
            ...
            Engine.custom_animation_relative(hologram01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "holo1_03", false, anchor02.Entity);
        }
        ...
        public async Task c04_outro1_03_holo2()
        {
            ...
            Engine.custom_animation_relative(hologram02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "holo2_03", false, anchor02.Entity);
        }
        ...
        public async Task c04_outro1_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_03", default(IUnit), anchor_flag_seraph);
            Engine.custom_animation_relative(dervish_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_03", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_03", false, anchor02.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro1\\04_outro1", 3857646713U), "monitor_03", false, anchor02.Entity);
            Engine.scenery_animation_start_relative(outro_seraph.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_03", anchor_seraph.Entity);
            Engine.scenery_animation_start_relative(holo_drone_1.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3858629768U), "outro1_01", anchor02.Entity);
            Engine.scenery_animation_start_relative(holo_drone_2.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3858629768U), "outro1_02", anchor02.Entity);
            Engine.wake(new ScriptMethodReference(c04_outro1_03_holo1));
            Engine.wake(new ScriptMethodReference(c04_outro1_03_holo2));
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\music\\c04_outro2_01_mus", 3858695305U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_01_fol", 3858760842U), default(IGameObject), 1F);
        ...
        public async Task c04_9110_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9110_gsp", 3858826379U), monitor.Entity, 1F);
        ...
        public async Task c04_9120_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9120_der", 3858891916U), dervish_03.Entity, 1F);
        ...
        public async Task c04_9130_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9130_gsp", 3858957453U), monitor.Entity, 1F);
        ...
        public async Task effect_monitor_scramble()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\brute\\hammer_grappling", 3859022990U), monitor.Entity, "body");
        ...
        public async Task c04_outro2_01_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_outro2_score_01));
            Engine.wake(new ScriptMethodReference(c04_outro2_foley_01));
            Engine.wake(new ScriptMethodReference(c04_9110_gsp));
            Engine.wake(new ScriptMethodReference(c04_9120_der));
            Engine.wake(new ScriptMethodReference(c04_9130_gsp));
            Engine.wake(new ScriptMethodReference(effect_monitor_scramble));
            Engine.wake(new ScriptMethodReference(c04_outro2_cinematic_light_01));
        }
        ...
        public async Task c04_outro2_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\music\\c04_outro2_01_mus", 3858695305U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_01_fol", 3858760842U));
            await Engine.sleep(this.prediction_offset);
            await this.c04_outro2_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro2\\04_outro2", 3859350675U), "04_outro2_01", default(IUnit), cinematic_anchor02);
            Engine.custom_animation_relative(dervish_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro2\\04_outro2", 3859416212U), "dervish_01", false, anchor02.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro2\\04_outro2", 3859481749U), "monitor_01", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro2\\04_outro2", 3859547286U), "heretic_01", false, anchor02.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._04_outro2_02_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_02_fol", 3859612823U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_02_fol", 3859612823U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9140_gsp", 3859678360U), monitor.Entity, 1F);
        ...
        public async Task c04_9150_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9150_der", 3859743897U), dervish_03.Entity, 1F);
        ...
        public async Task c04_9160_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9160_tar", 3859809434U), tartarus.Entity, 1F);
        ...
        public async Task c04_9170_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9170_tar", 3859874971U), tartarus.Entity, 1F);
        ...
        public async Task effect_monitor_yank()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\monitor\\monitor_scrambled", 3859940508U), monitor.Entity, "body");
        }
        ...
        public async Task c04_outro2_02_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c04_outro2_foley_02));
            Engine.wake(new ScriptMethodReference(c04_9140_gsp));
            Engine.wake(new ScriptMethodReference(c04_9150_der));
            Engine.wake(new ScriptMethodReference(c04_9160_tar));
            Engine.wake(new ScriptMethodReference(c04_9170_tar));
            Engine.wake(new ScriptMethodReference(effect_monitor_yank));
            Engine.wake(new ScriptMethodReference(c04_outro2_cinematic_light_02));
        }
        ...
        public async Task c04_outro2_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro2\\04_outro2", 3859350675U), "04_outro2_02", default(IUnit), cinematic_anchor02);
            Engine.custom_animation_relative(dervish_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro2\\04_outro2", 3859416212U), "dervish_02", false, anchor02.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro2\\04_outro2", 3859481749U), "monitor_02", false, anchor02.Entity);
            Engine.custom_animation_relative(heretic_leader1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro2\\04_outro2", 3859547286U), "heretic_02", false, anchor02.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\04_outro2\\04_outro2", 3860006045U), "tartarus_02", false, anchor02.Entity);
            Engine.scenery_animation_start_relative(hammer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\04_outro2\\04_outro2", 3860137119U), "hammer_02", anchor02.Entity);
            Engine.custom_animation_relative(phantom_outro2.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\04_outro2\\04_outro2", 3860202656U), "phantom_02", false, anchor02.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(0F, 0F, 0F, 15);
            await Engine.sleep(15);
        ...
        public async Task music_04b_01_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_01", 4157347224U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_01_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_01", 4157347224U));
        }
        ...
        public async Task music_04b_02_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_02", 4157543835U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_02_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_02", 4157543835U));
        }
        ...
        public async Task music_04b_03_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_03_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), true);
        }
        ...
        public async Task music_04b_03_stop_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), false);
        }
        ...
        public async Task music_04b_03_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U));
        }
        ...
        public async Task music_04b_04_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_04_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), true);
        }
        ...
        public async Task music_04b_04_stop_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), false);
        }
        ...
        public async Task music_04b_04_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U));
        }
        ...
        public async Task music_04b_05_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_05", 4158330279U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_06_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_06", 4158461353U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_07_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_07", 4158657964U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_08_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_08_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U), true);
        }
        ...
        public async Task music_04b_08_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U));
        }
        ...
        public async Task revive_aware()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\combat\\elite_loose\\02_danger\\warn_fldreanimate", 4159247797U), Engine.list_get(Engine.ai_actors(allies_elites_03a.Squad), 0), 1F);
        ...
        public async Task spec_ops_reborn()
        {
            await Engine.sleep_until(async () =>
            {
                ...
                Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4146795767U), Engine.list_get(Engine.ai_actors(disposal_commander.Squad), 0), "");
                await Engine.sleep(30);
        ...
        public async Task disposal_chamber_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(juggernaut_abort));
            Engine.wake(new ScriptMethodReference(music_04b_01_start));
            ...
            await Engine.sleep(60);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), tennis_ball.Entity, "");
            await Engine.sleep_until(async () => Engine.device_get_position(tennis_ball.Entity) == 1F, 30, 450);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), tennis_ball.Entity, "light");
        ...
        public async Task elev_go()
        {
            ...
            Engine.wake(new ScriptMethodReference(silo_saving));
            Engine.wake(new ScriptMethodReference(music_04b_02_stop));
            ...
            Engine.wake(new ScriptMethodReference(music_04b_01_stop));
        ...
        public async Task silo_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(silo_killer));
            Engine.wake(new ScriptMethodReference(music_04b_02_start));
            await Engine.sleep_until(async () => Engine.volume_test_objects_all(vol_specimen_storage, Engine.players()) == true && await this.player_count() > 0);
            Engine.wake(new ScriptMethodReference(elev_go));
            Engine.wake(new ScriptMethodReference(silo_covers_invincible));
            Engine.wake(new ScriptMethodReference(silo_flood_spawner));
            ...
            this.silo_try_save = true;
            Engine.wake(new ScriptMethodReference(silo_hall_flood_spawner));
        ...
        public async Task famine_flavor()
        {
            ...
            Engine.custom_animation_loop(Engine.unit(Engine.list_get(Engine.ai_actors(famine_cf.Squad), 3)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3978234792U), "combat:thrash_front:var1", true);
            await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4052356969U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4052356969U)));
        ...
        public async Task research_arm_bsp_swap()
        {
            ...
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 0);
            Engine.wake(new ScriptMethodReference(airlock_commander_talk));
            await Engine.sleep(30);
        ...
        public async Task flood_lab_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(lab_barricades));
            if (await this.difficulty_legendary())
            {
                Engine.wake(new ScriptMethodReference(famine_flavor));
            }

            Engine.wake(new ScriptMethodReference(music_04b_03_start));
            ...
            this.lab_flood_count = 0;
            Engine.wake(new ScriptMethodReference(lab_wave_new_02));
            ...
            this.lab_flood_count = 0;
            Engine.wake(new ScriptMethodReference(lab_wave_new_01));
            ...
            Engine.wake(new ScriptMethodReference(fuck_this_turret_shit));
            Engine.wake(new ScriptMethodReference(music_04b_03_stop));
            ...
            Engine.wake(new ScriptMethodReference(research_arm_bsp_swap));
        }
        ...
        public async Task wind()
        {
            await Engine.sleep_until(async () =>
            {
                await Engine.sleep_until(async () =>
                {
                    Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\ambience\\sound_scenery\\gusty_wind\\details\\gusty_wind", 4159313334U), default(IGameObject), 1F);
        ...
        public async Task bridge_start()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(wraparound_right));
            Engine.wake(new ScriptMethodReference(wraparound_left));
            Engine.ai_renew(all_allies);
            Engine.wake(new ScriptMethodReference(bridge_phantom_go));
            Engine.wake(new ScriptMethodReference(bridge_reminder));
        ...
        public async Task commander_farewell()
        {
            ...
            Engine.cs_enable_moving(true);
            Engine.cs_enable_looking(true);
            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)))
            {
            ...
            else
            {
                ...
                await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || Engine.volume_test_objects(vol_control_middle, Engine.players()) == true, 30, 900);
            }
        }
        ...
        public async Task control_room_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(hl_killer));
            ...
            Engine.sleep_forever(new ScriptMethodReference(hologram_toggle));
            Engine.object_create_anew(gasmine_hologram);
            Engine.object_set_function_variable(gasmine_hologram.Entity, "holo_power", 1F, 0F);
            ...
            Engine.wake(new ScriptMethodReference(control_bug_out));
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_control_middle, Engine.players()) == true, 30, 1800);
            Engine.wake(new ScriptMethodReference(control_flood_spawn));
            ...
            Engine.wake(new ScriptMethodReference(music_04b_05_start));
            ...
            Engine.wake(new ScriptMethodReference(music_04b_04_stop));
        ...
        public async Task cable_invulnerable()
        {
            ...
            Engine.ai_dialogue_enable(true);
            await Engine.sleep(30);
            Engine.wake(new ScriptMethodReference(music_04b_06_start));
            await Engine.sleep_until(async () => this.cables_cuttable == true && Engine.device_get_position(cableroom.Entity) == 1F, 1);
            Engine.object_can_take_damage(real_cable_a.Entity);
            Engine.object_can_take_damage(real_cable_b.Entity);
            Engine.object_can_take_damage(real_cable_c.Entity);
        ...
        public async Task cableroom_commander_reminder()
        {
            ...
            if (Engine.object_get_health(real_cable_a.Entity) > 0F && Engine.object_get_health(real_cable_b.Entity) > 0F && Engine.object_get_health(real_cable_c.Entity) > 0F)
            {
                ...
                await Engine.sleep(30);
                Engine.wake(new ScriptMethodReference(cable_nav_a));
                Engine.wake(new ScriptMethodReference(cable_nav_b));
                Engine.wake(new ScriptMethodReference(cable_nav_c));
                await Engine.sleep(30);
                Engine.ai_dialogue_enable(true);
            }
        }
        ...
        public async Task cable_a_health()
        {
            ...
            if (this.cable_var == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\ambience\\alphagasgiant\\cable_snaps\\cable_snap_one", 4159706556U), default(IGameObject), 1F);
            ...
            if (this.cable_var == 3)
            {
                ...
                Engine.object_type_predict_high(Engine.GetTag<BaseTag>("scenarios\\objects\\solo\\alphagasgiant\\cable_room\\cable_room", 4060418020U));
                Engine.object_type_predict_high(Engine.GetTag<BaseTag>("scenarios\\objects\\solo\\alphagasgiant\\cable_room_top\\cable_room_top", 4065660980U));
                ...
                Engine.switch_bsp(4);
                Engine.wake(new ScriptMethodReference(cam_shake_cont));
                ...
                Engine.wake(new ScriptMethodReference(cableroom_suck_killer));
                Engine.wake(new ScriptMethodReference(cableroom_junk_spawn));
                Engine.object_create(suction);
                Engine.wake(new ScriptMethodReference(grav_test));
        ...
        public async Task croom_exit()
        {
            ...
            Engine.sleep_forever(new ScriptMethodReference(cableroom_killer));
            Engine.device_set_power(control_up_switch_01.Entity, 0F);
        ...
        public async Task cable_room_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(cable_a_health));
            Engine.wake(new ScriptMethodReference(cable_b_health));
            Engine.wake(new ScriptMethodReference(cable_c_health));
            Engine.wake(new ScriptMethodReference(cable_invulnerable));
            Engine.wake(new ScriptMethodReference(cable_flood_spawner));
            Engine.wake(new ScriptMethodReference(cable_sentinel_spawner));
            Engine.device_set_power(control_up_switch_02.Entity, 0F);
            this.in_cable_room = true;
            Engine.wake(new ScriptMethodReference(_04b_title1));
            ...
            Engine.wake(new ScriptMethodReference(cableroom_killer));
            Engine.wake(new ScriptMethodReference(cableroom_junk_killer));
            Engine.game_save_immediate();
            ...
            await Engine.sleep(30);
            Engine.ai_dialogue_enable(true);
            Engine.wake(new ScriptMethodReference(cableroom_commander_reminder));
            await Engine.sleep_until(async () => this.plummeting == true);
            Engine.wake(new ScriptMethodReference(croom_exit));
            Engine.wake(new ScriptMethodReference(objective_cables_clear));
            await Engine.sleep(30);
        ...
        public async Task control_room_return()
        {
            ...
            Engine.game_save_immediate();
            Engine.wake(new ScriptMethodReference(plummeting_control_commander));
            ...
            Engine.wake(new ScriptMethodReference(control_return_flood_spawn));
        ...
        public async Task power_core_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(power_core_commander));
    ...
    async () =>
        ...
        {
            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle.weapon", 3793944749U)) && this.banshee_sin_01_ready == false)
            {
            ...
            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine.weapon", 3821994585U)) && this.banshee_sin_01_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_01.Squad), 0)), carbine, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle.weapon", 3830383321U)) && this.banshee_sin_01_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_01.Squad), 0)), sniper, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\pistol\\needler\\needler.weapon", 3838444372U)) && this.banshee_sin_01_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_01.Squad), 0)), needler, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol.weapon", 3812032961U)) && this.banshee_sin_01_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_01.Squad), 0)), pistol, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\support_high\\flak_cannon\\flak_cannon.weapon", 3845784516U)) && this.banshee_sin_01_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_01.Squad), 0)), flak, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\characters\\sentinel_aggressor\\weapons\\beam\\sentinel_aggressor_beam.weapon", 3850372106U)) && this.banshee_sin_01_ready == false)
            {
        ...
        public async Task dogfight_secondtime_start()
        {
            ...
            await this.cinematic_skip_stop();
            await Engine.sleep(2);
            Engine.wake(new ScriptMethodReference(plummet_killer));
            Engine.wake(new ScriptMethodReference(plummet_fl));
            Engine.wake(new ScriptMethodReference(plummet_nl));
            Engine.wake(new ScriptMethodReference(plummet_fr));
            Engine.wake(new ScriptMethodReference(plummet_nr));
            await Engine.sleep(5);
            if ((bool)Engine.game_is_cooperative())
            {
                ...
                Engine.wake(new ScriptMethodReference(banshee_killer_00));
                Engine.wake(new ScriptMethodReference(banshee_killer_01));
            }
            else
            {
                Engine.object_destroy(player0_fake_banshee.Entity);
            ...
            Engine.game_save_immediate();
            Engine.wake(new ScriptMethodReference(dogfight2_commander));
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
        ...
        {
            Engine.cs_enable_pathfinding_failsafe(true);
            Engine.cs_custom_animation(Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3894871729U), "climb:unarmed:detach", 0F, true);
        ...
        {
            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle.weapon", 3793944749U)) && this.banshee_sin_02_ready == false)
            {
            ...
            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine.weapon", 3821994585U)) && this.banshee_sin_02_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_031.Squad), 0)), carbine, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle.weapon", 3830383321U)) && this.banshee_sin_02_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_031.Squad), 0)), sniper, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\pistol\\needler\\needler.weapon", 3838444372U)) && this.banshee_sin_02_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_031.Squad), 0)), needler, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol.weapon", 3812032961U)) && this.banshee_sin_02_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_031.Squad), 0)), pistol, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\support_high\\flak_cannon\\flak_cannon.weapon", 3845784516U)) && this.banshee_sin_02_ready == false)
            {
                Engine.unit_add_equipment(Engine.unit(Engine.list_get(Engine.ai_actors(dervish_031.Squad), 0)), flak, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\characters\\sentinel_aggressor\\weapons\\beam\\sentinel_aggressor_beam.weapon", 3850372106U)) && this.banshee_sin_02_ready == false)
            {
        ...
        public async Task bottling_secondtime_start()
        {
            ...
            if ((bool)Engine.game_is_cooperative())
            {
                Engine.sleep_forever(new ScriptMethodReference(banshee_killer_00));
                Engine.sleep_forever(new ScriptMethodReference(banshee_killer_01));
            ...
            Engine.wake(new ScriptMethodReference(bottling_fx_01));
            Engine.wake(new ScriptMethodReference(bottling_fx_02));
            Engine.wake(new ScriptMethodReference(bottling_fx_03));
            Engine.wake(new ScriptMethodReference(bottling_fx_04));
            Engine.wake(new ScriptMethodReference(bottling_fx_05));
            Engine.camera_control(false);
            await Engine.sleep(1);
            await Engine.cache_block_for_one_frame();
            await Engine.sleep(1);
            ...
            Engine.game_save_immediate();
            Engine.wake(new ScriptMethodReference(_04b_title2));
            Engine.ai_place(bottling_return_sentinels_01.Squad, 2);
            Engine.ai_place(bottling_return_flood_01.Squad, 4);
            Engine.wake(new ScriptMethodReference(bottling_return_commander));
            ...
            Engine.wake(new ScriptMethodReference(bottling_return_s_respawner));
            Engine.wake(new ScriptMethodReference(bottling_return_cf_respawner));
            Engine.wake(new ScriptMethodReference(bottling_return_ca_respawner));
            ...
            Engine.game_save();
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 5);
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_s_respawner));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_cf_respawner));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_ca_respawner));
        }
        ...
        public async Task to_underhangar_secondtime()
        {
            ...
            Engine.wake(new ScriptMethodReference(music_04b_08_start));
            Engine.wake(new ScriptMethodReference(halls_up_01));
            Engine.wake(new ScriptMethodReference(halls_up_02));
            Engine.wake(new ScriptMethodReference(halls_up_03));
            Engine.wake(new ScriptMethodReference(halls_up_04));
            Engine.wake(new ScriptMethodReference(halls_up_05));
            Engine.wake(new ScriptMethodReference(halls_up_06));
            Engine.wake(new ScriptMethodReference(halls_up_07));
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 5);
            ...
            Engine.wake(new ScriptMethodReference(music_04b_08_start_alt));
        ...
        public async Task underhangar_secondtime_start()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(underhangar_return_commander));
            Engine.wake(new ScriptMethodReference(underhangar_fx_01));
            Engine.wake(new ScriptMethodReference(underhangar_fx_02));
            ...
            Engine.wake(new ScriptMethodReference(music_04b_08_stop));
            await Engine.sleep_until(async () =>
            {
        ...
        public async Task to_hangar_secondtime()
        {
            ...
            Engine.wake(new ScriptMethodReference(other_hall_fx));
        }
    ...
    async () => await Engine.sleep((short)Engine.random_range(5, 30))));
        ...
        public async Task boss_fight_deletion()
        {
            ...
            {
                Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_death", 3901097744U), Engine.list_get(Engine.ai_actors(hl_boss_random.Squad), 0), "");
        ...
        public async Task hangar_secondtime_start()
        {
            ...
            await this.cinematic_fade_to_white();
            Engine.sleep_forever(new ScriptMethodReference(other_hall_fx));
            Engine.sleep_forever(new ScriptMethodReference(underhangar_fx_01));
            Engine.sleep_forever(new ScriptMethodReference(underhangar_fx_02));
            Engine.sleep_forever(new ScriptMethodReference(bottling_fx_01));
            Engine.sleep_forever(new ScriptMethodReference(bottling_fx_02));
            Engine.sleep_forever(new ScriptMethodReference(bottling_fx_03));
            Engine.sleep_forever(new ScriptMethodReference(bottling_fx_04));
            Engine.sleep_forever(new ScriptMethodReference(bottling_fx_05));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_01));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_02));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_03));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_04));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_05));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_06));
            Engine.sleep_forever(new ScriptMethodReference(halls_up_07));
            Engine.ai_erase_all();
            ...
            Engine.wake(new ScriptMethodReference(hangar_fx));
            ...
            Engine.wake(new ScriptMethodReference(toys));
            Engine.camera_control(false);
            await Engine.sleep(1);
            await Engine.cache_block_for_one_frame();
            await Engine.sleep(1);
            await this.cinematic_fade_from_white();
            Engine.wake(new ScriptMethodReference(objective_dogfight_clear));
            Engine.wake(new ScriptMethodReference(objective_hl_set));
            Engine.data_mine_set_mission_segment("04b_24_boss_fight_01");
            Engine.game_save_immediate();
            Engine.wake(new ScriptMethodReference(monitor_chatting));
            Engine.wake(new ScriptMethodReference(monitor_flitting));
        ...
        {
            Engine.sleep_forever(new ScriptMethodReference(arm_02_entry_start));
        }

        [ScriptMethod(366, Lifecycle.Static)]
        public async Task sleep_disposal()
        {
            Engine.sleep_forever(new ScriptMethodReference(disposal_chamber_start));
            Engine.sleep_forever(new ScriptMethodReference(disposal_infection_spawn));
            Engine.sleep_forever(new ScriptMethodReference(spec_ops_reborn));
        }

        [ScriptMethod(367, Lifecycle.Static)]
        public async Task sleep_silo()
        {
            Engine.sleep_forever(new ScriptMethodReference(silo_start));
            Engine.sleep_forever(new ScriptMethodReference(silo_hall_flood_spawner));
            Engine.sleep_forever(new ScriptMethodReference(elev_go));
            Engine.sleep_forever(new ScriptMethodReference(to_flood_lab));
            Engine.sleep_forever(new ScriptMethodReference(silo_commander_reminder));
            Engine.sleep_forever(new ScriptMethodReference(silo_killer));
            Engine.sleep_forever(new ScriptMethodReference(silo_sentinel_spawner));
            Engine.sleep_forever(new ScriptMethodReference(silo_flood_spawner));
            Engine.sleep_forever(new ScriptMethodReference(silo_saving));
        }
        ...
        {
            Engine.sleep_forever(new ScriptMethodReference(to_flood_lab));
            Engine.sleep_forever(new ScriptMethodReference(flood_lab_start));
            Engine.sleep_forever(new ScriptMethodReference(lab_barricades));
            Engine.sleep_forever(new ScriptMethodReference(lab_wave_new_01));
            Engine.sleep_forever(new ScriptMethodReference(lab_wave_new_02));
            Engine.sleep_forever(new ScriptMethodReference(famine_flavor));
        }

        [ScriptMethod(369, Lifecycle.Static)]
        public async Task sleep_wraparound()
        {
            Engine.sleep_forever(new ScriptMethodReference(bridge_start));
            Engine.sleep_forever(new ScriptMethodReference(bridge_phantom_arrives));
            Engine.sleep_forever(new ScriptMethodReference(bridge_reminder));
            Engine.sleep_forever(new ScriptMethodReference(wraparound_right));
            Engine.sleep_forever(new ScriptMethodReference(wraparound_left));
            Engine.sleep_forever(new ScriptMethodReference(research_arm_bsp_swap));
        }

        [ScriptMethod(370, Lifecycle.Static)]
        public async Task sleep_control()
        {
            Engine.sleep_forever(new ScriptMethodReference(control_room_start));
            Engine.sleep_forever(new ScriptMethodReference(control_commander_reminder));
            Engine.sleep_forever(new ScriptMethodReference(control_bug_out));
            Engine.sleep_forever(new ScriptMethodReference(control_flood_spawn));
            Engine.sleep_forever(new ScriptMethodReference(wind));
            Engine.sleep_forever(new ScriptMethodReference(hologram_toggle));
            Engine.sleep_forever(new ScriptMethodReference(hl_killer));
        }

        [ScriptMethod(371, Lifecycle.Static)]
        public async Task sleep_cableroom()
        {
            Engine.sleep_forever(new ScriptMethodReference(cable_room_start));
            Engine.sleep_forever(new ScriptMethodReference(cable_a_health));
            Engine.sleep_forever(new ScriptMethodReference(cable_b_health));
            Engine.sleep_forever(new ScriptMethodReference(cable_c_health));
            Engine.sleep_forever(new ScriptMethodReference(cable_nav_a));
            Engine.sleep_forever(new ScriptMethodReference(cable_nav_b));
            Engine.sleep_forever(new ScriptMethodReference(cable_nav_c));
            Engine.sleep_forever(new ScriptMethodReference(cable_sentinel_spawner));
            Engine.sleep_forever(new ScriptMethodReference(cable_flood_spawner));
            Engine.sleep_forever(new ScriptMethodReference(grav_test));
            Engine.sleep_forever(new ScriptMethodReference(cable_invulnerable));
            Engine.sleep_forever(new ScriptMethodReference(cableroom_suck_killer));
            Engine.sleep_forever(new ScriptMethodReference(cableroom_junk_spawn));
            Engine.sleep_forever(new ScriptMethodReference(cableroom_commander_reminder));
            Engine.sleep_forever(new ScriptMethodReference(cableroom_killer));
            Engine.sleep_forever(new ScriptMethodReference(cableroom_junk_killer));
            Engine.sleep_forever(new ScriptMethodReference(croom_exit));
        }

        [ScriptMethod(372, Lifecycle.Static)]
        public async Task sleep_control_return()
        {
            Engine.sleep_forever(new ScriptMethodReference(control_room_return));
            Engine.sleep_forever(new ScriptMethodReference(control_return_flood_spawn));
        }

        [ScriptMethod(373, Lifecycle.Static)]
        public async Task sleep_powercore()
        {
            Engine.sleep_forever(new ScriptMethodReference(power_core_start));
        }

        [ScriptMethod(374, Lifecycle.Static)]
        public async Task sleep_dogfight()
        {
            Engine.sleep_forever(new ScriptMethodReference(dogfight_secondtime_start));
            Engine.sleep_forever(new ScriptMethodReference(banshee_killer_00));
            Engine.sleep_forever(new ScriptMethodReference(banshee_killer_01));
        }
        ...
        {
            Engine.sleep_forever(new ScriptMethodReference(bottling_secondtime_start));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_s_respawner));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_cf_respawner));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_ca_respawner));
            Engine.sleep_forever(new ScriptMethodReference(to_underhangar_secondtime));
            Engine.sleep_forever(new ScriptMethodReference(bottling_return_commander));
        }

        [ScriptMethod(376, Lifecycle.Static)]
        public async Task sleep_underhangar_return()
        {
            Engine.sleep_forever(new ScriptMethodReference(underhangar_secondtime_start));
            Engine.sleep_forever(new ScriptMethodReference(to_hangar_secondtime));
            Engine.sleep_forever(new ScriptMethodReference(underhangar_return_commander));
        }
        ...
        public async Task mission()
        {
            ...
            await Engine.cache_block_for_one_frame();
            await Engine.sleep(1);
            Engine.wake(new ScriptMethodReference(_04b_title0));
            Engine.wake(new ScriptMethodReference(objective_labs_set));
            Engine.wake(new ScriptMethodReference(kill_volumes));
            Engine.wake(new ScriptMethodReference(arm_02_entry_start));
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_disposal_enter, Engine.players()) == true);
            Engine.wake(new ScriptMethodReference(disposal_chamber_start));
            Engine.wake(new ScriptMethodReference(silo_start));
            Engine.wake(new ScriptMethodReference(to_flood_lab));
            Engine.wake(new ScriptMethodReference(flood_lab_start));
            await this.sleep_intro();
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 0);
            Engine.wake(new ScriptMethodReference(bridge_start));
            Engine.wake(new ScriptMethodReference(control_room_start));
            await this.sleep_disposal();
            await this.sleep_silo();
            await this.sleep_lab();
            Engine.wake(new ScriptMethodReference(objective_labs_clear));
            Engine.wake(new ScriptMethodReference(objective_control_set));
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 2);
            Engine.wake(new ScriptMethodReference(cable_room_start));
            await this.sleep_wraparound();
            await this.sleep_control();
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 1);
            Engine.wake(new ScriptMethodReference(control_room_return));
            Engine.wake(new ScriptMethodReference(power_core_start));
            Engine.wake(new ScriptMethodReference(dogfight_secondtime_start));
            ...
            Engine.wake(new ScriptMethodReference(bottling_secondtime_start));
            Engine.wake(new ScriptMethodReference(to_underhangar_secondtime));
            Engine.wake(new ScriptMethodReference(underhangar_secondtime_start));
            Engine.wake(new ScriptMethodReference(to_hangar_secondtime));
            Engine.wake(new ScriptMethodReference(hangar_secondtime_start));
        ...
        public async Task _04_intra0_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg\\door_tron_lg", 3860268193U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3861644470U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 30);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 32);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 3);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 20);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 22);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("incompetent\\default_object", 3868067096U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 5);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
        ...
        public async Task _04_intra1_01_predict()
        {
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3870033206U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3870033206U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\fp_energy_blade\\fp_energy_blade", 3793617064U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\fp_energy_blade\\fp_energy_blade", 3793617064U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3812164035U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg_containment_shield\\door_tron_lg_containment_shield", 3870360891U), 0);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\central_chamber\\generator_a\\generator_a", 3871147335U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\gasgiant_hologram\\gasgiant_hologram", 3873113445U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg\\door_tron_lg", 3860268193U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\edge_trim\\platform_plates_a\\platform_plates_a", 3873965426U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\control_lift_up\\control_lift_up", 3874030963U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\holo_panels\\holo_generic\\holo_generic", 3876390295U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\holo_panels\\holo_small02\\holo_small02", 3876652443U), 0);
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await Engine.sleep(8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 1);
        ...
        public async Task _04_intra1_02_predict()
        {
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 39, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\gasgiant_hologram\\gasgiant_hologram", 3873113445U), 1);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 30);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 27);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
        ...
        public async Task _04_outro1_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar_scenery\\door_cargo_hangar_scenery", 3877242276U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3861644470U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\alphagasgiant\\gasgiant_rob", 3785556013U), 0);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
            await Engine.sleep(18);
        ...
        public async Task _04_outro1_02_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3877963183U), 2);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 1);
            await Engine.sleep(42);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\hanger_lift\\hanger_lift", 3878618553U), 0);
            await Engine.sleep(8);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 1, true);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 1);
        ...
        public async Task _04_outro1_03_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar_scenery\\door_cargo_hangar_scenery", 3877242276U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3878684090U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            await Engine.sleep(90);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 6, true);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 21, true);
            await Engine.sleep(14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3879142849U), 0);
            await Engine.sleep(4);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 19, true);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 5, true);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 14, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 1);
            await Engine.sleep(4);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 9, true);
            await Engine.sleep(3);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 10, true);
        ...
        {
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar\\door_cargo_hangar", 3879339460U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3877963183U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 14, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 1);
        ...
        public async Task _04_outro2_02_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3879142849U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3880125904U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3880125904U), 7);
            await Engine.sleep(17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 29);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 35);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 36);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 37);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 33);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 34);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\gravity_hammer\\gravity_hammer", 3882288625U), 0);
            await Engine.sleep(90);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 57, false);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 1, false);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 34, false);
