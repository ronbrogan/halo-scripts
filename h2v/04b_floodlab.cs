...
#region Fields
        ...
        public scnr_04b_floodlab(IScriptEngine scriptEngine)
        {
            ...
            this.stress = GetTag<EffectTag>("effects\\scenery\\sparks\\sparking_light", 4159378871U);
            this.boom = GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\wall_explosion", 4159509945U);
            this.gravity = 0F;
            ...
            this.cable_var = 0;
            this.gasleak = GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\gas_leak", 3892905619U);
            this.big_boom = GetTag<EffectTag>("effects\\scenarios\\solo\\alphagasgiant\\wall_explosion", 4159509945U);
            ...
            this.holo_death = GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_death", 3901097744U);
        ...
        {
            await sleep(369);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\music\\c04_intra0_01_mus", 3854959696U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\foley\\c04_intra0_01_fol", 3855025233U), default(IGameObject), 1F);
        ...
        {
            await sleep(467);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_1230_der", 3855090770U), dervish_intra0.Entity, 1F);
        ...
        {
            await sleep(493);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_1240_soc", 3855156307U), commander_intra0.Entity, 1F);
        ...
        public async Task c04_intra0()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\music\\c04_intra0_01_mus", 3854959696U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra0\\foley\\c04_intra0_01_fol", 3855025233U));
            await sleep(this.prediction_offset);
            await this.c04_intra0_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra0\\04_intra0", 3855221844U), "04_intra0", default(IUnit), anchor_flag_intra0);
            custom_animation_relative(dervish_intra0.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra0\\04_intra0", 3855287381U), "dervish", false, anchor_intra0.Entity);
            custom_animation_relative(commander_intra0.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "commander", false, anchor_intra0.Entity);
            custom_animation_relative(elite_intra0_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "elite01", false, anchor_intra0.Entity);
            custom_animation_relative(elite_intra0_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra0\\04_intra0", 3855418455U), "elite02", false, anchor_intra0.Entity);
            custom_animation_relative(grunt_intra0_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\grunt\\04_intra0\\04_intra0", 3855549529U), "grunt01", false, anchor_intra0.Entity);
            custom_animation_relative(grunt_intra0_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\grunt\\04_intra0\\04_intra0", 3855549529U), "grunt02", false, anchor_intra0.Entity);
            fade_in(1F, 1F, 1F, 15);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_01_fol", 3855615066U), default(IGameObject), 1F);
            print("c04_intra1 foley 01 start");
        }
        ...
        {
            await sleep(45);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2010_her", 3855680603U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(121);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2020_her", 3855746140U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(249);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2030_soc", 3855811677U), default(IGameObject), 1F);
        ...
        public async Task effect_shield_impact()
        {
            ...
            effect_new(GetTag<EffectTag>("effects\\impact\\impact_bullet_medium\\energy_shield_thin_cov", 3825402509U), flag_shield_impact);
        }
        ...
        public async Task c04_intra1_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_01_fol", 3855615066U));
            await sleep(this.prediction_offset);
            await this.c04_intra1_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra1\\04_intra1", 3855877214U), "04_intra1_01", default(IUnit), cinematic_anchor02);
            custom_animation_relative(dervish02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra1\\04_intra1", 3855942751U), "dervish_01", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_intra1\\04_intra1", 3856008288U), "heretic_01", false, anchor02.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep(165);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_02_fol", 3856073825U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_intra1\\foley\\c04_intra1_02_fol", 3856073825U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2031_soc", 3856139362U), commander.Entity, 1F);
        ...
        {
            await sleep(96);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2040_soc", 3856204899U), commander.Entity, 1F);
        ...
        {
            await sleep(178);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2050_soc", 3856270436U), commander.Entity, 1F);
        ...
        {
            await sleep(229);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2060_der", 3856335973U), dervish02b.Entity, 1F);
        ...
        {
            await sleep(292);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2070_soc", 3856401510U), commander.Entity, 1F);
        ...
        {
            await sleep(335);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2080_der", 3856467047U), dervish02b.Entity, 1F);
        ...
        {
            await sleep(482);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_2090_der", 3856532584U), dervish02b.Entity, 1F);
        ...
        public async Task c04_intra1_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_intra1\\04_intra1", 3855877214U), "04_intra1_02", default(IUnit), cinematic_anchor02);
            custom_animation_relative(dervish02b.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_intra1\\04_intra1", 3855942751U), "dervish_02", false, anchor02.Entity);
            custom_animation_relative(commander.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "soc_02", false, anchor02.Entity);
            custom_animation_relative(elite01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "elite01_02", false, anchor02.Entity);
            custom_animation_relative(elite02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\04_intra1\\04_intra1", 3856598121U), "elite02_02", false, anchor02.Entity);
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\music\\c04_outro1_01_mus", 3856663658U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_01_fol", 3856729195U), default(IGameObject), 1F);
        ...
        {
            await sleep(118);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3010_der", 3856794732U), dervish_03.Entity, 1F);
        ...
        {
            await sleep(197);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3020_her", 3856860269U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(243);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3030_her", 3856925806U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(385);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3040_der", 3856991343U), dervish_03.Entity, 1F);
        ...
        public async Task c04_outro1_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\music\\c04_outro1_01_mus", 3856663658U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_01_fol", 3856729195U));
            await sleep(this.prediction_offset);
            await this.c04_outro1_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_01", default(IUnit), anchor_flag_seraph);
            custom_animation_relative(dervish_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_01", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_01", false, anchor02.Entity);
            scenery_animation_start_relative(outro_seraph.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_01", anchor_seraph.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._04_outro1_02_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_02_fol", 3857319028U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_02_fol", 3857319028U), default(IGameObject), 1F);
        ...
        {
            await sleep(132);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3050_der", 3857384565U), dervish_03.Entity, 1F);
        ...
        {
            await sleep(190);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3060_gsp", 3857450102U), monitor.Entity, 1F);
        ...
        {
            await sleep(363);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3070_her", 3857515639U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(516);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3080_gsp", 3857581176U), monitor.Entity, 1F);
        ...
        public async Task c04_outro1_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_02", default(IUnit), anchor_flag_seraph);
            custom_animation_relative(dervish_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_02", false, anchor02.Entity);
            custom_animation_relative(monitor.Entity, GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro1\\04_outro1", 3857646713U), "monitor_02", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_02", false, anchor02.Entity);
            scenery_animation_start_relative(outro_seraph.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_02", anchor_seraph.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._04_outro1_03_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_03_fol", 3857712250U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro1\\foley\\c04_outro1_03_fol", 3857712250U), default(IGameObject), 1F);
            print("c04_outro1 foley 01 start");
        }
        ...
        {
            await sleep(29);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3090_her", 3857777787U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(108);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_3100_her", 3857843324U), heretic_leader1.Entity, 1F);
        ...
        {
            await sleep(162);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), holo_drone_1.Entity, "light");
            print("effect - drone 1");
            await sleep(13);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), holo_drone_2.Entity, "light");
        ...
        {
            await sleep(477);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), holo_base_1.Entity, "marker");
            print("effect - hologram 1");
            await sleep(18);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), holo_base_2.Entity, "marker");
        ...
        public async Task c04_outro1_03_holo1()
        {
            ...
            custom_animation_relative(hologram01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "holo1_03", false, anchor02.Entity);
        }
        ...
        public async Task c04_outro1_03_holo2()
        {
            ...
            custom_animation_relative(hologram02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "holo2_03", false, anchor02.Entity);
        }
        ...
        public async Task c04_outro1_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro1\\04_outro1", 3857056880U), "04_outro1_03", default(IUnit), anchor_flag_seraph);
            custom_animation_relative(dervish_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro1\\04_outro1", 3857122417U), "dervish_03", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro1\\04_outro1", 3857187954U), "heretic_03", false, anchor02.Entity);
            custom_animation_relative(monitor.Entity, GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro1\\04_outro1", 3857646713U), "monitor_03", false, anchor02.Entity);
            scenery_animation_start_relative(outro_seraph.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3857253491U), "04_outro1_03", anchor_seraph.Entity);
            scenery_animation_start_relative(holo_drone_1.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3858629768U), "outro1_01", anchor02.Entity);
            scenery_animation_start_relative(holo_drone_2.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3858629768U), "outro1_02", anchor02.Entity);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\music\\c04_outro2_01_mus", 3858695305U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_01_fol", 3858760842U), default(IGameObject), 1F);
        ...
        {
            await sleep(32);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9110_gsp", 3858826379U), monitor.Entity, 1F);
        ...
        {
            await sleep(133);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9120_der", 3858891916U), dervish_03.Entity, 1F);
        ...
        {
            await sleep(274);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9130_gsp", 3858957453U), monitor.Entity, 1F);
        ...
        public async Task effect_monitor_scramble()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\brute\\hammer_grappling", 3859022990U), monitor.Entity, "body");
        ...
        public async Task c04_outro2_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\music\\c04_outro2_01_mus", 3858695305U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_01_fol", 3858760842U));
            await sleep(this.prediction_offset);
            await this.c04_outro2_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro2\\04_outro2", 3859350675U), "04_outro2_01", default(IUnit), cinematic_anchor02);
            custom_animation_relative(dervish_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro2\\04_outro2", 3859416212U), "dervish_01", false, anchor02.Entity);
            custom_animation_relative(monitor.Entity, GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro2\\04_outro2", 3859481749U), "monitor_01", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro2\\04_outro2", 3859547286U), "heretic_01", false, anchor02.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._04_outro2_02_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_02_fol", 3859612823U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\04_alphagas\\c04_outro2\\foley\\c04_outro2_02_fol", 3859612823U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9140_gsp", 3859678360U), monitor.Entity, 1F);
        ...
        {
            await sleep(146);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9150_der", 3859743897U), dervish_03.Entity, 1F);
        ...
        {
            await sleep(236);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9160_tar", 3859809434U), tartarus.Entity, 1F);
        ...
        {
            await sleep(300);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\04_gasgiant\\cinematic\\c04_9170_tar", 3859874971U), tartarus.Entity, 1F);
        ...
        public async Task effect_monitor_yank()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\monitor\\monitor_scrambled", 3859940508U), monitor.Entity, "body");
        }
        ...
        public async Task c04_outro2_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\04_outro2\\04_outro2", 3859350675U), "04_outro2_02", default(IUnit), cinematic_anchor02);
            custom_animation_relative(dervish_03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\04_outro2\\04_outro2", 3859416212U), "dervish_02", false, anchor02.Entity);
            custom_animation_relative(monitor.Entity, GetTag<AnimationGraphTag>("objects\\characters\\monitor\\04_outro2\\04_outro2", 3859481749U), "monitor_02", false, anchor02.Entity);
            custom_animation_relative(heretic_leader1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\heretic\\04_outro2\\04_outro2", 3859547286U), "heretic_02", false, anchor02.Entity);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\04_outro2\\04_outro2", 3860006045U), "tartarus_02", false, anchor02.Entity);
            scenery_animation_start_relative(hammer.Entity, GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\04_outro2\\04_outro2", 3860137119U), "hammer_02", anchor02.Entity);
            custom_animation_relative(phantom_outro2.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\04_outro2\\04_outro2", 3860202656U), "phantom_02", false, anchor02.Entity);
            await sleep((short)((float)camera_time() - 15));
            fade_out(0F, 0F, 0F, 15);
            await sleep(15);
        ...
        public async Task music_04b_01_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_01", 4157347224U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_01_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_01", 4157347224U));
        }
        ...
        public async Task music_04b_02_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_02", 4157543835U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_02_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_02", 4157543835U));
        }
        ...
        public async Task music_04b_03_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_03_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), true);
        }
        ...
        public async Task music_04b_03_stop_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U), false);
        }
        ...
        public async Task music_04b_03_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_03", 4157740446U));
        }
        ...
        public async Task music_04b_04_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_04_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), true);
        }
        ...
        public async Task music_04b_04_stop_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U), false);
        }
        ...
        public async Task music_04b_04_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_04", 4158133668U));
        }
        ...
        public async Task music_04b_05_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_05", 4158330279U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_06_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_06", 4158461353U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_07_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_07", 4158657964U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_08_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U), default(IGameObject), 1F);
        }
        ...
        public async Task music_04b_08_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U), true);
        }
        ...
        public async Task music_04b_08_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\04b_floodlab\\04b_music\\04b_08", 4158789038U));
        }
        ...
        public async Task revive_aware()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\combat\\elite_loose\\02_danger\\warn_fldreanimate", 4159247797U), list_get(ai_actors(allies_elites_03a.Squad), 0), 1F);
        ...
        public async Task spec_ops_reborn()
        {
            await sleep_until(async () =>
            {
                ...
                effect_new_on_object_marker(GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4146795767U), list_get(ai_actors(disposal_commander.Squad), 0), "");
                await sleep(30);
        ...
        public async Task disposal_chamber_start()
        {
            ...
            await sleep(60);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_activate", 3857908861U), tennis_ball.Entity, "");
            await sleep_until(async () => device_get_position(tennis_ball.Entity) == 1F, 30, 450);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_holo_on_cinematic", 3858236546U), tennis_ball.Entity, "light");
        ...
        public async Task famine_flavor()
        {
            ...
            custom_animation_loop(unit(list_get(ai_actors(famine_cf.Squad), 0)), GetTag<AnimationGraphTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3978234792U), "combat:thrash_back:var0", true);
            custom_animation_loop(unit(list_get(ai_actors(famine_cf.Squad), 1)), GetTag<AnimationGraphTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3978234792U), "combat:thrash_back:var1", true);
            custom_animation_loop(unit(list_get(ai_actors(famine_cf.Squad), 2)), GetTag<AnimationGraphTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3978234792U), "combat:thrash_front:var0", true);
            custom_animation_loop(unit(list_get(ai_actors(famine_cf.Squad), 3)), GetTag<AnimationGraphTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3978234792U), "combat:thrash_front:var1", true);
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4052356969U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4052356969U)));
        ...
        public async Task wind()
        {
            await sleep_until(async () =>
            {
                await sleep_until(async () =>
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\ambience\\sound_scenery\\gusty_wind\\details\\gusty_wind", 4159313334U), default(IGameObject), 1F);
        ...
        public async Task commander_farewell()
        {
            ...
            cs_enable_moving(true);
            cs_enable_looking(true);
            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)))
            {
            ...
            else
            {
                ...
                cs_play_line("0130");
                await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\melee\\energy_blade\\energy_blade.weapon", 3786145846U)) || volume_test_objects(vol_control_middle, players()) == true, 30, 900);
            }
        }
        ...
        public async Task cable_a_health()
        {
            ...
            if (this.cable_var == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\ambience\\alphagasgiant\\cable_snaps\\cable_snap_one", 4159706556U), default(IGameObject), 1F);
            ...
            if (this.cable_var == 3)
            {
                await this.cam_shake();
                device_set_position(real_cable_a.Entity, 1F);
                sound_impulse_start(GetTag<SoundTag>("sound\\ambience\\alphagasgiant\\cable_snaps\\cable_snap_two", 4159772093U), default(IGameObject), 1F);
                ...
                await sleep(400);
                object_type_predict_high(GetTag<BaseTag>("scenarios\\objects\\solo\\alphagasgiant\\cable_room\\cable_room", 4060418020U));
                object_type_predict_high(GetTag<BaseTag>("scenarios\\objects\\solo\\alphagasgiant\\cable_room_top\\cable_room_top", 4065660980U));
                await sleep(20);
    ...
    async () =>
        ...
        {
            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle.weapon", 3793944749U)) && this.banshee_sin_01_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_01.Squad), 0)), rifle, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine.weapon", 3821994585U)) && this.banshee_sin_01_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_01.Squad), 0)), carbine, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle.weapon", 3830383321U)) && this.banshee_sin_01_ready == false)
            {
            ...
            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol.weapon", 3812032961U)) && this.banshee_sin_01_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_01.Squad), 0)), pistol, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\support_high\\flak_cannon\\flak_cannon.weapon", 3845784516U)) && this.banshee_sin_01_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_01.Squad), 0)), flak, true, true);
                this.banshee_sin_01_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\characters\\sentinel_aggressor\\weapons\\beam\\sentinel_aggressor_beam.weapon", 3850372106U)) && this.banshee_sin_01_ready == false)
            {
        ...
        {
            cs_enable_pathfinding_failsafe(true);
            cs_custom_animation(GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3894871729U), "climb:unarmed:detach", 0F, true);
        ...
        {
            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle.weapon", 3793944749U)) && this.banshee_sin_02_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_031.Squad), 0)), rifle, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine.weapon", 3821994585U)) && this.banshee_sin_02_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_031.Squad), 0)), carbine, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle.weapon", 3830383321U)) && this.banshee_sin_02_ready == false)
            {
            ...
            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol.weapon", 3812032961U)) && this.banshee_sin_02_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_031.Squad), 0)), pistol, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\support_high\\flak_cannon\\flak_cannon.weapon", 3845784516U)) && this.banshee_sin_02_ready == false)
            {
                unit_add_equipment(unit(list_get(ai_actors(dervish_031.Squad), 0)), flak, true, true);
                this.banshee_sin_02_ready = true;
            }

            if (unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\characters\\sentinel_aggressor\\weapons\\beam\\sentinel_aggressor_beam.weapon", 3850372106U)) && this.banshee_sin_02_ready == false)
            {
    ...
    async () => await sleep((short)random_range(5, 30))));
        ...
        public async Task boss_fight_deletion()
        {
            ...
            {
                effect_new_on_object_marker(GetTag<EffectTag>("effects\\scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\drone_death", 3901097744U), list_get(ai_actors(hl_boss_random.Squad), 0), "");
        ...
        public async Task _04_intra0_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg\\door_tron_lg", 3860268193U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3861644470U), 0);
            ...
            await sleep(9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 30);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 32);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 3);
            await sleep(12);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            await sleep(4);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 20);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 21);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 22);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 23);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 24);
            predict_model_section(GetTag<RenderModelTag>("incompetent\\default_object", 3868067096U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 5);
            await sleep(145);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 51, true);
            await sleep(45);
            ...
            await sleep(14);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
            await sleep(11);
        ...
        public async Task _04_intra1_01_predict()
        {
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 15, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3870033206U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3870033206U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\fp_energy_blade\\fp_energy_blade", 3793617064U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\fp_energy_blade\\fp_energy_blade", 3793617064U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 15);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3866297597U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3812164035U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 21);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 23);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 1);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg_containment_shield\\door_tron_lg_containment_shield", 3870360891U), 0);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\central_chamber\\generator_a\\generator_a", 3871147335U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\gasgiant_hologram\\gasgiant_hologram", 3873113445U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_lg\\door_tron_lg", 3860268193U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\edge_trim\\platform_plates_a\\platform_plates_a", 3873965426U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\control_lift_up\\control_lift_up", 3874030963U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            await sleep(1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\holo_panels\\holo_generic\\holo_generic", 3876390295U), 0);
            await sleep(1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\holo_panels\\holo_small02\\holo_small02", 3876652443U), 0);
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 1);
            await sleep(71);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
        ...
        public async Task _04_intra1_02_predict()
        {
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 39, true);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\wall_insertions\\channel_curcuit_a\\channel_curcuit_a", 3872851297U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\gasgiant_hologram\\gasgiant_hologram", 3873113445U), 1);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 30);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3861972155U), 27);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 2);
            await sleep(6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 1);
            await sleep(36);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 13, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 32, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 40, true);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            await sleep(42);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
            await sleep(101);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 86, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 64, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04a_gasgiant\\alphagasgiant"), 81, false);
        ...
        public async Task _04_outro1_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar_scenery\\door_cargo_hangar_scenery", 3877242276U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3861644470U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\alphagasgiant\\gasgiant_rob", 3785556013U), 0);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3868263707U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
            await sleep(18);
        ...
        public async Task _04_outro1_02_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3877963183U), 2);
            await sleep(113);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 1);
            await sleep(9);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 3);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 3);
            await sleep(23);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 1);
            await sleep(42);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 12);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\hanger_lift\\hanger_lift", 3878618553U), 0);
            await sleep(8);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 1, true);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 1);
        ...
        public async Task _04_outro1_03_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar_scenery\\door_cargo_hangar_scenery", 3877242276U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\alphagasgiant\\holo_drone\\holo_drone", 3878684090U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            await sleep(90);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 6, true);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 21, true);
            await sleep(14);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3879142849U), 0);
            await sleep(4);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 19, true);
            await sleep(1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 5, true);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 14, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 1);
            await sleep(4);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 9, true);
            await sleep(3);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 10, true);
        ...
        {
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_cargo_hangar\\door_cargo_hangar", 3879339460U), 0);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3877963183U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\heretic\\heretic", 3874751870U), 10);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 14, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3876717980U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3874096500U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\doors\\door_tron_sm\\door_tron_sm", 3873637741U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3786276920U), 1);
        ...
        public async Task _04_outro2_02_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3838575446U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3794075823U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\vehicles\\c_seraph\\c_seraph", 3877569961U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3879142849U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_low\\sentinel_gun\\sentinel_gun", 3850503180U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3822125659U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_jetpack\\elite_jetpack", 3875407240U), 0);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3879536071U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3880125904U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3880125904U), 7);
            await sleep(17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 29);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 35);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 36);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 37);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 33);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3880191441U), 34);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\gravity_hammer\\gravity_hammer", 3882288625U), 0);
            await sleep(90);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 57, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 1, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\04b_floodlab\\production_arm2"), 34, false);
