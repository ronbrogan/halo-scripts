...
#region Fields
        ...
        public async Task x01_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\pedestal\\pedestal", 3923380324U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_small_door\\high_small_door", 3922462806U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\hc_introcine_love\\hc_cin_volume\\hc_cin_volume", 3835495207U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3788111956U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 19);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 1, true);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_chubby\\cov_chubby", 3800170764U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\high_charity_stardust\\high_charity_stardust", 3837461317U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_02\\halo_destroyed_02", 3798139117U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_01\\halo_destroyed_01", 3796435155U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\threshold_space\\threshold_space", 3795845322U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\high_charity_exterior", 3799777542U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\battle_cruiser", 3790536825U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3822518881U), 2);
        ...
        public async Task x01_01b_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_chubby\\cov_chubby", 3800170764U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\high_door_grand", 3921545288U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door\\high_door", 3920103474U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\hc_introcine_love\\hc_cin_volume\\hc_cin_volume", 3835495207U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3782934533U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3782934533U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3782934533U), 2);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3782934533U), 7);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 102);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 103);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 104);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 105);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 106);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 107);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 108);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\banshee\\banshee", 3903391539U), 109);
            await sleep(32);
        ...
        public async Task x01_02_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door\\high_door", 3920103474U), 1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 2, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 9);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 30);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 32);
            await sleep(12);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 45, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 1, true);
            await sleep(20);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 9, false);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\pedestal\\pedestal", 3923380324U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3916761087U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3916761087U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3871475020U), 0);
            await sleep(1);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 42, false);
            await sleep(39);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 26);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 29);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 35);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 36);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 37);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 33);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 34);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\melee\\gravity_hammer\\gravity_hammer", 3795058878U), 0);
            await sleep(114);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 23, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet_councillor_prop\\prophet_councillor_prop", 3821142604U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet_councillor_prop\\prophet_councillor_prop", 3821142604U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 5);
            await sleep(89);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3871475020U), 2);
            await sleep(100);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 45, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 33, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 4, false);
        ...
        public async Task x01_03_predict()
        {
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 27, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\reach_space\\reach_space", 3798532339U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\battle_cruiser", 3790536825U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\pillarofautumn\\pillarofautumn", 3793617064U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\high_charity_stardust\\high_charity_stardust", 3837461317U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\halo\\halo", 3837854539U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_02\\halo_destroyed_02", 3798139117U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_01\\halo_destroyed_01", 3796435155U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\threshold_space\\threshold_space", 3795845322U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3787194438U), 0);
        ...
        public async Task x01_05_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3871475020U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_honor_guard\\elite_honor_guard", 3824222843U), 3);
        ...
        public async Task x01_06_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3916761087U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3871475020U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 11);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 10);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 3, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 7);
        ...
        public async Task x01_07_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3787194438U), 0);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\halo_exploding\\halo_exploding", 3791782028U), 0);
        }
        ...
        public async Task x01_08_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\hc_introcine_love\\hc_cin_volume\\hc_cin_volume", 3835495207U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3788111956U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 11);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 1, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 2, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 30);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3782934533U), 7);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3866625282U), 4);
            await sleep(75);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 11, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 39, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3851224087U), 31);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 3);
        ...
        public async Task x01_10_predict()
        {
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 4, true);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 5, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 28);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3838575446U), 40);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_small_door\\high_small_door", 3922462806U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite_councillor_prop\\elite_councillor_prop", 3818848809U), 2);
        ...
        public async Task _01_intro_01_predict()
        {
            await sleep(2);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 27, false);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\moon\\moon", 3813802460U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\earth_space\\earth_space", 3809804703U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad\\inamberclad", 3808231815U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3787194438U), 0);
            await sleep(5);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\longsword\\longsword", 3834708763U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\spacestation\\ss_prop\\ss_prop", 3829138118U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\cairo\\cairo", 3825926805U), 0);
            await sleep(146);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\pillarofautumn\\pillarofautumn", 3793617064U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3836412725U), 0);
        ...
        {
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3894544044U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3894544044U), 71);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3894544044U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3894544044U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\power_core\\power_core", 3811312054U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\optics\\optics", 3810787758U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\equipment_cart\\equipment_cart", 3810197925U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\cairo_armory\\cairo_armory", 3814195682U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3788111956U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3885303327U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\helmet\\helmet", 3811901887U), 0);
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\music\\x01_01_mus", 3924297842U), default(IGameObject), 1F);
        ...
        {
            await sleep(60);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_01a_fol", 3924363379U), default(IGameObject), 1F);
        ...
        public async Task x01_scene_01a()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_01a_fol", 3924363379U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\music\\x01_01_mus", 3924297842U));
            await sleep(this.prediction_offset);
            await sleep(45);
            await this.x01_01a_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_01", default(IUnit), anchor_flag_x01a);
            fade_in(0F, 0F, 0F, 90);
            scenery_animation_start_relative(carrier_01.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x01\\x01", 3924494453U), "01_capital_ship_01", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_01.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "01_ship01", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "01_ship02", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_03.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "01_ship03", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_04.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "01_ship04", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_05.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "01_ship05", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_high_charity.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\x01\\x01", 3924625527U), "high_charity_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_threshold.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\threshold_space\\x01\\x01", 3924691064U), "threshold_space_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_halo_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_01\\x01\\x01", 3924756601U), "halo_destroyed01_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_halo_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\halo_destroyed_02\\x01\\x01", 3924822138U), "halo_destroyed02_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_stardust_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_stardust\\x01\\x01", 3924887675U), "stardust01_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_stardust_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_stardust\\x01\\x01", 3924887675U), "stardust02_01", anchor_x01a.Entity);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_01b_fol", 3924953212U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_01b_fol", 3924953212U), default(IGameObject), 1F);
        ...
        {
            await sleep(203);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0010_der", 3925018749U), default(IGameObject), 1F);
        ...
        public async Task x01_scene_01b()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_01b", default(IUnit), anchor_flag_x01b);
            custom_animation_relative(banshee_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee01_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee02_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_03.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee03_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_04.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee04_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_05.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee05_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_06.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee06_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_07.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee07_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_08.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee08_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_09.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee09_01b", false, anchor_x01b.Entity);
            custom_animation_relative(banshee_10.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\banshee\\x01\\x01", 3925084286U), "banshee10_01b", false, anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_02_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_02_fol", 3925149823U));
            await sleep((short)((float)camera_time() - 1));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_02_fol", 3925149823U), default(IGameObject), 1F);
        ...
        {
            await sleep(19);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0020_pot", 3925215360U), truth.Entity, 1F);
        ...
        {
            await sleep(100);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0030_der", 3925280897U), dervish.Entity, 1F);
        ...
        {
            await sleep(170);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0040_pcc", 3925346434U), default(IGameObject), 1F);
        ...
        {
            await sleep(289);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0050_pom", 3925411971U), mercy.Entity, 1F);
        ...
        {
            await sleep(391);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0060_der", 3925477508U), dervish.Entity, 1F);
        ...
        {
            cinematic_lighting_set_primary_light(-90F, 116F, 0.4F, 0.4F, 0.4F);
            cinematic_lighting_set_secondary_light(-26F, 148F, 0.3F, 0.25F, 0.3F);
            cinematic_lighting_set_ambient_light(0.00784314F, 0.00784314F, 0.00784314F);
            render_lights_enable_cinematic_shadow(true, dervish.Entity, "head", 0.4F);
            rasterizer_bloom_override_threshold(0.25F);
            rasterizer_bloom_override_brightness(0.7F);
        ...
        public async Task x01_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_02", default(IUnit), anchor_flag_x01b);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x01\\x01", 3925543045U), "dervish_02", false, anchor_x01b.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_02", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_02", false, anchor_x01b.Entity);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "tartarus_02", false, anchor_x01b.Entity);
            scenery_animation_start_relative(hammer.Entity, GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\x01\\x01", 3925805193U), "hammer_02", anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_03_predict_stub();
            await this.x01_03_problem_actors();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_03_fol", 3925870730U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_03_fol", 3925870730U), default(IGameObject), 1F);
        ...
        {
            await sleep(65);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0070_der", 3925936267U), default(IGameObject), 1F);
        ...
        public async Task x01_scene_03()
        {
            ...
            camera_set_field_of_view(60F, 0);
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_03", default(IUnit), anchor_flag_x01a);
            fade_in(1F, 1F, 1F, 15);
            scenery_animation_start_relative(poa_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\pillarofautumn\\x01\\x01", 3926001804U), "poa_03", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_01.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship01", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship02", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_03.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship03", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_04.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship04", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_05.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship05", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_06.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship06", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_07.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship07", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_08.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship08", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_09.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "03_ship09", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_reach.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\reach_space\\x01\\x01", 3926067341U), "reach_space_03", anchor_x01a.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            await sleep(12);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0080_por", 3926132878U), default(IGameObject), 1F);
        ...
        {
            await sleep(152);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0090_der", 3926198415U), default(IGameObject), 1F);
        ...
        {
            await sleep(180);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0100_por", 3926263952U), default(IGameObject), 1F);
        ...
        {
            await sleep(238);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0110_der", 3926329489U), default(IGameObject), 1F);
        ...
        public async Task x01_scene_04()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_04", default(IUnit), anchor_flag_x01a);
            scenery_animation_start_relative(cruiser_01.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship01", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_02.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship02", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_03.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship03", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_04.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship04", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_05.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship05", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_06.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship06", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_07.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship07", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_08.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship08", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_09.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship09", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_10.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship10", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_11.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship11", anchor_x01a.Entity);
            scenery_animation_start_relative(cruiser_12.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\battle_cruiser\\x01\\x01", 3924559990U), "04_ship12", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_threshold.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\threshold_space\\x01\\x01", 3924691064U), "threshold_space_04", anchor_x01a.Entity);
            scenery_animation_start_relative(halo_whole.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x01\\x01", 3926395026U), "halo_04", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_stardust_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_stardust\\x01\\x01", 3924887675U), "stardust01_04", anchor_x01a.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_05_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_05_fol", 3926460563U));
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_05_fol", 3926460563U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0120_por", 3926526100U), regret.Entity, 1F);
        ...
        {
            await sleep(141);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0130_por", 3926591637U), regret.Entity, 1F);
        ...
        public async Task x01_scene_05()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_05", default(IUnit), anchor_flag_x01b);
            fade_in(1F, 1F, 1F, 15);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_05", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_05", false, anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_06_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_06_fol", 3926657174U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_06_fol", 3926657174U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0140_der", 3926722711U), dervish.Entity, 1F);
        ...
        {
            await sleep(112);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0150_cch", 3926788248U), default(IGameObject), 1F);
        ...
        {
            await sleep(199);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0160_pom", 3926853785U), mercy.Entity, 1F);
        ...
        {
            await sleep(330);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0170_pot", 3926919322U), truth.Entity, 1F);
        ...
        {
            await sleep(524);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0180_der", 3926984859U), default(IGameObject), 1F);
        ...
        public async Task x01_scene_06()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_06", default(IUnit), anchor_flag_x01b);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x01\\x01", 3925543045U), "dervish_06", false, anchor_x01b.Entity);
            custom_animation_relative(truth.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "truth_06", false, anchor_x01b.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_06", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_06", false, anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_07_predict_stub();
            await this.x01_07_problem_actors();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_07_fol", 3927050396U));
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\foley\\x01_07_fol", 3927050396U), default(IGameObject), 1F);
        ...
        {
            await sleep(93);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0190_der", 3927115933U), default(IGameObject), 1F);
        ...
        public async Task halo_explosion()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\01\\halo_destruction", 3927181470U), halo_exploding.Entity, "explosion_poa_front");
        }
        ...
        public async Task x01_07_setup()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\01_outro\\alpha_halo_explosion", 3927443618U), halo_exploding.Entity, "explosion_poa_front");
        }
        ...
        public async Task x01_scene_07()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_07", default(IUnit), anchor_flag_x01a);
            fade_in(1F, 1F, 1F, 15);
            scenery_animation_start_relative(halo_exploding.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo_exploding\\x01\\x01", 3927967914U), "halo_07", anchor_x01a.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0200_pcc", 3928033451U), default(IGameObject), 1F);
        ...
        {
            await sleep(244);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0210_tar", 3928098988U), tartarus.Entity, 1F);
        ...
        {
            await sleep(279);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0220_por", 3928164525U), regret.Entity, 1F);
        ...
        public async Task x01_0230_pot()
        {
            ...
            await sleep(20);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0230_pot", 3928230062U), truth.Entity, 1F);
        ...
        {
            await sleep(705);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0240_pot", 3928295599U), truth.Entity, 1F);
        ...
        public async Task x01_scene_08()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_08", default(IUnit), anchor_flag_x01b);
            fade_in(1F, 1F, 1F, 15);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x01\\x01", 3925543045U), "dervish_08", false, anchor_x01b.Entity);
            custom_animation_relative(truth.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "truth_08", false, anchor_x01b.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_08", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_08", false, anchor_x01b.Entity);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "tartarus_08", false, anchor_x01b.Entity);
            custom_animation_relative(prophet_counc_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "prophet01_08", false, anchor_x01b.Entity);
            custom_animation_relative(prophet_counc_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "prophet02_08", false, anchor_x01b.Entity);
            custom_animation_relative(elite_counc_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\x01\\x01", 3928361136U), "elite01_08", false, anchor_x01b.Entity);
            custom_animation_relative(elite_counc_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\elite\\x01\\x01", 3928361136U), "elite02_08", false, anchor_x01b.Entity);
            scenery_animation_start_relative(hammer.Entity, GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\x01\\x01", 3925805193U), "hammer_08", anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0250_pc1", 3928426673U), default(IGameObject), 1F);
        ...
        {
            await sleep(60);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0260_pcc", 3928492210U), default(IGameObject), 1F);
        ...
        {
            await sleep(252);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0270_der", 3928557747U), dervish.Entity, 1F);
        ...
        {
            await sleep(376);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0280_pot", 3928623284U), truth.Entity, 1F);
        ...
        {
            await sleep(494);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0290_tar", 3928688821U), tartarus.Entity, 1F);
        ...
        public async Task x01_scene_09()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_09", default(IUnit), anchor_flag_x01b);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x01\\x01", 3925543045U), "dervish_09", false, anchor_x01b.Entity);
            custom_animation_relative(truth.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "truth_09", false, anchor_x01b.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_09", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_09", false, anchor_x01b.Entity);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "tartarus_09", false, anchor_x01b.Entity);
            custom_animation_relative(prophet_counc_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "prophet01_09", false, anchor_x01b.Entity);
            custom_animation_relative(prophet_counc_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "prophet02_09", false, anchor_x01b.Entity);
            scenery_animation_start_relative(hammer.Entity, GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\x01\\x01", 3925805193U), "hammer_09", anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this.x01_10_predict_stub();
            await this.x01_10_problem_actors();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\music\\x01_c01_intro_trans_mus", 3928754358U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(79);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\x01\\music\\x01_c01_intro_trans_mus", 3928754358U), default(IGameObject), 1F);
        ...
        {
            await sleep(20);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0300_pot", 3928819895U), truth.Entity, 1F);
        ...
        {
            await sleep(98);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0310_cch", 3928885432U), default(IGameObject), 1F);
        ...
        {
            await sleep(180);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0320_pot", 3928950969U), default(IGameObject), 1F);
        ...
        {
            await sleep(329);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\x01_0330_pot", 3929016506U), truth.Entity, 1F);
        ...
        public async Task x01_scene_10()
        {
            ...
            camera_set_field_of_view(60F, 0);
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x01\\x01", 3924428916U), "x01_10", default(IUnit), anchor_flag_x01b);
            custom_animation_relative(dervish.Entity, GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x01\\x01", 3925543045U), "dervish_10", false, anchor_x01b.Entity);
            custom_animation_relative(truth.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "truth_10", false, anchor_x01b.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "mercy_10", false, anchor_x01b.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\x01\\x01", 3925674119U), "regret_10", false, anchor_x01b.Entity);
            custom_animation_relative(tartarus.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "tartarus_10", false, anchor_x01b.Entity);
            custom_animation_relative(brute_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "brute01_10", false, anchor_x01b.Entity);
            custom_animation_relative(brute_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\brute\\x01\\x01", 3925739656U), "brute02_10", false, anchor_x01b.Entity);
            scenery_animation_start_relative(hammer.Entity, GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\x01\\x01", 3925805193U), "hammer_10", anchor_x01b.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._01_intro_01_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\c01_intro\\foley\\c01_intro_01_fol", 3929082043U));
            cinematic_screen_effect_start(true);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\c01_intro\\foley\\c01_intro_01_fol", 3929082043U), default(IGameObject), 1F);
        ...
        {
            await sleep(390);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\c01_1010_qtm", 3929147580U), default(IGameObject), 1F);
        ...
        public async Task c01_intro_scene_01()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\01_intro\\01_intro", 3929213117U), "01_intro_01", default(IUnit), anchor_flag_x01a);
            scenery_animation_start_relative(athens.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\spacestation\\ss_prop\\01_intro\\01_intro", 3929278654U), "ss_prop01_01", anchor_x01a.Entity);
            scenery_animation_start_relative(cairo.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cairo\\cairo", 3828941507U), "01_intro_01", anchor_x01a.Entity);
            scenery_animation_start_relative(malta.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\spacestation\\ss_prop\\01_intro\\01_intro", 3929278654U), "ss_prop03_01", anchor_x01a.Entity);
            scenery_animation_start_relative(iac_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\01_intro\\01_intro", 3929344191U), "iac_01", anchor_x01a.Entity);
            scenery_animation_start_relative(iac_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\01_intro\\01_intro", 3929344191U), "iac_02", anchor_x01a.Entity);
            scenery_animation_start_relative(iac_03.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\01_intro\\01_intro", 3929344191U), "iac_03", anchor_x01a.Entity);
            scenery_animation_start_relative(iac_04.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\01_intro\\01_intro", 3929344191U), "iac_04", anchor_x01a.Entity);
            scenery_animation_start_relative(iac_05.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\01_intro\\01_intro", 3929344191U), "iac_05", anchor_x01a.Entity);
            scenery_animation_start_relative(poa_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\pillarofautumn\\01_intro\\01_intro", 3929409728U), "poa_01", anchor_x01a.Entity);
            scenery_animation_start_relative(poa_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\pillarofautumn\\01_intro\\01_intro", 3929409728U), "poa_02", anchor_x01a.Entity);
            scenery_animation_start_relative(poa_03.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\pillarofautumn\\01_intro\\01_intro", 3929409728U), "poa_03", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_01", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_02", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_03.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_03", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_04.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_04", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_05.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_05", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_06.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_06", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_07.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_07", anchor_x01a.Entity);
            scenery_animation_start_relative(fighter_08.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\longsword\\01_intro\\01_intro", 3929475265U), "longsword_08", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_earth.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\earth_space\\01_intro\\01_intro", 3929540802U), "earth_space_01", anchor_x01a.Entity);
            scenery_animation_start_relative(matte_moon.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\moon\\01_intro\\01_intro", 3929606339U), "moon_01", anchor_x01a.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._01_intro_02_predict_stub();
            await this.c01_02_problem_actors();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\c01_intro\\foley\\c01_intro_02_fol", 3929671876U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\01_spacestation\\c01_intro\\foley\\c01_intro_02_fol", 3929671876U), default(IGameObject), 1F);
            print("c01 intro foley 01 start");
        }
        ...
        {
            await sleep(18);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\c01_1020_qtm", 3929737413U), master_guns.Entity, 1F);
        ...
        {
            await sleep(91);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\c01_1030_qtm", 3929802950U), master_guns.Entity, 1F);
        ...
        {
            await sleep(173);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\c01_1040_qtm", 3929868487U), master_guns.Entity, 1F);
        ...
        {
            await sleep(396);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\cinematic\\c01_1050_mas", 3929934024U), chief.Entity, 1F);
        ...
        public async Task c01_intro_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\01_intro\\01_intro", 3929213117U), "01_intro_02", default(IUnit), anchor_flag_x01a);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\01_intro\\01_intro", 3929999561U), "chief_02", false, anchor_x01a.Entity);
            custom_animation_relative(master_guns.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\01_intro\\01_intro", 3930065098U), "quartermaster_02", false, anchor_x01a.Entity);
            scenery_animation_start_relative(armory.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cairo_armory\\01_intro\\01_intro", 3930196172U), "cairo_armory_02", anchor_x01a.Entity);
            scenery_animation_start_relative(cart.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\equipment_cart\\01_intro\\01_intro", 3930261709U), "equipment_cart_02", anchor_x01a.Entity);
            scenery_animation_start_relative(optics.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\optics\\01_intro\\01_intro", 3930327246U), "optics_02", anchor_x01a.Entity);
            scenery_animation_start_relative(power_supply.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\power_core\\01_intro\\01_intro", 3930392783U), "power_supply_02", anchor_x01a.Entity);
            scenery_animation_start_relative(helmet.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\helmet\\01_intro\\01_intro", 3930458320U), "helmet_02", anchor_x01a.Entity);
            await sleep((short)((float)camera_time() - 15));
