...
#region Fields
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\music\\c07_intra1_05_mus", 3828679359U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_05_fol", 3828744896U), default(IGameObject), 1F);
        ...
        public async Task c07_intra1_scene_05()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\music\\c07_intra1_05_mus", 3828679359U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_05_fol", 3828744896U));
            await sleep(this.prediction_offset);
            await this.c07_intra1_05_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_intra1\\07_intra1", 3828810433U), "07_intra1_05", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_intra1\\07_intra1", 3828875970U), "chief_05", false, anchor_intra1.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\07_intra1\\07_intra1", 3828941507U), "mercy_05", false, anchor_intra1.Entity);
            custom_animation_relative(infection_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\flood_infection\\07_intra1\\07_intra1", 3829072581U), "infection01_05", false, anchor_intra1.Entity);
            custom_animation_relative(throne_mercy.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\gravity_throne\\animations\\07_intra1\\07_intra1", 3829138118U), "throne_mercy_05", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\07_intra1\\07_intra1", 3829203655U), "phantom1_05", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_02.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\07_intra1\\07_intra1", 3829203655U), "phantom2_05", false, anchor_intra1.Entity);
            custom_animation_relative(phantom_03.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\phantom\\animations\\07_intra1\\07_intra1", 3829203655U), "phantom3_05", false, anchor_intra1.Entity);
            fade_in(1F, 1F, 1F, 15);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_06_fol", 3829269192U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_06_fol", 3829269192U), default(IGameObject), 1F);
        ...
        {
            await sleep(45);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2080_mas", 3829334729U), chief.Entity, 1F);
        ...
        {
            await sleep(180);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2090_pom", 3829400266U), mercy.Entity, 1F);
        ...
        {
            await sleep(283);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2100_pom", 3829465803U), mercy.Entity, 1F);
        ...
        {
            await sleep(451);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2101_pom", 3829531340U), mercy.Entity, 1F);
        }
        ...
        {
            await sleep(566);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2110_cor", 3829596877U), cortana.Entity, 1F);
        ...
        {
            await sleep(621);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2120_cor", 3829662414U), cortana.Entity, 1F);
        ...
        public async Task infection_pop()
        {
            await sleep(510);
            print("infection pop");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\flood_infection\\body_depleted", 3829727951U), infection_02.Entity, "");
            await sleep(1);
        ...
        public async Task c07_intra1_scene_06()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_intra1\\07_intra1", 3828810433U), "07_intra1_06", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_intra1\\07_intra1", 3828875970U), "chief_06", false, anchor_intra1.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\07_intra1\\07_intra1", 3828941507U), "mercy_06", false, anchor_intra1.Entity);
            custom_animation_relative(infection_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\flood_infection\\07_intra1\\07_intra1", 3829072581U), "infection01_06", false, anchor_intra1.Entity);
            custom_animation_relative(infection_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\flood_infection\\07_intra1\\07_intra1", 3829072581U), "infection02_06", false, anchor_intra1.Entity);
            custom_animation_relative(throne_mercy.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\gravity_throne\\animations\\07_intra1\\07_intra1", 3829138118U), "throne_mercy_06", false, anchor_intra1.Entity);
            await sleep(556);
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\cortana\\cortana_on_off_25", 3830448858U), cortana_base.Entity, "marker");
            custom_animation_relative(cortana.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\07_intra1\\07_intra1", 3831431913U), "cortana_06", false, anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2130_cor", 3831562987U), cortana.Entity, 1F);
        ...
        {
            await sleep(110);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2140_cor", 3831628524U), cortana.Entity, 1F);
        ...
        {
            await sleep(150);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2150_mas", 3831694061U), chief.Entity, 1F);
        ...
        {
            await sleep(297);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2160_cor", 3831759598U), cortana.Entity, 1F);
        ...
        {
            await sleep(490);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2170_cor", 3831825135U), cortana.Entity, 1F);
        ...
        {
            await sleep(622);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2180_cor", 3831890672U), cortana.Entity, 1F);
        ...
        public async Task c07_2190_cor()
        {
            ...
            await sleep(13);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_2190_cor", 3831956209U), cortana.Entity, 1F);
        ...
        public async Task c07_intra1_scene_07()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_intra1\\07_intra1", 3828810433U), "07_intra1_07", default(IUnit), anchor_flag_intra1);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_intra1\\07_intra1", 3828875970U), "chief_07", false, anchor_intra1.Entity);
            custom_animation_relative(cortana.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\07_intra1\\07_intra1", 3831431913U), "cortana_07", false, anchor_intra1.Entity);
            custom_animation_relative(mercy.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\07_intra1\\07_intra1", 3828941507U), "mercy_07", false, anchor_intra1.Entity);
            custom_animation_relative(throne_mercy.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\gravity_throne\\animations\\07_intra1\\07_intra1", 3829138118U), "throne_mercy_07", false, anchor_intra1.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._07_intra1_08_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_08_fol", 3832021746U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_intra1\\foley\\c07_intra1_08_fol", 3832021746U), default(IGameObject), 1F);
        ...
        public async Task pelican_crash_01()
        {
            await sleep(38);
            print("crash 1");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit_small", 3832087283U), pelican_01.Entity, "hardpoint_right");
        }
        ...
        public async Task pelican_crash_02()
        {
            await sleep(49);
            print("crash 2");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit", 3832677116U), pelican_01.Entity, "johnson");
        }
        ...
        public async Task pelican_crash_03()
        {
            await sleep(101);
            print("crash 3");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit", 3832677116U), pelican_01.Entity, "pelican_p_l05");
        }
        ...
        public async Task c07_intra1_scene_08()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_intra1\\07_intra1", 3828810433U), "07_intra1_08", default(IUnit), anchor_flag_intra1);
            camera_set_field_of_view(26F, 0);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_intra1\\07_intra1", 3828875970U), "chief_08", false, anchor_intra1.Entity);
            custom_animation_relative(cortana.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\07_intra1\\07_intra1", 3831431913U), "cortana_08", false, anchor_intra1.Entity);
            custom_animation_relative(pelican_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\07_intra1\\07_intra1", 3832873727U), "pelican_08", false, anchor_intra1.Entity);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\music\\c07_outro_01_mus", 3832939264U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_01_fol", 3833004801U), default(IGameObject), 1F);
        ...
        public async Task ship_initial_blast()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\cinematics\\forerunner_ship\\initial_take_off_scale5", 3833070338U), forerunner_ship.Entity, "thruster");
        }
        ...
        public async Task c07_outro_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\music\\c07_outro_01_mus", 3832939264U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_01_fol", 3833004801U));
            await sleep(this.prediction_offset);
            await this.c07_outro_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_outro\\07_outro", 3833791245U), "07_outro_01", default(IUnit), anchor_flag_outro1);
            custom_animation_relative(chief_outro.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_outro\\07_outro", 3833856782U), "chief_01", false, anchor_outro1.Entity);
            scenery_animation_start_relative(forerunner_ship.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship\\07_outro\\07_outro", 3833922319U), "forerunner_ship_01", anchor_outro1.Entity);
            scenery_animation_start_relative(alcove.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship_alcove\\07_outro\\07_outro", 3833987856U), "alcove_01", anchor_outro1.Entity);
            scenery_animation_start_relative(cap.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_cap\\07_outro\\07_outro", 3834053393U), "conduit_cap_01", anchor_outro1.Entity);
            scenery_animation_start_relative(conduit.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit\\07_outro\\07_outro", 3834118930U), "conduit_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring01_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring02_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_03.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring03_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_04.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring04_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_05.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring05_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_06.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring06_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_07.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring07_01", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_08.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring08_01", anchor_outro1.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._07_outro_02_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_02_fol", 3834250004U));
            await sleep((short)camera_time());
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_02_fol", 3834250004U), default(IGameObject), 1F);
        ...
        {
            await sleep(38);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_9010_cor", 3834315541U), default(IGameObject), 1F, "radio_default_loop");
        ...
        {
            await sleep(104);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_9020_mas", 3834381078U), chief_outro.Entity, 1F);
        ...
        {
            await sleep(147);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_9030_cor", 3834446615U), default(IGameObject), 1F, "radio_default_loop");
        ...
        {
            await sleep(211);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\cinematic\\c07_9040_cor", 3834512152U), cortana_outro.Entity, 1F);
        ...
        public async Task chief_sparks()
        {
            await sleep(17);
            print("chief sparks");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\07\\chief_sparks", 3834577689U), chief_outro.Entity, "body");
        }
        ...
        public async Task ship_take_off_01()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\cinematics\\forerunner_ship\\initial_take_off_scale12", 3834643226U), forerunner_ship.Entity, "thruster");
        ...
        public async Task c07_outro_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_outro\\07_outro", 3833791245U), "07_outro_02", default(IUnit), anchor_flag_outro1);
            custom_animation_relative(chief_outro.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\07_outro\\07_outro", 3833856782U), "chief_02", false, anchor_outro1.Entity);
            custom_animation_relative(cortana_outro.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\07_outro\\07_outro", 3834839837U), "cortana_02", false, anchor_outro1.Entity);
            scenery_animation_start_relative(forerunner_ship.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship\\07_outro\\07_outro", 3833922319U), "forerunner_ship_02", anchor_outro1.Entity);
            scenery_animation_start_relative(alcove.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship_alcove\\07_outro\\07_outro", 3833987856U), "alcove_02", anchor_outro1.Entity);
            scenery_animation_start_relative(cap.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_cap\\07_outro\\07_outro", 3834053393U), "conduit_cap_02", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_01.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring01_02", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_02.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring02_02", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_03.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring03_02", anchor_outro1.Entity);
            scenery_animation_start_relative(ring_04.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\covenant\\conduit_ring\\07_outro\\07_outro", 3834184467U), "ring04_02", anchor_outro1.Entity);
            scenery_animation_start_relative(bloom_quad.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\special\\bloom_quad\\07_outro\\07_outro", 3834905374U), "bloom_quad_02", anchor_outro1.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._07_outro_03_predict_stub();
            await this.c07_outro_03_problem_actors();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_03_fol", 3834970911U));
            cinematic_screen_effect_start(true);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\07_highcharity\\c07_outro\\foley\\c07_outro_03_fol", 3834970911U), default(IGameObject), 1F);
        ...
        public async Task ship_take_off_02()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\cinematics\\forerunner_ship\\initial_take_off_scale01", 3835036448U), forerunner_ship.Entity, "thruster");
        }
        ...
        public async Task ship_take_off_03()
        {
            ...
            await sleep(111);
            print("effect - take off 02");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\cinematics\\forerunner_ship\\initial_take_off_scale04", 3835298596U), forerunner_ship.Entity, "thruster");
        }
        ...
        public async Task c07_outro_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\07_outro\\07_outro", 3833791245U), "07_outro_03", default(IUnit), anchor_flag_outro2);
            scenery_animation_start_relative(forerunner_ship.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship\\07_outro\\07_outro", 3833922319U), "forerunner_ship_03", anchor_outro2.Entity);
            scenery_animation_start_relative(matte_high_charity.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\07_outro\\07_outro", 3835560744U), "high_charity_03", anchor_outro2.Entity);
            scenery_animation_start_relative(matte_substance.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\07_outro\\07_outro", 3835626281U), "substance_03", anchor_outro2.Entity);
            fade_in(1F, 1F, 1F, 15);
        ...
        public async Task cs_expand_cortana()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\cortana\\cortana_on_off_65", 4176942787U), ai_get_object(this.ai_current_actor), "effect");
            await sleep(1);
        ...
        public async Task music_07b_01_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_01", 4177008324U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_01_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_01", 4177008324U));
        }
        ...
        public async Task music_07b_02_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_02", 4177204935U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_03_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_03", 4177336009U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_03_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_03", 4177336009U));
        }
        ...
        public async Task music_07b_04_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_04", 4177663694U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_04_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_04", 4177663694U));
        }
        ...
        public async Task music_07b_05_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_05", 4177860305U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_05_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_05", 4177860305U));
        }
        ...
        public async Task music_07b_06_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_06", 4178056916U), default(IGameObject), 1F);
        }
        ...
        public async Task music_07b_06_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\07b_forerunnership\\07b_music\\07b_06", 4178056916U));
        }
        ...
        public async Task e1_dia_truth_holycity()
        {
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0280_pot", 4118680413U), e5_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0280_pot", 4118680413U), e5_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0280_pot", 4118680413U), e5_speaker5.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0280_pot", 4118680413U), e5_speaker0.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0280_pot", 4118680413U), e5_speaker1.Entity, 1F, 1);
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0200_pot", 4118156117U), e5_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0200_pot", 4118156117U), e5_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0200_pot", 4118156117U), e5_speaker5.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0200_pot", 4118156117U), e5_speaker0.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0200_pot", 4118156117U), e5_speaker1.Entity, 1F, 1);
        ...
        public async Task e7_dia_filtration_systems()
        {
            ...
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_2850_cor", 4125234113U)));
            await sleep(this.dialogue_pause);
        }
        ...
        public async Task e12_tickle()
        {
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker5.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker6.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker7.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker8.Entity, 1F, 1);
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0260_pot", 4118549339U), e12_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0260_pot", 4118549339U), e12_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0260_pot", 4118549339U), e12_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0260_pot", 4118549339U), e12_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker5.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker6.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker7.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0330_pot", 4119008098U), e12_speaker8.Entity, 1F, 1);
        ...
        public async Task e12_final_battle()
        {
            ...
            if (this.g_e12_side)
            {
                ...
                begin_random(async () => sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e12_howler1.Entity, 1F), 
                    async () => ai_place(e12_fld_inf4.guy1), 
                    async () => ai_place(e12_fld_inf4.guy2), 
                    async () => ai_place(e12_fld_inf4.guya), 
                    async () => sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e12_howler2.Entity, 1F), 
        ...
        public async Task e10_sanctum2()
        {
            ...
            if (volume_test_objects(tv_e10_screen, players()))
            {
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_2890_cor", 4125496261U)));
                await sleep((short)(this.dialogue_pause * 2));
            }
            ...
            if (volume_test_objects(tv_e10_screen, players()))
            {
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_2900_cor", 4125561798U)));
                this.g_e10_talk = 9;
            }
        ...
        public async Task e10_storm()
        {
            ...
            begin_random(async () =>
            {
                ...
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e10_howler1.Entity, 1F);
                    ai_place(e10_fld_inf1.guy1);
                    ai_place(e10_fld_inf1.guy2);
                    ai_place(e10_fld_inf1.guy3);
                    await sleep((short)random_range(90, 150));
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e10_howler3.Entity, 1F);
                ...
                async () =>
            {
                if ((short)ai_living_count(e10_flood_storm) <= 3)
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e10_howler2.Entity, 1F);
                    ai_place(e10_fld_inf1.guy4);
                    ai_place(e10_fld_inf1.guy5);
                    ai_place(e10_fld_inf1.guy6);
                    await sleep((short)random_range(90, 150));
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e10_howler4.Entity, 1F);
        ...
        public async Task e10_talking_points()
        {
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0170_pot", 4117959506U), e10_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0170_pot", 4117959506U), e10_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0170_pot", 4117959506U), e10_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0170_pot", 4117959506U), e10_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0170_pot", 4117959506U), e10_speaker5.Entity, 1F, 1);
        ...
        public async Task e10_key()
        {
            ...
            object_create(key);
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4095283704U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4095283704U)));
                ...
                if (volume_test_objects_all(tv_e9_trigger1, players()))
                {
                    begin_random(async () =>
                    {
                        if ((short)ai_living_count(e9_fld_inf11.Squad) <= 0)
                        {
                            ...
                            sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e9_howler1.Entity, 1F);
                        }
                    }, 
                        async () =>
                    {
        ...
        public async Task e8_sneaky_spawner_dialogue()
        {
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0210_pot", 4118221654U), e8_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0210_pot", 4118221654U), e8_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0210_pot", 4118221654U), e8_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0210_pot", 4118221654U), e8_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0210_pot", 4118221654U), e8_speaker5.Entity, 1F, 1);
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0270_pot", 4118614876U), e8_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0270_pot", 4118614876U), e8_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0270_pot", 4118614876U), e8_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0270_pot", 4118614876U), e8_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0270_pot", 4118614876U), e8_speaker5.Entity, 1F, 1);
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5000_grv", 4126807001U), e8_speaker_gm1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5000_grv", 4126807001U), e8_speaker_gm2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5000_grv", 4126807001U), e8_speaker_gm3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5000_grv", 4126807001U), e8_speaker_gm4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5000_grv", 4126807001U), e8_speaker_gm5.Entity, 1F, 1);
            ...
            if (await this.difficulty_normal() || await this.difficulty_heroic())
            {
                begin_random(async () =>
                {
                    if ((short)ai_living_count(e8_fld_inf1.Squad) <= 3 && volume_test_objects(tv_e8_cave_check, players()))
                    {
                        if (random_range(0, 2) == 1 ? true : false)
                        {
                            sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e8_howler1.Entity, 1F);
                        }
                        else
                        {
                            sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e8_howler3.Entity, 1F);
                        }
        ...
        public async Task e7_start()
        {
            ...
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_2860_cor", 4125299650U)));
            await sleep(this.dialogue_pause);
            if (this.dialogue)
            {
            ...
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_2870_cor", 4125365187U)));
            await sleep(this.dialogue_pause);
        ...
        public async Task e6_talking()
        {
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0190_pot", 4118090580U), e6_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0190_pot", 4118090580U), e6_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0190_pot", 4118090580U), e6_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0190_pot", 4118090580U), e6_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_0190_pot", 4118090580U), e6_speaker5.Entity, 1F, 1);
            ...
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker1.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker2.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker3.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker4.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker5.Entity, 1F, 1);
            sound_impulse_trigger(GetTag<SoundTag>("sound\\dialog\\levels\\07_highcharity\\mission\\l07_5010_grv", 4126872538U), e6_speaker_gm1.Entity, 1F, 1);
        ...
        public async Task e6_ambush()
        {
            ...
            begin_random(async () =>
            {
                ...
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler_spec1.Entity, 1F);
                ...
                async () =>
            {
                if ((short)ai_living_count(e6_flood_storm) <= 5 && volume_test_objects(tv_e6_ambusher, players()))
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler_spec2.Entity, 1F);
                ...
                async () =>
            {
                if ((short)ai_living_count(e6_flood_storm) <= 5 && volume_test_objects(tv_e6_ambusher, players()))
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler_spec3.Entity, 1F);
                ...
                async () =>
            {
                if ((short)ai_living_count(e6_flood_storm) <= 5 && volume_test_objects(tv_e6_ambusher, players()))
                {
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler_spec4.Entity, 1F);
        ...
        public async Task e6_flood_attack_2()
        {
            ...
            begin_random(async () =>
            {
                if ((short)ai_living_count(e6_flood_group_2) <= 0)
                {
                    ...
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler1.Entity, 1F);
                }
            }, 
                async () =>
            {
                if ((short)ai_living_count(e6_flood_group_2) <= 0)
                {
                    ...
                    sound_impulse_start(GetTag<SoundTag>("sound\\characters\\flood\\flood_howls", 4178450138U), e6_howler2.Entity, 1F);
                }
            });
        ...
        public async Task e1_mercy()
        {
            ...
            await sleep(10);
            scenery_animation_start_loop(ledge_99.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3892315785U), "mercy_dead");
        }
        ...
        public async Task _07_intra1_05_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3835691818U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3835691818U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\fp_covenant_carbine\\fp_covenant_carbine", 3807183223U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_hallway_signs\\holo_hallway_signs", 3837264706U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3837854539U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 2);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\high_door_grand", 3839296353U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 7);
            await sleep(6);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 0);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\civilian_cov_crate\\civilian_cov_crate", 3841852296U), 0);
            await sleep(25);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 2, true);
            await sleep(10);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 1);
            await sleep(3);
            ...
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3842245518U), 1);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\battery\\battery", 3842573203U), 0);
            await sleep(3);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 13, true);
            await sleep(6);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3843228573U), 0);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 2);
            await sleep(51);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\flood_infection\\flood_infection", 3844866998U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3845325757U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3845325757U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\civilian_cov_crate\\civilian_cov_crate", 3841852296U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\battery\\battery", 3842573203U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3846177738U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3846177738U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3846177738U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3846177738U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3851944994U), 0);
            await sleep(26);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3841786759U), 1);
            await sleep(103);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 8, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3852665901U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3843228573U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher", 3852993586U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3842245518U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\high_door_grand", 3839296353U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3842114444U), 0);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 12, true);
            await sleep(46);
        ...
        public async Task _07_intra1_06_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3851944994U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3854173252U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 8);
            await sleep(119);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 3, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\flood_infection\\flood_infection", 3844866998U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3845325757U), 3);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 8);
            await sleep(10);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3842245518U), 3);
            await sleep(53);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3837854539U), 0);
        }
        ...
        public async Task _07_intra1_07_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3851944994U), 1);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 8);
        ...
        public async Task _07_intra1_08_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3837854539U), 0);
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3855549529U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3856991343U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3856991343U), 1);
            await sleep(8);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 5, true);
            await sleep(50);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 13, true);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 12, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3843228573U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\battery\\battery", 3842573203U), 1);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\phantom\\phantom", 3840869241U), 0);
            ...
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_5"), 12, true);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 15);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 20);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 21);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 24);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3823764084U), 0);
            await sleep(8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 22);
            await sleep(31);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 31);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 32);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 33);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 34);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 36);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 37);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 38);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 41);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 42);
            await sleep(14);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 11);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 12);
        }
        ...
        public async Task _07_outro_01_predict()
        {
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\civilian_cov_crate\\civilian_cov_crate", 3841852296U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 20);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_shipping_crate\\high_shipping_crate", 3845915590U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3855549529U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 5);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_human\\floodcombat_human", 3858629768U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3859219601U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3859219601U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcombat_elite\\floodcombat_elite", 3857581176U), 10);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\magnum\\magnum", 3860006045U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 36);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 37);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3860464804U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\brute_plasma_rifle\\brute_plasma_rifle", 3863217358U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\brute_plasma_rifle\\brute_plasma_rifle", 3863217358U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_sack\\flood_sack", 3863807191U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_clump\\flood_clump", 3864397024U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_floor_clump_large\\flood_floor_clump_large", 3864462561U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_pod\\flood_pod", 3864528098U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3835691818U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3835691818U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\fp_covenant_carbine\\fp_covenant_carbine", 3807183223U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\battery\\battery", 3842573203U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\high_door_grand", 3839296353U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 5);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\crashed\\crashed", 3858564231U), 6);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_tentacle_c\\flood_tentacle_c", 3864593635U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_tentacle_b\\flood_tentacle_b", 3864659172U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_tentacle_a\\flood_tentacle_a", 3864724709U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3788177493U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcarrier\\floodcarrier", 3864790246U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcarrier\\floodcarrier", 3864790246U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\floodcarrier\\floodcarrier", 3864790246U), 2);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 4);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\sky_high_cinematic\\sky_high_cinematic", 3787980882U), 5);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3865052394U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\covenant\\conduit\\conduit", 3866297597U), 0);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\covenant\\conduit_ring\\conduit_ring", 3866559745U), 0);
        }
        ...
        public async Task _07_outro_02_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 8);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\bloom_quad\\bloom_quad", 3868591392U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\covenant\\conduit_ring\\conduit_ring", 3866559745U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3837854539U), 0);
            await sleep(59);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3855549529U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3838182224U), 19);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\bloom_quad\\bloom_quad", 3868591392U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\forerunner_ship\\forerunner_ship", 3868853540U), 0);
            await sleep(142);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\07b_forerunnership\\high_9_cinematic"), 4, true);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3854369863U), 7);
        ...
        {
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\substance_space\\substance_space", 3869902132U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\high_charity_exterior", 3870229817U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3786211383U), 0);
            await sleep(160);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3842114444U), 0);
        }
    }
