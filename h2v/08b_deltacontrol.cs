...
#region Fields
 ...
 == "normal";
        ...
        public async Task cs_boss_tartarus_cheer()
        {
            ...
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\brute", 3972074315U), "combat:rifle:cheer", true);
            await Engine.sleep(60);
        }
        ...
        public async Task cs_boss_tartarus_taunt()
        {
            ...
            Engine.cs_face_player(true);
            await Engine.sleep(60);
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\brute", 3972074315U), "combat:rifle:taunt", true);
            await Engine.sleep(60);
        }
        ...
        public async Task cs_boss_tartarus_shakefist()
        {
            ...
            Engine.cs_face_player(true);
            await Engine.sleep(60);
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\brute", 3972074315U), "combat:rifle:shakefist", true);
            await Engine.sleep(60);
        }
        ...
        public async Task boss_tartarus_taunt()
        {
            if (this.counter_boss_tartarus_taunt == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_0980_tar", 4200995056U), Engine.ai_get_object(boss_tartarus.Squad), 1F);
            }
            else if (this.counter_boss_tartarus_taunt == 1)
            {
                Engine.print("you want revenge?! well here i am! come and take it!");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_0990_tar", 4201060593U), Engine.ai_get_object(boss_tartarus.Squad), 1F);
            }
            else if (this.counter_boss_tartarus_taunt == 2)
            {
                Engine.print("just like the rest of your kind - you are cowardly and weak!");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1000_tar", 4201126130U), Engine.ai_get_object(boss_tartarus.Squad), 1F);
            }
            else if (true)
            {
                this.counter_boss_tartarus_taunt = 0;
        ...
        public async Task boss_johnson_prompt()
        {
            ...
            if (this.counter_boss_johnson_prompt == (short)(1 * this.skip_boss_johnson_prompt))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2010_jon", 4202567944U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
            else if (this.counter_boss_johnson_prompt == (short)(2 * this.skip_boss_johnson_prompt))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2020_jon", 4202633481U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
            else if (this.counter_boss_johnson_prompt == (short)(3 * this.skip_boss_johnson_prompt))
            {
                Engine.print("there goes his shield!");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2030_jon", 4202699018U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
            else if (this.counter_boss_johnson_prompt == (short)(4 * this.skip_boss_johnson_prompt))
            {
                Engine.print("got his shield! hit him now!");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2040_jon", 4202764555U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
            else if (this.counter_boss_johnson_prompt == (short)(5 * this.skip_boss_johnson_prompt))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2050_jon", 4202830092U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
            else if (this.counter_boss_johnson_prompt == (short)(6 * this.skip_boss_johnson_prompt))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_2060_jon", 4202895629U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            }
        ...
        public async Task boss_flavor()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\ambience\\deltacontolroom\\boss\\stage1", 4256767024U), default(IGameObject), 1F);
            await Engine.sleep((short)(5 * this.game_seconds));
            Engine.print("charging sequence initiated! primary generators coming on-line!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1040_gsp", 4201388278U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1040_gsp", 4201388278U)));
            Engine.print("well, shut them down!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1050_mir", 4201453815U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1050_mir", 4201453815U)));
            Engine.print("apology. protocol does allow me to interfere with any aspect of the sequence.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1060_gsp", 4201519352U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1060_gsp", 4201519352U)));
            Engine.print("then how do i stop it?!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1120_mir", 4201912574U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1120_mir", 4201912574U)));
            Engine.print("well\u0085it will take some time to go over the proper procedures\u0085");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1130_gsp", 4201978111U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1130_gsp", 4201978111U)));
            Engine.print("quit stalling!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1140_mir", 4202043648U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1140_mir", 4202043648U)));
            Engine.print("under more controlled circumstances, i would suggest the reclaimer simply remove the index.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1150_gsp", 4202109185U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1150_gsp", 4202109185U)));
            Engine.print("that's it?! johnson, i'm on it!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1160_mir", 4202174722U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1160_mir", 4202174722U)));
            Engine.print("hang-tight, ma'am! not until that brute is dead!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1170_jon", 4202240259U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1170_jon", 4202240259U)));
            this.boss_flavor_done = true;
            await Engine.sleep((short)(30 * this.game_seconds));
            this.boss_flavor_done = false;
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\ambience\\deltacontolroom\\boss\\stage2", 4256832561U), default(IGameObject), 1F);
            await Engine.sleep((short)(5 * this.game_seconds));
            Engine.print("secondary generators charging! all systems are performing well within operational parameters!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1070_gsp", 4201584889U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1070_gsp", 4201584889U)));
            Engine.print("you're telling me you can't stop the sequence?");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1080_mir", 4201650426U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1080_mir", 4201650426U)));
            Engine.print("reclaimer, please understand: interrupting the wave-generation process will severely damage this installation.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1090_gsp", 4201715963U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1090_gsp", 4201715963U)));
            Engine.print("give me a direct answer!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1100_mir", 4201781500U), Engine.ai_get_object(boss_miranda.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1100_mir", 4201781500U)));
            Engine.print("i am but a monitor. the reclaimer can do what it likes.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1110_gsp", 4201847037U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1110_gsp", 4201847037U)));
            this.boss_flavor_done = true;
            await Engine.sleep((short)(30 * this.game_seconds));
            this.boss_flavor_done = false;
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\ambience\\deltacontolroom\\boss\\stage3", 4256898098U), default(IGameObject), 1F);
            await Engine.sleep((short)(5 * this.game_seconds));
            Engine.print("power-generation phase complete! the installation is ready to fire! starting final countdown\u0085");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1180_gsp", 4202305796U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1180_gsp", 4202305796U)));
            Engine.print("c'mon, arbiter! kick that guy's ass!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1190_jon", 4202371333U), Engine.ai_get_object(boss_johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1190_jon", 4202371333U)));
            Engine.print("and may i say, reclaimers, it has been a pleasure to serve you both! goodbye!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1200_gsp", 4202436870U), Engine.ai_get_object(boss_monitor.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1200_gsp", 4202436870U)));
            this.boss_flavor_done = true;
        }
        ...
        {
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_11", 3828679359U), default(IGameObject), 1F);
            await Engine.sleep_until(async () => Engine.volume_test_objects(tv_boss_platform, Engine.players()));
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_12", 3828875970U), default(IGameObject), 1F);
            await Engine.sleep_until(async () => !(this.mark_boss_first_cycle));
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_13", 3829072581U), default(IGameObject), 1F);
        }
                ...
                else if ((bool)Engine.ai_vitality_pinned(boss_tartarus.Squad))
                {
                    ...
                    else if (true)
                    {
                        if (this.mark_boss_first_cycle)
                        {
                            ...
                            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\mission\\l08_1020_tar", 4201257204U), Engine.ai_get_object(boss_tartarus.Squad), 1F);
        ...
        public async Task c08_intra1_score_04()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\music\\c08_intra1_04_mus", 3820421697U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_04_fol", 3820487234U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(60);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2050_der", 3820552771U), dervish_02.Entity, 1F);
        ...
        public async Task c08_2060_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2060_soc", 3820618308U), commander.Entity, 1F);
        ...
        public async Task c08_2070_grv()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2070_grv", 3820683845U), default(IGameObject), 1F);
        ...
        public async Task c08_2080_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2080_der", 3820749382U), dervish_02.Entity, 1F);
        ...
        public async Task c08_2090_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2090_soc", 3820814919U), commander.Entity, 1F);
        ...
        public async Task c08_2100_soc()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_2100_soc", 3820880456U), commander.Entity, 1F);
        ...
        public async Task c08_intra1()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\music\\c08_intra1_04_mus", 3820421697U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra1\\foley\\c08_intra1_04_fol", 3820487234U));
            await Engine.sleep(this.prediction_offset);
            await this.c08_intra1_04_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra1\\08_intra1", 3820945993U), "08_intra1_04", default(IUnit), anchor_flag_intra1);
            Engine.custom_animation_relative(dervish_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra1\\08_intra1", 3821011530U), "dervish_04", false, anchor_intra1.Entity);
            Engine.custom_animation_relative(commander.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\08_intra1\\08_intra1", 3821142604U), "commander_04", false, anchor_intra1.Entity);
            Engine.custom_animation_relative(wraith_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\wraith\\08_intra1\\08_intra1", 3821273678U), "wraith_04", false, anchor_intra1.Entity);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra2\\foley\\c08_intra2_01_fol", 3821339215U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(100);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3010_jon", 3821404752U), johnson_02.Entity, 1F, "radio_covy_in");
        ...
        public async Task c08_3020_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3020_jon", 3821470289U), johnson_02.Entity, 1F);
        ...
        public async Task c08_3030_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3030_jon", 3821535826U), johnson_02.Entity, 1F);
        ...
        public async Task c08_3040_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3040_der", 3821601363U), dervish_02.Entity, 1F);
        ...
        public async Task intra2_texture_cam_01()
        {
            ...
            Engine.scenery_animation_start_relative(texture_camera.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\08_intra2\\08_intra2", 3821666900U), "texture_camera_01", anchor_intra2.Entity);
        }
        ...
        public async Task c08_intra2_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra2\\foley\\c08_intra2_01_fol", 3821339215U));
            await Engine.sleep(this.prediction_offset);
            await Engine.sleep(45);
            await this.c08_intra2_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra2\\08_intra2", 3821732437U), "08_intra2_01", default(IUnit), anchor_flag_intra2);
            Engine.custom_animation_relative(dervish_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra2\\08_intra2", 3821797974U), "dervish_01", false, anchor_intra2.Entity);
            Engine.custom_animation_relative(johnson_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\08_intra2\\08_intra2", 3821863511U), "johnson_01", false, anchor_intra2.Entity);
            Engine.scenery_animation_start_relative(scarab_01.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\08_intra2\\08_intra2", 3821994585U), "scarab_01", anchor_intra2.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra2\\foley\\c08_intra2_02_fol", 3822060122U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra2\\foley\\c08_intra2_02_fol", 3822060122U), default(IGameObject), 1F);
            Engine.print("c08_intra1 foley 04 start");
        }
        ...
        public async Task c08_3050_jon()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3050_jon", 3822125659U), johnson_02.Entity, 1F, "radio_covy_loop");
        ...
        public async Task c08_3061_jon()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3061_jon", 3822191196U), johnson_02.Entity, 1F, "radio_covy_loop");
        ...
        public async Task c08_3070_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_3070_jon", 3822256733U), johnson_02.Entity, 1F);
        ...
        public async Task c08_intra2_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra2\\08_intra2", 3821732437U), "08_intra2_02", default(IUnit), anchor_flag_intra2);
            Engine.custom_animation_relative(dervish_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra2\\08_intra2", 3821797974U), "dervish_02", false, anchor_intra2.Entity);
            Engine.custom_animation_relative(johnson_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\08_intra2\\08_intra2", 3821863511U), "johnson_02", false, anchor_intra2.Entity);
            Engine.scenery_animation_start_relative(scarab_01.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\08_intra2\\08_intra2", 3821994585U), "scarab_02", anchor_intra2.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_01_fol", 3822322270U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4010_tar", 3822387807U), tartarus.Entity, 1F);
        ...
        public async Task c08_4020_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4020_tar", 3822453344U), tartarus.Entity, 1F);
        ...
        public async Task c08_4030_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4030_gsp", 3822518881U), monitor.Entity, 1F);
        ...
        public async Task c08_4040_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4040_tar", 3822584418U), tartarus.Entity, 1F);
        ...
        public async Task c08_4050_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4050_mir", 3822649955U), miranda.Entity, 1F);
        ...
        public async Task c08_4060_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4060_tar", 3822715492U), tartarus.Entity, 1F);
        ...
        public async Task c08_intra3_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_01_fol", 3822322270U));
            await Engine.sleep(this.prediction_offset);
            await this.c08_intra3_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra3\\08_intra3", 3822781029U), "08_intra3_01", default(IUnit), anchor_flag_intra3);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra3\\08_intra3", 3822846566U), "miranda_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra3\\08_intra3", 3825402509U), "monitor_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "tartarus_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute01_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute02_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute03_01", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute04_01", false, anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(index.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\08_intra3\\08_intra3", 3825599120U), "index_01", anchor_intra3.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._08_intra3_02_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\music\\c08_intra3_02_mus", 3825664657U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_02_fol", 3825730194U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\music\\c08_intra3_02_mus", 3825664657U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_02_fol", 3825730194U), default(IGameObject), 1F);
        ...
        public async Task c08_4070_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4070_der", 3825795731U), dervish.Entity, 1F);
        ...
        public async Task c08_4080_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4080_tar", 3825861268U), tartarus.Entity, 1F);
        ...
        public async Task c08_4100_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4100_der", 3825926805U), dervish.Entity, 1F);
        ...
        public async Task c08_4110_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4110_tar", 3825992342U), tartarus.Entity, 1F);
        ...
        public async Task c08_4120_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4120_der", 3826057879U), dervish.Entity, 1F);
        ...
        public async Task c08_4140_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4140_tar", 3826123416U), tartarus.Entity, 1F);
        ...
        public async Task c08_4150_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4150_der", 3826188953U), dervish.Entity, 1F);
        ...
        public async Task c08_4160_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4160_der", 3826254490U), dervish.Entity, 1F);
        ...
        public async Task c08_intra3_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra3\\08_intra3", 3822781029U), "08_intra3_02", default(IUnit), anchor_flag_intra3);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra3\\08_intra3", 3822846566U), "miranda_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra3\\08_intra3", 3825402509U), "monitor_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(dervish.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra3\\08_intra3", 3826320027U), "dervish_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "tartarus_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute01_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute02_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute03_02", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute04_02", false, anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(index.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\08_intra3\\08_intra3", 3825599120U), "index_02", anchor_intra3.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._08_intra3_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_03_fol", 3826385564U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_03_fol", 3826385564U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4170_gsp", 3826451101U), monitor.Entity, 1F);
        ...
        public async Task c08_4180_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4180_tar", 3826516638U), tartarus.Entity, 1F);
        ...
        {
            await Engine.sleep(84);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4190_tar", 3826582175U), tartarus.Entity, 1F);
        ...
        {
            await Engine.sleep(137);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4200_jon", 3826647712U), johnson.Entity, 1F);
        ...
        public async Task c08_4201_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4201_jon", 3826713249U), johnson.Entity, 1F);
        ...
        public async Task c08_4220_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4220_jon", 3826778786U), johnson.Entity, 1F);
        ...
        public async Task c08_4230_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4230_tar", 3826844323U), tartarus.Entity, 1F);
        ...
        public async Task c08_4240_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4240_jon", 3826909860U), johnson.Entity, 1F);
        ...
        public async Task c08_4250_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4250_der", 3826975397U), dervish.Entity, 1F);
        ...
        public async Task c08_intra3_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra3\\08_intra3", 3822781029U), "08_intra3_03", default(IUnit), anchor_flag_intra3);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra3\\08_intra3", 3822846566U), "miranda_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\08_intra3\\08_intra3", 3827040934U), "johnson_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra3\\08_intra3", 3825402509U), "monitor_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(dervish.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra3\\08_intra3", 3826320027U), "dervish_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "tartarus_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute01_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute02_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute03_03", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute04_03", false, anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(index.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\08_intra3\\08_intra3", 3825599120U), "index_03", anchor_intra3.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._08_intra3_04_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_04_fol", 3827106471U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_04_fol", 3827106471U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4260_gsp", 3827172008U), monitor.Entity, 1F);
        ...
        public async Task c08_4270_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4270_der", 3827237545U), dervish.Entity, 1F);
        ...
        public async Task c08_4280_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4280_gsp", 3827303082U), monitor.Entity, 1F);
        ...
        public async Task c08_4290_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4290_gsp", 3827368619U), monitor.Entity, 1F);
        ...
        public async Task c08_4300_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4300_der", 3827434156U), dervish.Entity, 1F);
        ...
        public async Task c08_intra3_scene_04()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra3\\08_intra3", 3822781029U), "08_intra3_04", default(IUnit), anchor_flag_intra3);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra3\\08_intra3", 3822846566U), "miranda_04", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\08_intra3\\08_intra3", 3827040934U), "johnson_04", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra3\\08_intra3", 3825402509U), "monitor_04", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(dervish.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra3\\08_intra3", 3826320027U), "dervish_04", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "tartarus_04", false, anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(index.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\08_intra3\\08_intra3", 3825599120U), "index_04", anchor_intra3.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._08_intra3_05_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_05_fol", 3827499693U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_05_fol", 3827499693U), default(IGameObject), 1F);
        ...
        public async Task c08_4310_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4310_jon", 3827565230U), johnson.Entity, 1F);
        ...
        public async Task c08_4320_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4320_tar", 3827630767U), tartarus.Entity, 1F);
        ...
        public async Task c08_4330_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4330_tar", 3827696304U), tartarus.Entity, 1F);
        ...
        public async Task c08_4340_tar()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\c08_4340_tar", 3827761841U), tartarus.Entity, 1F);
        ...
        public async Task index_insertion()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\cinematics\\index\\index_insertion", 3827827378U), index.Entity, "");
            await Engine.sleep(15);
        ...
        public async Task c08_intra3_scene_05()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\08_intra3\\08_intra3", 3822781029U), "08_intra3_05", default(IUnit), anchor_flag_intra3);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\08_intra3\\08_intra3", 3822846566U), "miranda_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\08_intra3\\08_intra3", 3827040934U), "johnson_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\08_intra3\\08_intra3", 3825402509U), "monitor_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(dervish.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\08_intra3\\08_intra3", 3826320027U), "dervish_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(tartarus.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "tartarus_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute01_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute02_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute03_05", false, anchor_intra3.Entity);
            Engine.custom_animation_relative(brute_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\brute\\08_intra3\\08_intra3", 3825468046U), "brute04_05", false, anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(hammer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\melee\\gravity_hammer\\08_intra3\\08_intra3", 3828417211U), "hammer_05", anchor_intra3.Entity);
            Engine.scenery_animation_start_relative(index.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\08_intra3\\08_intra3", 3825599120U), "index_05", anchor_intra3.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._08_intra3_06_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\music\\c08_intra3_06_mus", 3828482748U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_06_fol", 3828548285U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\music\\c08_intra3_06_mus", 3828482748U), default(IGameObject), 1F);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\c08_intra3\\foley\\c08_intra3_06_fol", 3828548285U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_01_fol", 3828613822U), default(IGameObject), 1F);
        ...
        public async Task x09_01_stop_sounds()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_11", 3828679359U));
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_12", 3828875970U));
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_13", 3829072581U));
        }
        ...
        public async Task x09_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_01_fol", 3828613822U));
            await Engine.sleep(this.prediction_offset);
            await Engine.sleep(30);
            await this.x09_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_01", default(IUnit), anchor_flag_x09_01);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x09\\x09", 3829334729U), "miranda_01", false, anchor_x09_01.Entity);
            Engine.scenery_animation_start_relative(rotors_x09.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\deltacontrolroom\\control_rotors\\x09\\x09", 3829400266U), "control_rotors_01", anchor_x09_01.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x09_02_predict_stub();
            await this.x09_problem_actors_02();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\music\\x09_02_mus", 3829465803U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_02_fol", 3829531340U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            await Engine.sleep(92);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\music\\x09_02_mus", 3829465803U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_02_fol", 3829531340U), default(IGameObject), 1F);
        ...
        public async Task x09_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_02", default(IUnit), anchor_flag_x09_01);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x09\\x09", 3829334729U), "miranda_02", false, anchor_x09_01.Entity);
            Engine.scenery_animation_start_relative(index_x09.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\x09\\x09", 3829596877U), "index_02", anchor_x09_01.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x09_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_03_fol", 3829662414U));
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
            Engine.cinematic_screen_effect_stop();
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_03_fol", 3829662414U), default(IGameObject), 1F);
        ...
        public async Task x09_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_03", default(IUnit), anchor_flag_x09_03);
            await Engine.sleep(10);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            ...
            Engine.cinematic_screen_effect_start(true);
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_04_fol", 3829727951U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_04_fol", 3829727951U), default(IGameObject), 1F);
        ...
        public async Task x09_scene_04()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_04", default(IUnit), anchor_flag_x09_02);
            Engine.scenery_animation_start_relative(halo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x09\\x09", 3829793488U), "halo_04", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(matte_halo.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_halo_quarter\\x09\\x09", 3829859025U), "delta_halo_quarter_04", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(matte_substance.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\x09\\x09", 3829924562U), "substance_space_04", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(matte_high_charity.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\x09\\x09", 3829990099U), "high_charity_exterior_04", anchor_x09_02.Entity);
            await Engine.sleep(10);
            ...
            Engine.cinematic_screen_effect_start(true);
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_05_fol", 3830055636U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_05_fol", 3830055636U), default(IGameObject), 1F);
        ...
        public async Task x09_0010_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0010_mir", 3830121173U), miranda.Entity, 1F);
        ...
        public async Task x09_0020_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0020_gsp", 3830186710U), monitor.Entity, 1F);
        ...
        {
            await Engine.sleep(251);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0030_mir", 3830252247U), miranda.Entity, 1F);
        ...
        public async Task x09_0040_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0040_gsp", 3830317784U), monitor.Entity, 1F);
        ...
        public async Task x09_0050_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0050_mir", 3830383321U), miranda.Entity, 1F);
        ...
        public async Task x09_0060_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0060_gsp", 3830448858U), monitor.Entity, 1F);
        ...
        public async Task x09_0070_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0070_mir", 3830514395U), miranda.Entity, 1F);
        ...
        public async Task x09_scene_05()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_05", default(IUnit), anchor_flag_x09_01);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x09\\x09", 3829334729U), "miranda_05", false, anchor_x09_01.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x09\\x09", 3830579932U), "johnson_05", false, anchor_x09_01.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\x09\\x09", 3830645469U), "monitor_05", false, anchor_x09_01.Entity);
            Engine.scenery_animation_start_relative(index_x09.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\x09\\x09", 3829596877U), "index_05", anchor_x09_01.Entity);
            await Engine.sleep(15);
            Engine.fade_in(0F, 0F, 0F, 90);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x09_06_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_06_fol", 3830711006U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_06_fol", 3830711006U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0080_gsp", 3830776543U), monitor.Entity, 1F);
        ...
        public async Task x09_0090_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0090_mir", 3830842080U), miranda.Entity, 1F);
        ...
        public async Task x09_0100_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0100_gsp", 3830907617U), monitor.Entity, 1F);
        ...
        {
            await Engine.sleep(430);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0110_jon", 3830973154U), johnson.Entity, 1F);
        ...
        public async Task x09_0120_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0120_mir", 3831038691U), miranda.Entity, 1F);
        ...
        public async Task x09_0130_gsp()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0130_gsp", 3831104228U), monitor.Entity, 1F);
        ...
        public async Task x09_0140_der()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0140_der", 3831169765U), dervish.Entity, 1F);
        ...
        public async Task x09_scene_06()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_06", default(IUnit), anchor_flag_x09_01);
            Engine.custom_animation_relative(dervish.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\dervish\\x09\\x09", 3831235302U), "dervish_06", false, anchor_x09_01.Entity);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x09\\x09", 3829334729U), "miranda_06", false, anchor_x09_01.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x09\\x09", 3830579932U), "johnson_06", false, anchor_x09_01.Entity);
            Engine.custom_animation_relative(monitor.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\monitor\\x09\\x09", 3830645469U), "monitor_06", false, anchor_x09_01.Entity);
            Engine.scenery_animation_start_relative(index_x09.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\x09\\x09", 3829596877U), "index_06", anchor_x09_01.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x09_07_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_07_fol", 3831300839U));
            await Engine.sleep((short)((float)Engine.camera_time() - 5));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_07_fol", 3831300839U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(100);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0150_to1", 3831366376U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task x09_scene_07()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_07", default(IUnit), anchor_flag_x09_02);
            Engine.scenery_animation_start_relative(forerunner_ship.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship\\x09\\x09", 3831431913U), "forerunner_ship_07", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(cairo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\spacestation\\ss_prop\\x09\\x09", 3831497450U), "ss_prop_07", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(matte_earth.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\earth_space\\x09\\x09", 3831562987U), "earth_space_07", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(matte_moon.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\moon\\x09\\x09", 3831628524U), "moon_07", anchor_x09_02.Entity);
            Engine.fade_in(0F, 0F, 0F, 5);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x09_08_predict_stub();
            await this.x09_problem_actors_08();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\music\\x09_08_mus", 3831694061U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_03_fol", 3829662414U));
            await Engine.sleep((short)((float)Engine.camera_time() - 5));
            Engine.fade_out(1F, 1F, 1F, 5);
            await Engine.sleep(5);
        ...
        public async Task x09_score_8()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\music\\x09_08_mus", 3831694061U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x09\\foley\\x09_08_fol", 3831759598U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0160_lhd", 3831825135U), default(IGameObject), 1F, "radio_default_loop");
        ...
        {
            await Engine.sleep(69);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0180_mas", 3831890672U), chief.Entity, 1F);
        ...
        public async Task x09_0190_mas()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0190_mas", 3831956209U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task x09_0200_lhd()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0200_lhd", 3832021746U), hood.Entity, 1F);
        ...
        public async Task x09_0210_lhd()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0210_lhd", 3832087283U), hood.Entity, 1F);
        ...
        public async Task x09_0220_mas()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x09_0220_mas", 3832152820U), chief.Entity, 1F);
        ...
        public async Task final_explosion()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\01_outro\\covenant_tiny_explosion", 3832218357U), blast_base.Entity, "marker");
            await Engine.sleep(110);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\01_outro\\covenant_tiny_explosion", 3832218357U), blast_base2.Entity, "marker");
        }
        ...
        public async Task x09_scene_08()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x09\\x09", 3829269192U), "x09_08", default(IUnit), anchor_flag_x09_02);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x09\\x09", 3832677116U), "chief_08", false, anchor_x09_02.Entity);
            Engine.custom_animation_relative(hood.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\lord_hood\\x09\\x09", 3832742653U), "hood_08", false, anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(cairo_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cairo_bridge\\x09\\x09", 3832873727U), "cairo_bridge_08", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(x09_alcove.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\forerunner_ship_alcove\\x09\\x09", 3832939264U), "alcove_08", anchor_x09_02.Entity);
            Engine.scenery_animation_start_relative(bloom_quad.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\special\\bloom_quad\\x09\\x09", 3833004801U), "bloom_quad_08", anchor_x09_02.Entity);
            await Engine.sleep(10);
            Engine.fade_in(1F, 1F, 1F, 5);
            await Engine.sleep((short)((float)Engine.camera_time() - 5));
            Engine.fade_out(0F, 0F, 0F, 5);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x10\\music\\x10_01_mus", 3833070338U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x10\\foley\\x10_01_fol", 3833135875U), default(IGameObject), 1F);
        ...
        public async Task x10_0010_grv()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x10_0010_grv", 3833201412U), default(IGameObject), 1F);
        ...
        public async Task x10_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x10\\music\\x10_01_mus", 3833070338U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\08_deltacliffs\\x10\\foley\\x10_01_fol", 3833135875U));
            await Engine.sleep(this.prediction_offset);
            await this.x10_scene_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x10\\x10", 3833266949U), "x10_01", default(IUnit), anchor_flag_x10);
            Engine.scenery_animation_start_relative(x09_chamber_door.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\x10\\x10", 3833332486U), "high_door_grand_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(spore_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\flood\\flood_spore\\x10\\x10", 3833398023U), "spore01_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(spore_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\flood\\flood_spore\\x10\\x10", 3833398023U), "spore02_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(spore_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\flood\\flood_spore\\x10\\x10", 3833398023U), "spore03_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle01_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle02_01", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle03_01", anchor_x10.Entity);
        ...
        public async Task x10_score_2()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\cinematics\\08_deltacliffs\\x10\\music\\x10_02_mus", 3833529097U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x10_0020_grv", 3833725708U), default(IGameObject), 1F);
        ...
        public async Task x10_0030_grv()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x10_0030_grv", 3833791245U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(496);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x10_0040_cor", 3833856782U), cortana.Entity, 1F);
        ...
        public async Task x10_0041_cor()
        {
            ...
            await Engine.sleep(30);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\08_controlroom\\cinematic\\x10_0041_cor", 3833922319U), cortana.Entity, 1F);
        ...
        public async Task effect_cortana_appear()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\cortana\\cortana_on_off_65", 3833987856U), cortana_stand.Entity, "marker");
        }
        ...
        public async Task x10_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x10\\x10", 3833266949U), "x10_02", default(IUnit), anchor_flag_x10);
            Engine.custom_animation_relative(cortana.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\cortana\\x10\\x10", 3834970911U), "cortana_02", false, anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle01_02", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle02_02", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle03_02", anchor_x10.Entity);
            Engine.scenery_animation_start_relative(tentacle_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\x10\\x10", 3833463560U), "tentacle04_02", anchor_x10.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 5));
            Engine.fade_out(0F, 0F, 0F, 5);
            await Engine.sleep(5);
        ...
        public async Task x09()
        {
            ...
            await Engine.sleep(30);
            Engine.print("30 ticks of black for marty");
            Engine.cinematic_show_letterbox(false);
            Engine.play_credits();
            await Engine.sleep_until(async () => (bool)Engine.bink_done(), 1);
            await Engine.sleep(30);
            await this.x10();
            await Engine.sleep(30);
            Engine.print("30 ticks of black for marty");
        ...
        public async Task music_08b_01_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_01", 4256963635U));
        }
        ...
        public async Task music_08b_01_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_01", 4256963635U), true);
        }
        ...
        public async Task music_08b_01_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_01", 4256963635U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_02_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_02", 4257487931U));
        }
        ...
        public async Task music_08b_02_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_02", 4257487931U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_03_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_03", 4257684542U));
        }
        ...
        public async Task music_08b_03_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_03", 4257684542U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_04_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_04", 4257881153U));
        }
        ...
        public async Task music_08b_04_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_04", 4257881153U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_05_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_05", 4258143301U));
        }
        ...
        public async Task music_08b_05_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_05", 4258143301U), true);
        }
        ...
        public async Task music_08b_05_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_05", 4258143301U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_06_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_06", 4258536523U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_07_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_07", 4258667597U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_08_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_08", 4258798671U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_09_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_09", 4258929745U));
        }
        ...
        public async Task music_08b_09_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_09", 4258929745U), true);
        }
        ...
        public async Task music_08b_09_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_09", 4258929745U), default(IGameObject), 1F);
        }
        ...
        public async Task music_08b_10_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_10", 4259126356U));
        }
        ...
        public async Task music_08b_10_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\08b_deltacontrol\\08b_music\\08b_10", 4259126356U), default(IGameObject), 1F);
        }
        ...
        {
            float ifResult_36053772 = default(float);
            if (Engine.unit_get_health(Engine.ai_vehicle_get_from_starting_location(e11_pro_wraith1_0.wraith)) > 0F)
            {
                ifResult_36053772 = 1F;
            }
            else
            {
                ifResult_36053772 = 0F;
            }

            float ifResult_318863 = default(float);
            ...
            float ifResult_62492244 = default(float);
            if (Engine.unit_get_health(Engine.ai_vehicle_get_from_starting_location(e11_pro_wraith1_2.wraith)) > 0F)
            {
                ifResult_62492244 = 1F;
            }
            else
            {
                ifResult_62492244 = 0F;
            }

            float ifResult_18582956 = default(float);
            if (Engine.unit_get_health(Engine.ai_vehicle_get_from_starting_location(e11_pro_wraith1_3.wraith)) > 0F)
            {
                ifResult_18582956 = 1F;
            }
            else
            {
                ifResult_18582956 = 0F;
            }

            return (short)(ifResult_36053772 + ifResult_318863 + ifResult_62492244 + ifResult_18582956);
        }
        ...
        public async Task e11_door_opening()
        {
            ...
            await Engine.sleep(120);
            Engine.effect_new(Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\deltacontrolroom\\scarab_attack_deltacontrol", 4259388504U), e11_door_explosion);
        ...
        public async Task e11_key()
        {
            ...
            await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4177336199U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4177336199U)));
        ...
        public async Task cs_e7_mars_inf0_wait()
        {
            ...
            Engine.custom_animation_loop(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\deltacontrol\\deltacontrol", 4259585115U), "kneel_unarmed", false);
            await Engine.sleep_until(async () => this.g_e7_mars_johnson_go, 3);
            await Engine.sleep(15);
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\deltacontrol\\deltacontrol", 4259585115U), "kneel_to_idle_pistol", false);
            Engine.cs_enable_moving(true);
        ...
        public async Task cs_e7_mars_inf0_johnson()
        {
            ...
            Engine.ai_disregard(Engine.ai_get_object(this.ai_current_actor), true);
            Engine.cs_enable_pathfinding_failsafe(true);
            Engine.custom_animation_relative_loop(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\deltacontrol\\deltacontrol", 4259585115U), "kneel_unarmed_johnson", false, anchor_intra2.Entity);
            await Engine.sleep_until(async () => this.g_e7_mars_johnson_go, 3);
            Engine.print("johnson: go go go!");
            Engine.ai_play_line(this.ai_current_actor, "3000") // Couldn't generate cast from 'Short' to 'Void'
            ;
            Engine.custom_animation_relative(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\deltacontrol\\deltacontrol", 4259585115U), "kneel_2_scarab", false, anchor_intra2.Entity);
            await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
        ...
        public async Task cs_e6_cov_inf1_1_init()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    if (Engine.object_get_health(e6_jail_shield1.Entity) >= 0F)
                    {
                        Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4058845303U), "combat:pistol:cheer", true);
                        await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
                    ...
                    async () =>
                {
                    if (Engine.object_get_health(e6_jail_shield1.Entity) >= 0F)
                    {
                        Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4058845303U), "combat:pistol:shakefist", true);
                        await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
                        await Engine.sleep_until(async () => Engine.object_get_health(e6_jail_shield1.Entity) < 0F, 10, (int)Engine.random_range(90, 150));
                    }
                }, 
                    async () =>
                {
                    if (Engine.object_get_health(e6_jail_shield1.Entity) >= 0F)
                    {
                        Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4058845303U), "combat:pistol:warn", true);
                        await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
                        await Engine.sleep_until(async () => Engine.object_get_health(e6_jail_shield1.Entity) < 0F, 10, (int)Engine.random_range(90, 150));
                    }
                }, 
                    async () =>
                {
                    if (Engine.object_get_health(e6_jail_shield1.Entity) >= 0F)
                    {
                        Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4058845303U), "combat:pistol:wave", true);
                        await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
                        await Engine.sleep_until(async () => Engine.object_get_health(e6_jail_shield1.Entity) < 0F, 10, (int)Engine.random_range(90, 150));
                    }
                });
        ...
        public async Task e1_cov_spectre0_main()
        {
            ...
            await Engine.sleep(10);
            Engine.object_type_predict(Engine.GetTag<BaseTag>("objects\\vehicles\\spectre\\spectre", 4259650652U));
        }
        ...
        {
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_maple\\maple\\maple", 3835101985U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3836281651U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_maple\\maple_l\\maple_l", 3836609336U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3836674873U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3838116687U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redalder\\redalder_saplingm\\redalder_saplingm", 3838772057U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 32);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 66);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 67);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 68);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 69);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 70);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 71);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\wraith", 3845325757U), 72);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\minigun\\minigun", 3846636497U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3846702034U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3846702034U), 9);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\minigun\\minigun", 3846636497U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3846702034U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\wraith\\turrets\\mortar\\mortar", 3846702034U), 17);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_maple\\maple\\maple", 3835101985U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 3);
            await Engine.sleep(155);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3839165279U), 32);
            await Engine.sleep(72);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_large\\door_large", 3838116687U), 2);
        ...
        public async Task _08_intra2_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3847029719U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\fp\\fp", 3847029719U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\fp_plasma_rifle\\fp_plasma_rifle", 3808756111U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\fp_plasma_rifle\\fp_plasma_rifle", 3808756111U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_maple\\maple_l\\maple_l", 3836609336U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 2);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redalder\\redalder_s\\redalder_s", 3847357404U), 0);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\08b_deltacontrol\\deltacontrolroom_bsp0"), 24, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 20);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 22);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 28);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 29);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 30);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 31);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_cam\\scarab_cam", 3849126903U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_scarab_full\\holo_scarab_full", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_main_gun\\scarab_main_gun", 3850241032U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_rear_gun\\scarab_rear_gun", 3850568717U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3851027476U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 74);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 69);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 60);
            await Engine.sleep(1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3836674873U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_recharge_station\\recharge_station_cell\\recharge_station_cell", 3855877214U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3836674873U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3836674873U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space_a\\crate_space_a", 3856204899U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3856335973U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_small\\door_small", 3857450102U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3857712250U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 1);
            await Engine.sleep(71);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\08b_deltacontrol\\deltacontrolroom_bsp0"), 43, true);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\door_small\\door_small", 3857450102U), 0);
            await Engine.sleep(3);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\08b_deltacontrol\\deltacontrolroom_bsp0"), 26, true);
        ...
        public async Task _08_intra3_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\monitor\\monitor", 3857777787U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 28);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 29);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 40);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 36);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 37);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 33);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 39);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 35);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\brute\\brute", 3858629768U), 43);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3860858026U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3860858026U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\control_walkway\\control_walkway", 3862365377U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3864069339U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3864069339U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\index_full", 3865052394U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\holo_panels\\control_room_index_board\\control_room_index_board", 3865380079U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\control_boss_platform\\control_boss_platform", 3865969912U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3836281651U), 0);
            ...
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\lightfixture_indirect_blurple\\lightfixture_indirect_blurple", 3870033206U), 0);
        ...
        public async Task _08_intra3_03_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3851093013U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3856335973U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3788636252U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\lightfixture_indirect_blurple\\lightfixture_indirect_blurple", 3870033206U), 0);
        ...
        public async Task _08_intra3_05_predict()
        {
            ...
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\08b_deltacontrol\\deltacontrolroom_bsp3"), 8, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\gravity_hammer\\gravity_hammer", 3870164280U), 0);
        ...
        public async Task x09_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\control_rotors\\control_rotors", 3870557502U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\control_room\\grav_lift\\grav_lift", 3871016261U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3860858026U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3860858026U), 1);
        ...
        public async Task x09_03_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_l\\redcedar_l", 3836216114U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_redcedar\\redcedar_m\\redcedar_m", 3835691818U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\control_room_beam\\control_room_beam", 3871737168U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltacontrolroom\\deltacontrolroom_08b\\deltacontrolroom_08b", 3782934533U), 3);
        ...
        public async Task x09_04_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\high_charity_exterior\\high_charity_exterior", 3871802705U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_halo_quarter\\delta_halo_quarter", 3872327001U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3785031717U), 0);
            await Engine.sleep(131);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\halo_disarm\\halo_disarm", 3873178982U), 0);
        }
        ...
        public async Task x09_05_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3860858026U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\index\\index_full\\index_full", 3865052394U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\beacon_halo_holo\\beacon_halo_holo", 3873244519U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3836281651U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltacontrolroom\\lightfixture_indirect_blurple\\lightfixture_indirect_blurple", 3870033206U), 0);
        ...
        public async Task x09_07_predict()
        {
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\08b_deltacontrol\\deltacontrolroom_bsp0"), 75, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\moon\\moon", 3874424185U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\earth_space\\earth_space", 3874620796U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\forerunner_ship\\forerunner_ship", 3874817407U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3875931536U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3785031717U), 0);
            await Engine.sleep(123);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3875931536U), 0);
            await Engine.sleep(36);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\forerunner_ship_alcove\\forerunner_ship_alcove", 3876062610U), 0);
        }
        ...
        {
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\bloom_quad\\bloom_quad", 3877373350U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3877569961U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3877569961U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3877569961U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3877569961U), 19);
            await Engine.sleep(5);
            await Engine.sleep(119);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\lord_hood\\lord_hood", 3878356405U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\lord_hood\\lord_hood", 3878356405U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\cairo_bridge\\cairo_bridge", 3879142849U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3875931536U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\human\\military\\emergency\\emergency", 3883009532U), 0);
        ...
        public async Task x10_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\flood\\flood_spore\\flood_spore", 3883140606U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\highcharity\\highcharity", 3786080309U), 7);
            await Engine.sleep(19);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3847422941U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_scarab_full\\holo_scarab_full", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_main_gun\\scarab_main_gun", 3850241032U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_rear_gun\\scarab_rear_gun", 3850568717U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3851027476U), 0);
            ...
            await Engine.sleep(14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space_a\\crate_space_a", 3856204899U), 0);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3864069339U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\energy_blade\\energy_blade", 3864069339U), 1);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_short\\bowl_short", 3883337217U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_recharge_station\\recharge_station_cell\\recharge_station_cell", 3855877214U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3836674873U), 0);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3883861513U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\battery\\battery", 3883927050U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 13, true);
            await Engine.sleep(12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\multi\\lockout\\power_module\\power_module", 3884254735U), 0);
            await Engine.sleep(18);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 26, true);
            await Engine.sleep(6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\dervish\\dervish", 3843556258U), 1);
            await Engine.sleep(9);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3884713494U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3884713494U), 1);
            await Engine.sleep(28);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 0, true);
            await Engine.sleep(15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_gravcolumn\\garbage\\cov_gravcolumn_top\\cov_gravcolumn_top", 3885499938U), 0);
            await Engine.sleep(8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_gravcolumn\\cov_gravcolumn", 3886417456U), 1);
            await Engine.sleep(18);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 32, true);
            await Engine.sleep(14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_chubby\\cov_chubby", 3887531585U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_clump\\flood_clump", 3888318029U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_sack\\flood_sack", 3888580177U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_pod\\flood_pod", 3888776788U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_floor_clump_small\\flood_floor_clump_small", 3888842325U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door_grand\\high_door_grand", 3888907862U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_hallway_signs\\holo_hallway_signs", 3889956454U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_door\\high_door", 3890021991U), 0);
            await Engine.sleep(3);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 31, true);
            await Engine.sleep(6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\flood\\flood_generator\\flood_generator", 3890087528U), 0);
            await Engine.sleep(9);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\07a_highcharity\\high_0"), 33, true);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_gravcolumn\\garbage\\cov_gravcolumn_bottom_garbage_1\\cov_gravcolumn_bottom_garbage_1", 3890153065U), 0);
        }
        ...
        public async Task x10_02_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\interior_objects\\cov_chubby\\cov_chubby", 3887531585U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\highcharity\\high_small_door\\high_small_door", 3890284139U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3890611824U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3890611824U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3890611824U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3857712250U), 0);
