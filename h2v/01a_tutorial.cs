...
#region Fields
        ...
        public async Task<bool> prompt_looker_start()
        {
            if (this.counter_prompt_looker_start == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3110_gun", 3865642227U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3110_gun", 3865642227U));
            ...
            else if (this.counter_prompt_looker_start == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1360_gun", 3865707764U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1360_gun", 3865707764U));
        ...
        public async Task<bool> prompt_looker()
        {
            if (this.counter_prompt_looker == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1310_gun", 3865773301U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1310_gun", 3865773301U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_short);
            }
            else if (this.counter_prompt_looker == 1)
            {
                print("you gotta look at all the lights to complete the test.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1370_gun", 3865838838U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1370_gun", 3865838838U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_short);
            }
            else if (this.counter_prompt_looker == 2)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1300_gun", 3865904375U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1300_gun", 3865904375U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_looker == 3)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1350_gun", 3865969912U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1350_gun", 3865969912U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_medium);
            }
            else if (true)
            {
        ...
        public async Task<bool> prompt_start_spot()
        {
            if (this.counter_prompt_start_spot == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0820_gun", 3866035449U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0820_gun", 3866035449U));
            ...
            else if (this.counter_prompt_start_spot == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0830_gun", 3866100986U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0830_gun", 3866100986U));
            ...
            else if (this.counter_prompt_start_spot == 2)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0840_gun", 3866166523U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0840_gun", 3866166523U));
                this.timer_prompt_start_spot = (short)(this.timer_prompt_start_spot + this.delay_prompt_medium);
            }
            else if (true)
            {
        ...
        public async Task<bool> prompt_careful()
        {
            if (this.counter_prompt_careful == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0850_gun", 3866232060U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0850_gun", 3866232060U)));
                await sleep(30);
            ...
            else if (this.counter_prompt_careful == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0860_gun", 3866297597U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0860_gun", 3866297597U)));
                await sleep(30);
                cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_guns_zapper_wait));
            }
            else if (this.counter_prompt_careful == 2)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0870_gun", 3866363134U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0870_gun", 3866363134U)));
                await sleep(30);
                cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_guns_zapper_wait));
            }
            else if (true)
        ...
        public async Task<bool> prompt_zapper_lookatme()
        {
            ...
            if (this.counter_prompt_zapper_lookatme == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3160_gun", 3866428671U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3160_gun", 3866428671U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3170_gun", 3866494208U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3170_gun", 3866494208U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_short);
            }
            else if (this.counter_prompt_zapper_lookatme == 2)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3180_gun", 3866559745U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3180_gun", 3866559745U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 3)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3190_gun", 3866625282U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3190_gun", 3866625282U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_lookatme == 4)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3200_gun", 3866690819U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3200_gun", 3866690819U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 5)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3210_gun", 3866756356U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3210_gun", 3866756356U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                hud_set_training_text("tutorial_zapper_lookatme");
                hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_lookatme == 6)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3220_gun", 3866821893U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3220_gun", 3866821893U));
        ...
        public async Task<bool> prompt_zapper_getin()
        {
            ...
            {
                custom_animation(ai_get_unit(guns.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0900_jon", true);
                objectives_finish_up_to(0);
                objectives_show_up_to(1);
                await sleep(10);
                print("step on in. i'll show you.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0900_gun", 3867018504U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0900_gun", 3867018504U));
            ...
            else if (this.counter_prompt_zapper_getin == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3230_gun", 3867084041U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3230_gun", 3867084041U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_short);
            }
            else if (this.counter_prompt_zapper_getin == 2)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3240_gun", 3867149578U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3240_gun", 3867149578U));
            ...
            else if (this.counter_prompt_zapper_getin == 3)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3250_gun", 3867215115U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3250_gun", 3867215115U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_getin == 4)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3260_gun", 3867280652U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3260_gun", 3867280652U));
            ...
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3270_gun", 3867346189U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3270_gun", 3867346189U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
            ...
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3280_gun", 3867411726U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3280_gun", 3867411726U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                hud_set_training_text("tutorial_zapper_getin");
                hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3290_gun", 3867477263U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3290_gun", 3867477263U));
        ...
        public async Task<bool> prompt_zapper_button()
        {
            ...
            if (this.counter_prompt_zapper_button == 0)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0880_gun", 3867542800U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)(2 * (float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0880_gun", 3867542800U)));
            ...
            else if (this.counter_prompt_zapper_button == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0890_gun", 3867608337U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)(2 * (float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0890_gun", 3867608337U)));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + 0);
            }
            else if (this.counter_prompt_zapper_button == 2)
            {
                custom_animation(ai_get_unit(guns.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0910_jon", true);
                objectives_finish_up_to(1);
                objectives_show_up_to(2);
                await sleep(10);
                print("go ahead and use the switch in front of you to start the shield test.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3300_gun", 3867673874U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3300_gun", 3867673874U));
            ...
            else if (this.counter_prompt_zapper_button == 3)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3310_gun", 3867739411U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3310_gun", 3867739411U));
            ...
            else if (this.counter_prompt_zapper_button == 4)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3340_gun", 3867804948U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3340_gun", 3867804948U));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_button == 5)
            {
                print("go ahead and use that switch in front of you.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3330_gun", 3867870485U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3330_gun", 3867870485U));
            ...
            else if (this.counter_prompt_zapper_button == 6)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3320_gun", 3867936022U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3320_gun", 3867936022U));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                hud_set_training_text("tutorial_zapper_button");
                hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_button == 7)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3350_gun", 3868001559U), ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3350_gun", 3868001559U));
        ...
        public async Task<bool> prompt_elevator_plr()
        {
            ...
            else if (this.counter_prompt_elevator_plr == 1)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1640_jon", 3868067096U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1640_jon", 3868067096U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_short);
            }
            else if (this.counter_prompt_elevator_plr == 2)
            {
                print("get on the lift, cheif, we're gonna be late.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1650_jon", 3868132633U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1650_jon", 3868132633U));
            ...
            else if (this.counter_prompt_elevator_plr == 3)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1660_jon", 3868198170U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1660_jon", 3868198170U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_elevator_plr == 4)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1670_jon", 3868263707U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1670_jon", 3868263707U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
            }
            else if (this.counter_prompt_elevator_plr == 5)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1680_jon", 3868329244U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1680_jon", 3868329244U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
            }
            else if (this.counter_prompt_elevator_plr == 6)
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1690_jon", 3868394781U), ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1690_jon", 3868394781U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
        ...
        public async Task icecream()
        {
            ...
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 3824812676U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 3824812676U)), 1);
        ...
        public async Task test_mindread_up()
        {
            ...
            if (!(objects_can_see_object(players(), looker_light_top_red.Entity, 5F) || (bool)player0_looking_up()))
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3070_gun", 3868460318U), ai_get_object(guns.Squad), 1F);
            ...
            player_action_test_reset();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3070_gun", 3868460318U)));
        }
        ...
        public async Task test_mindread_down()
        {
            ...
            if (!(objects_can_see_object(players(), looker_light_bottom_red.Entity, 3F) || (bool)player0_looking_down()))
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3060_gun", 3868525855U), ai_get_object(guns.Squad), 1F);
            ...
            player_action_test_look_pitch_end();
            player_action_test_reset();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3060_gun", 3868525855U)));
        }
        ...
        public async Task<bool> training_pitch_choose()
        {
            ...
            if ((bool)controller_get_look_invert())
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1450_gun", 3868591392U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1450_gun", 3868591392U)));
            ...
            else
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1470_gun", 3868656929U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1470_gun", 3868656929U)));
            ...
            else
            {
                ...
                if ((bool)controller_get_look_invert())
                {
                    ...
                    sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1480_gun", 3868722466U), ai_get_object(guns.Squad), 1F);
                    await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1480_gun", 3868722466U)));
                }
                else
                {
                    cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_console_inhibitor));
                    ...
                    sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1460_gun", 3868788003U), ai_get_object(guns.Squad), 1F);
                    await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1460_gun", 3868788003U)));
                }
        ...
        public async Task training_pitch()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3100_gun", 3868853540U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3100_gun", 3868853540U)));
            if ((bool)controller_get_look_invert())
            {
                print("the diagnostic software set your targeting system to be inverted");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3130_gun", 3868919077U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3130_gun", 3868919077U)));
            }
            else
            {
                print("the diagnostic software set your targeting system to be normal");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3120_gun", 3868984614U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3120_gun", 3868984614U)));
            }
            ...
            if ((bool)controller_get_look_invert())
            {
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1570_gun", 3869050151U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1570_gun", 3869050151U)));
            }
            else
            {
                cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_console_inhibitor));
                ...
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1560_gun", 3869115688U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1560_gun", 3869115688U)));
            }

            print("if you change your mind, you can switch the setting anytime.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1580_gun", 3869181225U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1580_gun", 3869181225U)));
            hud_enable_training(false);
            hud_show_training_text(false);
        }
        ...
        public async Task training_look()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0600_gun", 3869246762U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0600_gun", 3869246762U)));
            custom_animation(ai_get_unit(guns.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0610_jon", true);
            await sleep(15);
            print("your new suit is a mark vi, sent up from songnam this morning.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0610_gun", 3869312299U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0610_gun", 3869312299U)));
            print("try to take it easy until you get used to it.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0620_gun", 3869377836U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0620_gun", 3869377836U)));
            cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_console_inhibitor));
            await sleep(30);
            print("ok.  let's test your targeting, first thing.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0630_gun", 3869443373U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0630_gun", 3869443373U)));
            objectives_show_up_to(0);
            print("please look at the top light.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3000_gun", 3869508910U), ai_get_object(guns.Squad), 1F);
            await this.test_mindread_up();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3000_gun", 3869508910U)));
            print("good.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0650_gun", 3869574447U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0650_gun", 3869574447U)));
            print("now look at the bottom light.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3010_gun", 3869639984U), ai_get_object(guns.Squad), 1F);
            await this.test_mindread_down();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3010_gun", 3869639984U)));
            print("allright");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0670_gun", 3869705521U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0670_gun", 3869705521U)));
            print("look at the top light again.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3020_gun", 3869771058U), ai_get_object(guns.Squad), 1F);
            await this.test_mindread_up();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3020_gun", 3869771058U)));
            print("that's it�");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0760_gun", 3869836595U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0760_gun", 3869836595U)));
            print("now the bottom one.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3030_gun", 3869902132U), ai_get_object(guns.Squad), 1F);
            await this.test_mindread_down();
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3030_gun", 3869902132U)));
            print("ok.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0740_gun", 3869967669U), ai_get_object(guns.Squad), 1F);
            await sleep(30);
            player_camera_control(true);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0740_gun", 3869967669U)));
            if (this.counter_mindread_normal_success >= 2)
            {
                await sleep(30);
                print("everything checks out.");
                sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0770_gun", 3870033206U), ai_get_object(guns.Squad), 1F);
                await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0770_gun", 3870033206U)));
                controller_set_look_invert(false);
            }
        ...
        public async Task training_move()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0790_gun", 3870098743U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0790_gun", 3870098743U)));
            device_set_position(inhibitor.Entity, 1F);
            player_disable_movement(false);
            hud_enable_training(true);
            cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_console_inhibitor));
            await sleep(30);
            custom_animation(ai_get_unit(guns.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0800_jon", true);
            await sleep(10);
            print("move around a little, get a feel for it.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0800_gun", 3870164280U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0800_gun", 3870164280U)));
            print("when you're ready, come and meet me by the zapper.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0810_gun", 3870229817U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0810_gun", 3870229817U)));
        ...
        public async Task training_shield()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3150_gun", 3870295354U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3150_gun", 3870295354U)));
            print("this station will test your recharging energy shields");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3140_gun", 3870360891U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3140_gun", 3870360891U)));
            ...
            await sleep(15);
            print("bingo!");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0940_gun", 3870426428U), ai_get_object(guns.Squad), 1F);
            await sleep(30);
            cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_console_zapper));
            print("as you can see, they re-charge a lot faster.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0950_gun", 3870491965U), ai_get_object(guns.Squad), 1F);
            await sleep(45);
            ...
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0950_gun", 3870491965U)));
            await sleep(60);
            device_set_power(zapper.Entity, 0F);
            device_set_power(zapper_cage.Entity, 0F);
            await sleep(30);
            custom_animation(ai_get_unit(guns.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0960_jon", true);
            print("if your shields go down, find some cover, wait for the meter to read fully-charged.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0960_gun", 3870557502U), ai_get_object(guns.Squad), 1F);
            await sleep(45);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0960_gun", 3870557502U)));
            print("that, or he can just hide behind me.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0970_jon", 3870623039U), ai_get_object(johnson.Squad), 1F);
            await sleep(30);
            cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_lookat_johnson));
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0970_jon", 3870623039U)));
            await sleep(15);
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)((float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U)) - 90));
            cs_run_command_script(johnson.Squad, new ScriptMethodReference(cs_lookat_player));
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U)));
            print("his armor's working fine.");
            unit_set_emotional_state(ai_get_unit(guns.Squad), "annoyed", 0.5F, 1);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1010_gun", 3870754113U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1010_gun", 3870754113U)));
            await sleep(15);
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U), ai_get_object(guns.Squad), 1F);
            await sleep((short)((float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U)) - 60));
            cs_run_command_script(johnson.Squad, new ScriptMethodReference(cs_lookat_player));
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U)));
        }
        ...
        public async Task training_done_tram()
        {
            ...
            custom_animation_loop(tram_marine_1.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
            custom_animation_loop(tram_marine_2.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_fist_loop", false);
            custom_animation_loop(tram_marine_3.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_clapping_loop", false);
            await sleep(5);
            custom_animation_loop(tram_marine_6.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
            custom_animation_loop(tram_marine_5.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_fist_loop", false);
            custom_animation_loop(tram_marine_4.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_clapping_loop", false);
            await sleep(5);
            custom_animation_loop(tram_marine_7.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
        ...
        public async Task training_done()
        {
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1040_jon", 3870950724U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)((float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1040_jon", 3870950724U)) - 30));
            cs_run_command_script(johnson.Squad, new ScriptMethodReference(cs_johnson_elevator));
            await sleep(15);
            cs_run_command_script(guns.Squad, new ScriptMethodReference(cs_guns_elevator));
            await sleep(15);
            await sleep_until(async () => volume_test_objects_all(tv_elevator_tram_bot, ai_get_object(johnson.Squad)), 1, (int)(30 * this.seconds));
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3360_gun", 3871016261U), ai_get_object(guns.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3360_gun", 3871016261U)));
            print("sorry, guns.  it's classified.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0990_jon", 3871081798U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)((float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0990_jon", 3871081798U)) - 0));
            unit_set_emotional_state(ai_get_unit(guns.Squad), "angry", 0.5F, 1);
            await sleep(5);
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3370_gun", 3871147335U), ai_get_object(guns.Squad), 1F);
            await sleep(30);
            ...
            sound_impulse_stop(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3370_gun", 3871147335U));
            await sleep(10);
            print("well he's in a particularly fine mood. maybe lord hood forgot to give him an invitation.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U), ai_get_object(johnson.Squad), 1F);
        }
        ...
        public async Task training_tram()
        {
            ...
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U)));
            ...
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0010_jon", true);
            await sleep(10);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U)));
            print("earth. haven't seen it in years.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0010_jon", 3871278409U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)((float)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0010_jon", 3871278409U)) - 30));
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\01a_tutorial\\01a_music\\01a_01", 3871343946U), default(IGameObject), 1F);
            ...
            await sleep(30);
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0020_jon", true);
            print("when i shipped out for basic, the orbital defense grid was all theory and politics.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0020_jon", 3871475020U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0020_jon", 3871475020U)));
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0021_jon", 3871540557U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0021_jon", 3871540557U)));
            await sleep_until(async () => device_get_position(tram.Entity) >= 0.275F, 1);
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0030_jon", true);
            await sleep(10);
            print("that mac-gun can put a round clean through a covenant capital-ship.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0030_jon", 3871606094U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0030_jon", 3871606094U)));
            ...
            await sleep(45);
            await sleep(45);
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0040_jon", true);
            print("with coordinated fire from the athens and the malta, nothing's getting past this battle-cluster in one piece.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0040_jon", 3871671631U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0040_jon", 3871671631U)));
            await sleep(15);
            await sleep_until(async () => device_get_position(tram.Entity) >= 0.7F, 1);
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0050_jon", true);
            print("ships have been arriving all morning.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0050_jon", 3871737168U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0050_jon", 3871737168U)));
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\01a_tutorial\\01a_music\\01a_01", 3871343946U));
            await sleep_until(async () => device_get_position(tram.Entity) >= 0.75F, 1);
            await sleep(30);
            custom_animation(ai_get_unit(johnson.Squad), GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0051_jon", true);
            print("nobody's saying much, but i'll bet something big's about to happen.");
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0051_jon", 3871802705U), ai_get_object(johnson.Squad), 1F);
            await sleep((short)sound_impulse_language_time(GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0051_jon", 3871802705U)));
