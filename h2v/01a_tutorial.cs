...
#region Fields
        ...
        public async Task<bool> prompt_looker_start()
        {
            if (this.counter_prompt_looker_start == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3110_gun", 3865642227U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3110_gun", 3865642227U));
            ...
            else if (this.counter_prompt_looker_start == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1360_gun", 3865707764U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1360_gun", 3865707764U));
        ...
        public async Task<bool> prompt_looker()
        {
            if (this.counter_prompt_looker == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1310_gun", 3865773301U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1310_gun", 3865773301U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_short);
            }
            else if (this.counter_prompt_looker == 1)
            {
                Engine.print("you gotta look at all the lights to complete the test.");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1370_gun", 3865838838U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1370_gun", 3865838838U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_short);
            }
            else if (this.counter_prompt_looker == 2)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1300_gun", 3865904375U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1300_gun", 3865904375U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_looker == 3)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1350_gun", 3865969912U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_looker = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1350_gun", 3865969912U));
                this.timer_prompt_looker = (short)(this.timer_prompt_looker + this.delay_prompt_medium);
            }
            else if (true)
            {
        ...
        public async Task<bool> prompt_start_spot()
        {
            if (this.counter_prompt_start_spot == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0820_gun", 3866035449U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0820_gun", 3866035449U));
            ...
            else if (this.counter_prompt_start_spot == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0830_gun", 3866100986U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0830_gun", 3866100986U));
            ...
            else if (this.counter_prompt_start_spot == 2)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0840_gun", 3866166523U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_start_spot = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0840_gun", 3866166523U));
                this.timer_prompt_start_spot = (short)(this.timer_prompt_start_spot + this.delay_prompt_medium);
            }
            else if (true)
            {
        ...
        public async Task<bool> prompt_careful()
        {
            if (this.counter_prompt_careful == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0850_gun", 3866232060U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0850_gun", 3866232060U)));
                await Engine.sleep(30);
            ...
            else if (this.counter_prompt_careful == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0860_gun", 3866297597U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0860_gun", 3866297597U)));
                await Engine.sleep(30);
                Engine.cs_run_command_script(guns.Squad, cs_guns_zapper_wait);
            }
            else if (this.counter_prompt_careful == 2)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0870_gun", 3866363134U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0870_gun", 3866363134U)));
                await Engine.sleep(30);
                Engine.cs_run_command_script(guns.Squad, cs_guns_zapper_wait);
            }
            else if (true)
        ...
        public async Task<bool> prompt_zapper_lookatme()
        {
            ...
            if (this.counter_prompt_zapper_lookatme == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3160_gun", 3866428671U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3160_gun", 3866428671U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3170_gun", 3866494208U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3170_gun", 3866494208U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_short);
            }
            else if (this.counter_prompt_zapper_lookatme == 2)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3180_gun", 3866559745U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3180_gun", 3866559745U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 3)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3190_gun", 3866625282U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3190_gun", 3866625282U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_lookatme == 4)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3200_gun", 3866690819U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3200_gun", 3866690819U));
            ...
            else if (this.counter_prompt_zapper_lookatme == 5)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3210_gun", 3866756356U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3210_gun", 3866756356U));
                this.timer_prompt_zapper_lookatme = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                Engine.hud_set_training_text("tutorial_zapper_lookatme");
                Engine.hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_lookatme == 6)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3220_gun", 3866821893U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3220_gun", 3866821893U));
        ...
        public async Task<bool> prompt_zapper_getin()
        {
            ...
            {
                Engine.custom_animation(Engine.ai_get_unit(guns.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0900_jon", true);
                Engine.objectives_finish_up_to(0);
                Engine.objectives_show_up_to(1);
                await Engine.sleep(10);
                Engine.print("step on in. i'll show you.");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0900_gun", 3867018504U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0900_gun", 3867018504U));
            ...
            else if (this.counter_prompt_zapper_getin == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3230_gun", 3867084041U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3230_gun", 3867084041U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_short);
            }
            else if (this.counter_prompt_zapper_getin == 2)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3240_gun", 3867149578U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3240_gun", 3867149578U));
            ...
            else if (this.counter_prompt_zapper_getin == 3)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3250_gun", 3867215115U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3250_gun", 3867215115U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_getin == 4)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3260_gun", 3867280652U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3260_gun", 3867280652U));
            ...
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3270_gun", 3867346189U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3270_gun", 3867346189U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
            ...
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3280_gun", 3867411726U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3280_gun", 3867411726U));
                this.timer_prompt_zapper_getin = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                Engine.hud_set_training_text("tutorial_zapper_getin");
                Engine.hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_getin == 5)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3290_gun", 3867477263U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3290_gun", 3867477263U));
        ...
        public async Task<bool> prompt_zapper_button()
        {
            ...
            if (this.counter_prompt_zapper_button == 0)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0880_gun", 3867542800U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)(2 * (float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0880_gun", 3867542800U)));
            ...
            else if (this.counter_prompt_zapper_button == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0890_gun", 3867608337U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)(2 * (float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0890_gun", 3867608337U)));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + 0);
            }
            else if (this.counter_prompt_zapper_button == 2)
            {
                Engine.custom_animation(Engine.ai_get_unit(guns.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0910_jon", true);
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3300_gun", 3867673874U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3300_gun", 3867673874U));
            ...
            else if (this.counter_prompt_zapper_button == 3)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3310_gun", 3867739411U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3310_gun", 3867739411U));
            ...
            else if (this.counter_prompt_zapper_button == 4)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3340_gun", 3867804948U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3340_gun", 3867804948U));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_zapper_button == 5)
            {
                Engine.print("go ahead and use that switch in front of you.");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3330_gun", 3867870485U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3330_gun", 3867870485U));
            ...
            else if (this.counter_prompt_zapper_button == 6)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3320_gun", 3867936022U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3320_gun", 3867936022U));
                this.timer_prompt_zapper_button = (short)(this.timer_prompt_zapper + this.delay_prompt_long);
                Engine.hud_set_training_text("tutorial_zapper_button");
                Engine.hud_show_training_text(true);
            }
            else if (this.counter_prompt_zapper_button == 7)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3350_gun", 3868001559U), Engine.ai_get_object(guns.Squad), 1F);
                this.timer_prompt_zapper = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3350_gun", 3868001559U));
        ...
        public async Task<bool> prompt_elevator_plr()
        {
            ...
            else if (this.counter_prompt_elevator_plr == 1)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1640_jon", 3868067096U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1640_jon", 3868067096U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_short);
            }
            else if (this.counter_prompt_elevator_plr == 2)
            {
                Engine.print("get on the lift, cheif, we're gonna be late.");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1650_jon", 3868132633U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1650_jon", 3868132633U));
            ...
            else if (this.counter_prompt_elevator_plr == 3)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1660_jon", 3868198170U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1660_jon", 3868198170U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_medium);
            }
            else if (this.counter_prompt_elevator_plr == 4)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1670_jon", 3868263707U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1670_jon", 3868263707U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
            }
            else if (this.counter_prompt_elevator_plr == 5)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1680_jon", 3868329244U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1680_jon", 3868329244U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
            }
            else if (this.counter_prompt_elevator_plr == 6)
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1690_jon", 3868394781U), Engine.ai_get_object(johnson.Squad), 1F);
                this.timer_prompt_elevator_plr = (short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1690_jon", 3868394781U));
                this.timer_prompt_elevator_plr = (short)(this.timer_prompt_elevator_plr + this.delay_prompt_long);
        ...
        public async Task icecream()
        {
            ...
            await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 3824812676U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 3824812676U)), 1);
        ...
        public async Task test_mindread_up()
        {
            ...
            if (!(Engine.objects_can_see_object(Engine.players(), looker_light_top_red.Entity, 5F) || (bool)Engine.player0_looking_up()))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3070_gun", 3868460318U), Engine.ai_get_object(guns.Squad), 1F);
            ...
            Engine.player_action_test_reset();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3070_gun", 3868460318U)));
        }
        ...
        public async Task test_mindread_down()
        {
            ...
            if (!(Engine.objects_can_see_object(Engine.players(), looker_light_bottom_red.Entity, 3F) || (bool)Engine.player0_looking_down()))
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3060_gun", 3868525855U), Engine.ai_get_object(guns.Squad), 1F);
            ...
            Engine.player_action_test_look_pitch_end();
            Engine.player_action_test_reset();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3060_gun", 3868525855U)));
        }
        ...
        public async Task<bool> training_pitch_choose()
        {
            ...
            if ((bool)Engine.controller_get_look_invert())
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1450_gun", 3868591392U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1450_gun", 3868591392U)));
            ...
            else
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1470_gun", 3868656929U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1470_gun", 3868656929U)));
            ...
            else
            {
                ...
                if ((bool)Engine.controller_get_look_invert())
                {
                    ...
                    Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1480_gun", 3868722466U), Engine.ai_get_object(guns.Squad), 1F);
                    await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1480_gun", 3868722466U)));
                }
                else
                {
                    Engine.cs_run_command_script(guns.Squad, cs_lookat_console_inhibitor);
                    ...
                    Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1460_gun", 3868788003U), Engine.ai_get_object(guns.Squad), 1F);
                    await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1460_gun", 3868788003U)));
                }
        ...
        public async Task training_pitch()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3100_gun", 3868853540U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3100_gun", 3868853540U)));
            if ((bool)Engine.controller_get_look_invert())
            {
                Engine.print("the diagnostic software set your targeting system to be inverted");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3130_gun", 3868919077U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3130_gun", 3868919077U)));
            }
            else
            {
                Engine.print("the diagnostic software set your targeting system to be normal");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3120_gun", 3868984614U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3120_gun", 3868984614U)));
            }
            ...
            if ((bool)Engine.controller_get_look_invert())
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1570_gun", 3869050151U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1570_gun", 3869050151U)));
            }
            else
            {
                Engine.cs_run_command_script(guns.Squad, cs_lookat_console_inhibitor);
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1560_gun", 3869115688U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1560_gun", 3869115688U)));
            }

            Engine.print("if you change your mind, you can switch the setting anytime.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1580_gun", 3869181225U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1580_gun", 3869181225U)));
            Engine.hud_enable_training(false);
            Engine.hud_show_training_text(false);
        }
        ...
        public async Task training_look()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0600_gun", 3869246762U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0600_gun", 3869246762U)));
            Engine.custom_animation(Engine.ai_get_unit(guns.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0610_jon", true);
            await Engine.sleep(15);
            Engine.print("your new suit is a mark vi, sent up from songnam this morning.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0610_gun", 3869312299U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0610_gun", 3869312299U)));
            Engine.print("try to take it easy until you get used to it.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0620_gun", 3869377836U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0620_gun", 3869377836U)));
            Engine.cs_run_command_script(guns.Squad, cs_lookat_console_inhibitor);
            await Engine.sleep(30);
            Engine.print("ok.  let's test your targeting, first thing.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0630_gun", 3869443373U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0630_gun", 3869443373U)));
            Engine.objectives_show_up_to(0);
            Engine.print("please look at the top light.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3000_gun", 3869508910U), Engine.ai_get_object(guns.Squad), 1F);
            await this.test_mindread_up();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3000_gun", 3869508910U)));
            Engine.print("good.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0650_gun", 3869574447U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0650_gun", 3869574447U)));
            Engine.print("now look at the bottom light.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3010_gun", 3869639984U), Engine.ai_get_object(guns.Squad), 1F);
            await this.test_mindread_down();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3010_gun", 3869639984U)));
            Engine.print("allright");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0670_gun", 3869705521U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0670_gun", 3869705521U)));
            Engine.print("look at the top light again.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3020_gun", 3869771058U), Engine.ai_get_object(guns.Squad), 1F);
            await this.test_mindread_up();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3020_gun", 3869771058U)));
            Engine.print("that's it�");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0760_gun", 3869836595U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0760_gun", 3869836595U)));
            Engine.print("now the bottom one.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3030_gun", 3869902132U), Engine.ai_get_object(guns.Squad), 1F);
            await this.test_mindread_down();
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3030_gun", 3869902132U)));
            Engine.print("ok.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0740_gun", 3869967669U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep(30);
            Engine.player_camera_control(true);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0740_gun", 3869967669U)));
            if (this.counter_mindread_normal_success >= 2)
            {
                await Engine.sleep(30);
                Engine.print("everything checks out.");
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0770_gun", 3870033206U), Engine.ai_get_object(guns.Squad), 1F);
                await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0770_gun", 3870033206U)));
                Engine.controller_set_look_invert(false);
            }
        ...
        public async Task training_move()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0790_gun", 3870098743U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0790_gun", 3870098743U)));
            Engine.device_set_position(inhibitor.Entity, 1F);
            Engine.player_disable_movement(false);
            Engine.hud_enable_training(true);
            Engine.cs_run_command_script(guns.Squad, cs_lookat_console_inhibitor);
            await Engine.sleep(30);
            Engine.custom_animation(Engine.ai_get_unit(guns.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0800_jon", true);
            await Engine.sleep(10);
            Engine.print("move around a little, get a feel for it.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0800_gun", 3870164280U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0800_gun", 3870164280U)));
            Engine.print("when you're ready, come and meet me by the zapper.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0810_gun", 3870229817U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0810_gun", 3870229817U)));
        ...
        public async Task training_shield()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3150_gun", 3870295354U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3150_gun", 3870295354U)));
            Engine.print("this station will test your recharging energy shields");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3140_gun", 3870360891U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3140_gun", 3870360891U)));
            ...
            await Engine.sleep(15);
            Engine.print("bingo!");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0940_gun", 3870426428U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep(30);
            Engine.cs_run_command_script(guns.Squad, cs_lookat_console_zapper);
            Engine.print("as you can see, they re-charge a lot faster.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0950_gun", 3870491965U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep(45);
            ...
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0950_gun", 3870491965U)));
            await Engine.sleep(60);
            Engine.device_set_power(zapper.Entity, 0F);
            Engine.device_set_power(zapper_cage.Entity, 0F);
            await Engine.sleep(30);
            Engine.custom_animation(Engine.ai_get_unit(guns.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0960_jon", true);
            Engine.print("if your shields go down, find some cover, wait for the meter to read fully-charged.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0960_gun", 3870557502U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep(45);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0960_gun", 3870557502U)));
            Engine.print("that, or he can just hide behind me.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0970_jon", 3870623039U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep(30);
            Engine.cs_run_command_script(guns.Squad, cs_lookat_johnson);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0970_jon", 3870623039U)));
            await Engine.sleep(15);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)((float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U)) - 90));
            Engine.cs_run_command_script(johnson.Squad, cs_lookat_player);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1000_jon", 3870688576U)));
            Engine.print("his armor's working fine.");
            Engine.unit_set_emotional_state(Engine.ai_get_unit(guns.Squad), "annoyed", 0.5F, 1);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1010_gun", 3870754113U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1010_gun", 3870754113U)));
            await Engine.sleep(15);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)((float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U)) - 60));
            Engine.cs_run_command_script(johnson.Squad, cs_lookat_player);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0980_gun", 3870819650U)));
        }
        ...
        public async Task training_done_tram()
        {
            ...
            Engine.custom_animation_loop(tram_marine_1.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
            Engine.custom_animation_loop(tram_marine_2.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_fist_loop", false);
            Engine.custom_animation_loop(tram_marine_3.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_clapping_loop", false);
            await Engine.sleep(5);
            Engine.custom_animation_loop(tram_marine_6.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
            Engine.custom_animation_loop(tram_marine_5.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_fist_loop", false);
            Engine.custom_animation_loop(tram_marine_4.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_clapping_loop", false);
            await Engine.sleep(5);
            Engine.custom_animation_loop(tram_marine_7.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x02\\x02", 3870885187U), "marine_whistle_loop", false);
        ...
        public async Task training_done()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1040_jon", 3870950724U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)((float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1040_jon", 3870950724U)) - 30));
            Engine.cs_run_command_script(johnson.Squad, cs_johnson_elevator);
            await Engine.sleep(15);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3360_gun", 3871016261U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3360_gun", 3871016261U)));
            Engine.print("sorry, guns.  it's classified.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0990_jon", 3871081798U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)((float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0990_jon", 3871081798U)) - 0));
            Engine.unit_set_emotional_state(Engine.ai_get_unit(guns.Squad), "angry", 0.5F, 1);
            await Engine.sleep(5);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3370_gun", 3871147335U), Engine.ai_get_object(guns.Squad), 1F);
            await Engine.sleep(30);
            ...
            Engine.sound_impulse_stop(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_3370_gun", 3871147335U));
            await Engine.sleep(10);
            Engine.print("well he's in a particularly fine mood. maybe lord hood forgot to give him an invitation.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U), Engine.ai_get_object(johnson.Squad), 1F);
        }
        ...
        public async Task training_tram()
        {
            ...
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U)));
            ...
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0010_jon", true);
            await Engine.sleep(10);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_1810_jon", 3871212872U)));
            Engine.print("earth. haven't seen it in years.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0010_jon", 3871278409U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)((float)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0010_jon", 3871278409U)) - 30));
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\01a_tutorial\\01a_music\\01a_01", 3871343946U), default(IGameObject), 1F);
            ...
            await Engine.sleep(30);
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0020_jon", true);
            Engine.print("when i shipped out for basic, the orbital defense grid was all theory and politics.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0020_jon", 3871475020U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0020_jon", 3871475020U)));
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0021_jon", 3871540557U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0021_jon", 3871540557U)));
            await Engine.sleep_until(async () => Engine.device_get_position(tram.Entity) >= 0.275F, 1);
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0030_jon", true);
            await Engine.sleep(10);
            Engine.print("that mac-gun can put a round clean through a covenant capital-ship.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0030_jon", 3871606094U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0030_jon", 3871606094U)));
            ...
            await Engine.sleep(45);
            await Engine.sleep(45);
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0040_jon", true);
            Engine.print("with coordinated fire from the athens and the malta, nothing's getting past this battle-cluster in one piece.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0040_jon", 3871671631U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0040_jon", 3871671631U)));
            await Engine.sleep(15);
            await Engine.sleep_until(async () => Engine.device_get_position(tram.Entity) >= 0.7F, 1);
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0050_jon", true);
            Engine.print("ships have been arriving all morning.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0050_jon", 3871737168U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0050_jon", 3871737168U)));
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\01a_tutorial\\01a_music\\01a_01", 3871343946U));
            await Engine.sleep_until(async () => Engine.device_get_position(tram.Entity) >= 0.75F, 1);
            await Engine.sleep(30);
            Engine.custom_animation(Engine.ai_get_unit(johnson.Squad), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\tutorial\\tutorial", 3866887430U), "l01_0051_jon", true);
            Engine.print("nobody's saying much, but i'll bet something big's about to happen.");
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0051_jon", 3871802705U), Engine.ai_get_object(johnson.Squad), 1F);
            await Engine.sleep((short)Engine.sound_impulse_language_time(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\01_spacestation\\mission\\l01_0051_jon", 3871802705U)));
