...
#region Fields
        ...
        public async Task backwash_weather()
        {
            ...
            Engine.weather_change_intensity(0F, 0.3F);
            await Engine.sleep((short)Engine.random_range(900, 1800));
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () => Engine.print("stopping"), 
                    async () => Engine.weather_stop((float)Engine.random_range(10, 20)), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1800)), 
                    async () => Engine.print("restarting"), 
                    async () => Engine.weather_start((float)Engine.random_range(10, 20)), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1800)), 
                    async () => Engine.print("light rain"), 
                    async () => Engine.weather_change_intensity((float)Engine.random_range(10, 20), 0.3F), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1800)), 
                    async () => Engine.print("light rain"), 
                    async () => Engine.weather_change_intensity((float)Engine.random_range(10, 20), 0.3F), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1800)), 
                    async () => Engine.print("heavy rain"), 
                    async () => Engine.weather_change_intensity((float)Engine.random_range(10, 20), 1F), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1200)), 
                    async () => Engine.weather_change_intensity((float)Engine.random_range(10, 20), 0.3F), 
                    async () => await Engine.sleep((short)Engine.random_range(900, 1200)));
                return false;
            });
