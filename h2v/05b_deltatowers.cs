...
#region Fields
        ...
        public scnr_05b_deltatowers(IScriptEngine scriptEngine)
        {
            ...
            this.splashy = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\deltatemple\\elevator_splash", 4279901415U);
            ...
            this.regret_teleport = Engine.GetTag<EffectTag>("effects\\gameplay\\regret_teleport", 4280163563U);
            this.regret_blood = Engine.GetTag<EffectTag>("effects\\contact\\collision\\blood_aoe\\blood_aoe_human", 4086305306U);
            this.regret_lives = 0;
        }
 ...
 == "normal";
        ...
        {
            Engine.wake(_05_intra1_01_predict);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task _05_intra1_02_predict_stub()
        {
            Engine.wake(_05_intra1_02_predict);
        ...
        public async Task c05_intra1_score_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\music\\c05_intra1_02_mus", 3831759598U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_01_fol", 3831825135U), default(IGameObject), 1F);
        ...
        public async Task c05_2010_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2010_cor", 3831890672U), default(IGameObject), 1F);
        ...
        public async Task c05_2020_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2020_cor", 3831956209U), cortana.Entity, 1F);
        ...
        public async Task c05_2030_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2030_cor", 3832021746U), cortana.Entity, 1F);
        ...
        public async Task c05_2040_mas()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2040_mas", 3832087283U), chief.Entity, 1F);
        ...
        public async Task c05_2050_por()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2050_por", 3832152820U), regret.Entity, 1F);
        ...
        public async Task c05_2060_cor()
        {
            ...
            await Engine.sleep(30);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2060_cor", 3832218357U), cortana.Entity, 1F);
        ...
        public async Task c05_2070_mas()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2070_mas", 3832283894U), chief.Entity, 1F);
        ...
        public async Task c05_2080_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2080_mir", 3832349431U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task cortana_appear()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\cortana\\cortana_on_off", 3832414968U), cortana_base.Entity, "marker");
        }
        ...
        public async Task c05_intra1_01_setup()
        {
            ...
            Engine.wake(c05_2010_cor);
            Engine.wake(c05_2020_cor);
            Engine.wake(c05_2030_cor);
            Engine.wake(c05_2040_mas);
            Engine.wake(c05_2050_por);
            Engine.wake(c05_2060_cor);
            Engine.wake(c05_2070_mas);
            Engine.wake(c05_2080_mir);
            Engine.wake(c05_intra1_score_01);
            Engine.wake(c05_intra1_foley_01);
            Engine.wake(cortana_appear);
            Engine.wake(c05_intra1_cinematic_light_01);
        }
        ...
        public async Task c05_intra1_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\music\\c05_intra1_02_mus", 3831759598U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_01_fol", 3831825135U));
            await Engine.sleep(this.prediction_offset);
            await this.c05_intra1_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_01", default(IUnit), anchor_flag_intra1a);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra1\\05_intra1", 3833332486U), "chief_01", false, anchor_intra1a.Entity);
            Engine.custom_animation_relative(regret.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\05_intra1\\05_intra1", 3833398023U), "regret_01", false, anchor_intra1a.Entity);
            await Engine.sleep(5);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep(94);
            Engine.custom_animation_relative(cortana.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\cortana\\05_intra1\\05_intra1", 3833529097U), "cortana_01", false, anchor_intra1a.Entity);
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_02_fol", 3833660171U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_02_fol", 3833660171U), default(IGameObject), 1F);
        ...
        public async Task c05_2090_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2090_mir", 3833725708U), miranda.Entity, 1F);
        ...
        public async Task c05_2100_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2100_mir", 3833791245U), miranda.Entity, 1F);
        ...
        public async Task c05_2110_jon()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2110_jon", 3833856782U), johnson.Entity, 1F, "radio_default_loop");
        ...
        public async Task c05_2120_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2120_mir", 3833922319U), miranda.Entity, 1F);
        ...
        public async Task c05_2130_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2130_mir", 3833987856U), miranda.Entity, 1F);
        ...
        public async Task c05_2140_jon()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2140_jon", 3834053393U), johnson.Entity, 1F, "radio_default_loop");
        ...
        public async Task intra1_texture_camera_on()
        {
            ...
            Engine.scenery_animation_start_relative(texture_camera.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\05_intra1\\05_intra1", 3834118930U), "texture_camera_02", anchor_intra1b.Entity);
        ...
        public async Task c05_intra1_02_setup()
        {
            ...
            Engine.wake(c05_2090_mir);
            Engine.wake(c05_2100_mir);
            Engine.wake(c05_2110_jon);
            Engine.wake(c05_2120_mir);
            Engine.wake(c05_2130_mir);
            Engine.wake(c05_2140_jon);
            Engine.wake(c05_intra1_foley_02);
            Engine.wake(intra1_texture_camera_on);
            Engine.wake(c05_intra1_cinematic_light_02);
        }
        ...
        public async Task c05_intra1_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_02", default(IUnit), anchor_flag_intra1b);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\05_intra1\\05_intra1", 3834184467U), "miranda_02", false, anchor_intra1b.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\05_intra1\\05_intra1", 3836740410U), "johnson_02", false, anchor_intra1b.Entity);
            Engine.custom_animation_relative(pilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\05_intra1\\05_intra1", 3836740410U), "marine01_02", false, anchor_intra1b.Entity);
            Engine.scenery_animation_start_relative(iac_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\05_intra1\\05_intra1", 3836871484U), "bridge_02", anchor_intra1b.Entity);
            Engine.scenery_animation_start_relative(holo_index.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\index_holo_human\\05_intra1\\05_intra1", 3836937021U), "index_holo_human_02", anchor_intra1b.Entity);
            Engine.scenery_animation_start_relative(holo_library.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\mount_doom_holo\\05_intra1\\05_intra1", 3837002558U), "mount_doom_holo_02", anchor_intra1b.Entity);
            Engine.scenery_animation_start_relative(matte_horizon.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\05_intra1\\05_intra1", 3837068095U), "delta_horizon_02", anchor_intra1b.Entity);
            Engine.custom_animation_relative(pelican_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\05_intra1\\05_intra1", 3837133632U), "pelican_02", false, anchor_intra1b.Entity);
            await Engine.sleep(30);
            Engine.fade_in(1F, 1F, 1F, 5);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._05_intra1_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_03_fol", 3837199169U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_03_fol", 3837199169U), default(IGameObject), 1F);
        ...
        public async Task c05_2150_mir()
        {
            ...
            await Engine.sleep(0);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2150_mir", 3837264706U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c05_2160_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2160_mir", 3837330243U), default(IGameObject), 1F, "radio_default_out");
        ...
        {
            Engine.wake(c05_2150_mir);
            Engine.wake(c05_2160_mir);
            Engine.wake(c05_intra1_foley_03);
            Engine.wake(c05_intra1_cinematic_light_03);
            Engine.wake(cortana_disappear);
        }
        ...
        public async Task c05_intra1_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_03", default(IUnit), anchor_flag_intra1a);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra1\\05_intra1", 3833332486U), "chief_03", false, anchor_intra1a.Entity);
            Engine.custom_animation_relative(cortana.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\cortana\\05_intra1\\05_intra1", 3833529097U), "cortana_03", false, anchor_intra1a.Entity);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra2\\foley\\c05_intra2_01_fol", 3837395780U), default(IGameObject), 1F);
        ...
        public async Task c05_3010_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3010_cor", 3837461317U), default(IGameObject), 1F);
        ...
        public async Task c05_3020_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3020_cor", 3837526854U), default(IGameObject), 1F);
        ...
        public async Task c05_3030_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3030_cor", 3837592391U), default(IGameObject), 1F);
        ...
        public async Task c05_intra2_setup()
        {
            ...
            Engine.object_cinematic_lod(chief.Entity, true);
            Engine.cinematic_clone_players_weapon(chief.Entity, "right_hand", "");
            Engine.wake(c05_3010_cor);
            Engine.wake(c05_3020_cor);
            Engine.wake(c05_3030_cor);
            Engine.wake(c05_intra2_foley);
            Engine.wake(fleet_arrival);
            Engine.wake(c05_intra2_dof);
            Engine.wake(c05_intra2_cinematic_light);
        }
        ...
        public async Task c05_intra2()
        {
            ...
            await this._05_intra1_01_predict_stub();
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra2\\foley\\c05_intra2_01_fol", 3837395780U));
            await Engine.sleep(this.prediction_offset);
            await this.c05_intra2_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra2\\05_intra2", 3837657928U), "05_intra2_01", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra2\\05_intra2", 3837723465U), "chief_01", false, anchor_outro.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\music\\c05_outro_01_mus", 3837789002U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_01_fol", 3837854539U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_01_setup()
        {
            ...
            Engine.wake(c05_outro_score_01);
            Engine.wake(c05_outro_foley_01);
            Engine.wake(effect_dust_scrape);
            Engine.wake(c05_outro_01_dof);
            Engine.wake(c05_outro_cinematic_light_01);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\covenant_beam", 3837920076U), carrier.Entity, "beam");
        }
        ...
        public async Task c05_outro_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\music\\c05_outro_01_mus", 3837789002U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_01_fol", 3837854539U));
            Engine.wake(c05_outro_problem_actors);
            await Engine.sleep(this.prediction_offset);
            await this.c05_outro_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_01", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_01", false, anchor_outro.Entity);
            Engine.scenery_animation_start_relative(carrier.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_01", anchor_outro.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._05_outro_02_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_02_fol", 3839296353U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_02_fol", 3839296353U), default(IGameObject), 1F);
        ...
        {
            Engine.wake(c05_outro_foley_02);
            Engine.wake(effect_dust_land);
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_02", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_02", false, anchor_outro.Entity);
            Engine.scenery_animation_start_relative(carrier.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_02", anchor_outro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._05_outro_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_03_fol", 3839361890U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_03_fol", 3839361890U), default(IGameObject), 1F);
        ...
        {
            Engine.wake(c05_outro_foley_03);
            Engine.wake(c05_outro_fov_01);
        }
        ...
        public async Task c05_outro_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_03", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_03", false, anchor_outro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._05_outro_04_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_04_fol", 3839427427U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_04_fol", 3839427427U), default(IGameObject), 1F);
        ...
        {
            Engine.wake(c05_outro_foley_04);
            Engine.object_create_anew(outro_beam);
            Engine.print("start beam");
            Engine.camera_set_field_of_view(60F, 0);
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_04", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_04", false, anchor_outro.Entity);
            Engine.scenery_animation_start_relative(carrier.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_04", anchor_outro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
        ...
        public async Task x07_0220_grv()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\06_sentinelwall\\cinematic\\x07_0220_grv", 3839492964U), default(IGameObject), 1F);
        ...
        public async Task x07_0230_grv()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\06_sentinelwall\\cinematic\\x07_0230_grv", 3839558501U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_bubbles()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles01");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles04");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles06");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles08");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles09");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles11");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles12");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles14");
        }
        ...
        public async Task c05_outro_05_setup()
        {
            ...
            Engine.wake(x07_0220_grv);
            Engine.wake(x07_0230_grv);
            Engine.wake(c05_outro_cinematic_light_05);
            Engine.wake(c05_outro_bubbles);
            Engine.wake(c05_outro_caustic);
        }
        ...
        public async Task c05_outro_scene_05()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_05", default(IUnit), anchor_flag_outro);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_05", false, anchor_outro.Entity);
            Engine.scenery_animation_start_relative(rubble.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\effects\\05_outro_rubble\\05_outro_rubble", 3840017260U), "05_outro_05", anchor_outro.Entity);
            Engine.scenery_animation_start_relative(tentacle_capture_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\05_outro\\05_outro", 3840082797U), "tentacle1_05", anchor_outro.Entity);
            Engine.scenery_animation_start_relative(tentacle_capture_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\05_outro\\05_outro", 3840082797U), "tentacle2_05", anchor_outro.Entity);
        ...
        public async Task music_05b_01_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_01", 4277869768U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_01_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_01", 4277869768U));
        }
        ...
        public async Task music_05b_02_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_02", 4278131916U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_02_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_02", 4278131916U));
        }
        ...
        public async Task music_05b_03_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_03", 4278328527U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_03_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_03", 4278328527U));
        }
        ...
        public async Task music_05b_04_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_04", 4278590675U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_04_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_04", 4278590675U));
        }
        ...
        public async Task music_05b_05_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_05", 4278787286U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_06_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_06", 4278918360U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_06_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_06", 4278918360U));
        }
        ...
        public async Task music_05b_07_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_07", 4279114971U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_08_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_08", 4279311582U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_09_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_09_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U), true);
        }
        ...
        public async Task music_05b_09_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U));
        }
        ...
        public async Task music_05b_10_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_10", 4279704804U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_10_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_10", 4279704804U));
        }
        ...
        public async Task tower1_holo_looper()
        {
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task tower1_start()
        {
            ...
            Engine.game_save();
            Engine.wake(tower1_cortana_comment);
            await Engine.sleep(60);
            Engine.wake(music_05b_01_start);
        }
        ...
        public async Task bridges_start()
        {
            ...
            Engine.wake(cortana_bridge_reminder);
        ...
        public async Task tower2_start()
        {
            ...
            Engine.game_save();
            Engine.wake(tower2_cortana_comment);
        }
        ...
        public async Task central_platform_start()
        {
            ...
            Engine.game_save();
            Engine.wake(central_plat_ph_go);
            ...
            await Engine.sleep(30);
            Engine.wake(music_05b_02_start);
            await Engine.sleep(60);
            Engine.wake(miranda_pelican_comment);
            await Engine.sleep_until(async () => this.miranda_pel_comment_done == true);
            Engine.game_save();
            Engine.wake(central_platform_pelican);
            ...
            Engine.wake(gondola_01_cortana_warn);
            ...
            Engine.game_save();
            Engine.wake(music_05b_03_start);
            ...
            await Engine.sleep(30);
            Engine.wake(gondola_01_cortana_comment);
            await Engine.sleep(150);
            ...
            {
                Engine.wake(gondola_01_cortana_reminder);
            }
        }
        ...
        public async Task gondola_01_start()
        {
            ...
            Engine.ai_renew(all_allies);
            Engine.wake(objective_towers_clear);
            Engine.wake(objective_gondola1_set);
            Engine.wake(gondola_01_go_reminder);
            Engine.game_save();
            ...
            Engine.wake(music_05b_02_stop);
            Engine.wake(music_05b_03_stop);
            Engine.wake(tower_cluster_delete);
            ...
            Engine.wake(_05b_title1);
            Engine.device_set_position(gondola_01_launch_a.Entity, 1F);
            Engine.device_set_position(gondola_01_launch_b.Entity, 1F);
            Engine.device_set_position(gondola_01_a.Entity, 0.54F);
            Engine.device_set_position(gondola_01_b.Entity, 0.54F);
            Engine.game_save();
            Engine.wake(gondola_01_buggers_board);
            ...
            Engine.object_dynamic_simulation_disable(gondola_01_a.Entity, false);
            Engine.object_dynamic_simulation_disable(gondola_01_b.Entity, false);
            Engine.wake(music_05b_04_start);
            Engine.wake(gondola_01_reverser);
            ...
            Engine.wake(music_05b_04_stop);
            if (await this.difficulty_legendary())
            {
                Engine.wake(assassin_ice_cream);
            }
        ...
        public async Task go1to2()
        {
            ...
            if (Engine.volume_test_object(vol_elev_shaft_under, await this.player0()) == false && await this.player_count() > 0)
            {
                ...
                Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4266925089U), await this.player0(), "");
            }
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\ambience\\device_machines\\delta_sub\\sub_water_in_out\\sub_impact_water", 4280032489U), default(IGameObject), 1F);
            ...
            Engine.wake(music_05b_05_start);
            await Engine.sleep(60);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\ambience\\device_machines\\delta_sub\\sub_water_in_out\\sub_out_of_water", 4280098026U), default(IGameObject), 1F);
        ...
        public async Task go2to3()
        {
            ...
            Engine.wake(music_05b_08_start);
            await Engine.sleep(60);
            Engine.ai_erase(all_enemies);
            await Engine.sleep_until(async () =>
            {
        ...
        public async Task elev_under_monitor()
        {
            ...
            {
                Engine.object_teleport(await this.player1(), _1to2_teleport);
                Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4266925089U), await this.player1(), "");
            }
            ...
            Engine.wake(music_05b_05_start);
            await Engine.sleep(60);
            Engine.wake(elev_under_cortana_comment);
            await Engine.sleep_until(async () =>
            {
                if (Engine.objects_distance_to_object(Engine.players(), Engine.list_get(Engine.ai_actors(all_allies), 0)) > 5F)
                {
        ...
        public async Task tower3_start()
        {
            ...
            Engine.wake(tower3_sleeper_spawn);
            Engine.wake(objective_gondola1_clear);
            Engine.wake(objective_sunken_set);
            Engine.ai_place(tower3_jackals_01.Squad, 4);
            Engine.sleep_forever(tower3_turret_reman);
            ...
            Engine.wake(tower3_cortana_comment);
            if ((short)Engine.ai_living_count(all_allies) < 2)
            {
                Engine.wake(tower3_pelican_arrives);
            }
            ...
            Engine.wake(tower3_cortana_reminder_02);
            Engine.wake(elev_under_monitor);
        ...
        public async Task sunken_tunnel1_start()
        {
            ...
            Engine.wake(music_05b_06_start);
        ...
        public async Task sunken_holo_looper()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task sunken_holo_translate()
        {
            ...
            Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_l05_0140_por", true);
        ...
        public async Task sunken_chamber_start()
        {
            ...
            Engine.wake(sunken_holo_looper);
            Engine.wake(sunken_holo_cortana_comment);
            Engine.wake(hide_rightside_guys);
            Engine.wake(hide_leftside_guys);
            Engine.wake(sunken_chamber_saves);
            ...
            this.sunken_save_again = true;
            Engine.wake(sunk_chamber_hunters_enter);
            if (Engine.volume_test_objects_all(vol_sunk_chamber_left, Engine.players()) == true && await this.player_count() > 0)
            {
                if ((short)Engine.ai_living_count(sunken_chamber_enemies) < 8)
                {
            ...
            this.sunken_save_again = true;
            Engine.wake(sunken_chamber_reminder);
            ...
            Engine.wake(sunken_holo_translate);
        ...
        public async Task elev_up_monitor()
        {
            ...
            Engine.wake(music_05b_08_start);
            await Engine.sleep(60);
            Engine.wake(elev_up_cortana_comment);
            await Engine.sleep_until(async () =>
            {
                if (Engine.objects_distance_to_object(Engine.players(), Engine.list_get(Engine.ai_actors(all_allies), 0)) > 5F)
                {
        ...
        public async Task sunken_tunnel2_start()
        {
            ...
            Engine.wake(music_05b_07_start);
        ...
        public async Task island_holo_looper()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task island_int_translate()
        {
            ...
            Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_l05_0160_por", true);
        ...
        public async Task island_interior_start()
        {
            ...
            Engine.wake(objective_sunken_clear);
            Engine.wake(objective_temple_set);
            ...
            Engine.wake(island_holo_looper);
            ...
            Engine.wake(island_int_translate);
        }
        ...
        public async Task island_pelican_arrives()
        {
            ...
            await Engine.sleep(150);
            Engine.wake(island_pelican_comment);
        ...
        public async Task island_gully_start()
        {
            ...
            {
                Engine.wake(island_pelican_arrives);
            }
        }
        ...
        public async Task island_exterior_start()
        {
            ...
            Engine.game_save();
            Engine.wake(island_phantom_arrives);
            Engine.wake(gondola_02_cortana_reminder);
        ...
        public async Task island_miranda_conversation()
        {
            ...
            Engine.ai_dialogue_enable(true);
            Engine.game_save();
            Engine.wake(music_05b_09_start);
            await Engine.sleep(90);
        ...
        public async Task temple_entry_start()
        {
            ...
            await Engine.sleep(1);
            Engine.wake(_05b_title2);
            Engine.wake(objective_temple_clear);
            Engine.wake(objective_regret_set);
            ...
            ;
            Engine.wake(temple_ent_cortana_reminder);
            if (await this.difficulty_legendary())
            {
        ...
        public async Task temple_foyer_start()
        {
            ...
            Engine.wake(temple_cortana_warn_02);
        }
        ...
        public async Task regret_taunt_01()
        {
            ...
            Engine.custom_animation(Engine.unit(Engine.ai_get_object(regret1.Squad)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:point", true);
        ...
        public async Task regret_taunt_02()
        {
            ...
            Engine.custom_animation(Engine.unit(Engine.ai_get_object(regret1.Squad)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:cheer", true);
        ...
        public async Task regret_taunt_05()
        {
            ...
            Engine.custom_animation(Engine.unit(Engine.ai_get_object(regret1.Squad)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:taunt", true);
            ...
            await Engine.sleep_until(async () =>
            {
                ...
                if (Engine.unit_in_vehicle(await this.player0()) == true || Engine.unit_in_vehicle(await this.player1()) == true)
                {
                    ...
                    else
                    {
                        ...
                        Engine.unit_set_enterable_by_player(Engine.unit(this.regret_throne), false);
                        Engine.custom_animation_loop(fake_corpse.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "throne_d:dead", true);
                        Engine.ai_play_line_on_object(fake_corpse.Entity, "1380") // Couldn't generate cast from 'Short' to 'Void'
                        ;
                        await Engine.sleep(60);
                        Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\prophet\\regret_death", 4280294637U), fake_corpse.Entity, "body");
                        Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\objects\\characters\\prophet\\regret_death", 4280294637U), this.regret_throne, "");
                        Engine.unit_exit_vehicle(await this.player0(), 1);
                        Engine.unit_exit_vehicle(await this.player1(), 1);
                        ...
                        await Engine.sleep(150);
                        Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\vehicles\\damage_effects\\cov_damage_large", 3901163281U), this.regret_throne, 1F);
                    }
                }
                else if (Engine.objects_distance_to_object(Engine.players(), Engine.list_get(Engine.ai_actors(regret1.Squad), 0)) < 5F)
                {
        ...
        public async Task regret_test()
        {
            ...
            Engine.custom_animation_loop(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:cheer", true);
        }
        ...
        public async Task temple_center_start()
        {
            ...
            Engine.wake(temple_cortana_warn_01);
            Engine.wake(regret_taunts);
            ...
            Engine.sleep_forever(regret_taunts);
        ...
        {
            Engine.sleep_forever(tower1_start);
            Engine.sleep_forever(tower1_holo_looper);
            Engine.sleep_forever(tower1_cortana_comment);
        }
        ...
        public async Task sleep_bridges()
        {
            ...
            Engine.sleep_forever(cortana_bridge_reminder);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_tower2()
        {
            Engine.sleep_forever(tower2_start);
            Engine.sleep_forever(tower2_cortana_comment);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_central_platform()
        {
            Engine.sleep_forever(central_platform_start);
            Engine.sleep_forever(central_platform_pelican);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_gondola_01()
        {
            Engine.sleep_forever(gondola_01_start);
            Engine.sleep_forever(tower3_dock_above);
            Engine.sleep_forever(gondola_01_nuke);
            Engine.sleep_forever(gondola_01_restarter);
            Engine.sleep_forever(gondola_01_reverser);
            Engine.sleep_forever(gondola_01_go_reminder);
            Engine.sleep_forever(gondola_01_phantom_arrives);
            Engine.sleep_forever(tower3_turret_reman);
            Engine.sleep_forever(tower3_cortana_comment);
            Engine.sleep_forever(gondola_01_wake);
            Engine.sleep_forever(tower_cluster_delete);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_tower3()
        {
            Engine.sleep_forever(tower3_start);
            Engine.sleep_forever(tower3_sleeper_spawn);
            Engine.sleep_forever(tower3_cortana_reminder_02);
            Engine.sleep_forever(elev_under_monitor);
            Engine.sleep_forever(assassin_ice_cream);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_sunken_tunnel_01()
        {
            Engine.sleep_forever(sunken_tunnel1_start);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_sunken_chamber()
        {
            Engine.sleep_forever(sunken_chamber_start);
            Engine.sleep_forever(sunken_holo_cortana_comment);
            Engine.sleep_forever(sunken_holo_looper);
            Engine.sleep_forever(sunken_holo_translate);
            Engine.sleep_forever(sunken_chamber_reminder);
            Engine.sleep_forever(hide_rightside_guys);
            Engine.sleep_forever(hide_leftside_guys);
            Engine.sleep_forever(sunk_chamber_hunters_enter);
            Engine.sleep_forever(sunken_chamber_saves);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_sunken_tunnel_02()
        {
            Engine.sleep_forever(sunken_tunnel2_start);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_island_exterior()
        {
            Engine.sleep_forever(island_interior_start);
            Engine.sleep_forever(island_gully_start);
            Engine.sleep_forever(island_exterior_start);
            Engine.sleep_forever(elev_up_monitor);
            Engine.sleep_forever(island_holo_looper);
            Engine.sleep_forever(island_int_translate);
            Engine.sleep_forever(island_pelican_arrives);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_gondola_02()
        {
            Engine.sleep_forever(gondola_02_start);
            Engine.sleep_forever(gondola_02_cortana_reminder);
            Engine.sleep_forever(gondola_02_nuke);
            Engine.sleep_forever(gondola_02_restarter);
            Engine.sleep_forever(gondola_02_reverser);
            Engine.sleep_forever(gondola_02_wake);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_temple_entry()
        {
            Engine.sleep_forever(temple_entry_start);
            Engine.sleep_forever(temple_foyer_start);
            Engine.sleep_forever(temple_ent_cortana_reminder);
        }

        [ScriptMethod(Lifecycle.Static)]
        public async Task sleep_boss_fight()
        {
            Engine.sleep_forever(temple_center_start);
            Engine.sleep_forever(temple_hg_respawner);
            Engine.sleep_forever(regret_respawner);
            Engine.sleep_forever(regret_retreat);
            Engine.sleep_forever(regret_beam_comment);
            Engine.sleep_forever(regret_hg_comment);
            Engine.sleep_forever(temple_cortana_warn_01);
            Engine.sleep_forever(regret_taunts);
        }
        ...
        public async Task mission()
        {
            ...
            await Engine.cache_block_for_one_frame();
            await Engine.sleep(1);
            Engine.wake(_05b_title0);
            Engine.wake(objective_towers_set);
            ...
            Engine.wake(sunken_tunnel1_start);
            Engine.wake(sunken_chamber_start);
            Engine.wake(sunken_tunnel2_start);
            ...
            Engine.wake(island_interior_start);
            Engine.wake(island_gully_start);
            Engine.wake(island_exterior_start);
            Engine.wake(gondola_02_start);
        ...
        {
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_short\\bowl_short", 3841917833U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3848733681U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3848733681U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium\\stone_block_medium", 3850241032U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            await Engine.sleep(1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_01"), 10, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_floodlight\\cov_floodlight", 3851027476U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3851551772U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3851879457U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 8);
            await Engine.sleep(98);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 8);
        ...
        {
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3853255734U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3853255734U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3855090770U), 0);
            await Engine.sleep(4);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\delta_horizon", 3859022990U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\index_holo_human\\index_holo_human", 3859350675U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\mount_doom_holo\\mount_doom_holo", 3860006045U), 0);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            await Engine.sleep(7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\water_elevator\\water_elevator", 3861382322U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3862168766U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3863545043U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3863545043U), 1);
            await Engine.sleep(215);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3862168766U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 61);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 54);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 72);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 56);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 74);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 69);
            await Engine.sleep(135);
        ...
        public async Task _05_intra2_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_floodlight\\cov_floodlight", 3851027476U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\fp_beam_rifle\\fp_beam_rifle", 3807117686U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 20);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 29);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 22);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 62);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 56);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 30);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 32);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\projectiles\\needler_shard\\needler_shard", 3876586906U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 10);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola\\gondola", 3877373350U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3878290868U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3879404997U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3807773056U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3879404997U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3807773056U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 2);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 1);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 13);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\ambient_life\\bird_quadwing\\bird_quadwing", 3879732682U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_large\\stone_block_large", 3880060367U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3878290868U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_short\\bowl_short", 3841917833U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            ...
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            await Engine.sleep(150);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\human\\military\\resupply_capsule\\resupply_capsule_crate\\resupply_capsule_crate", 3880125904U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_branch\\tree_branch", 3880453589U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_bush\\tree_bush", 3880977885U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_ancient_medium\\tree_ancient_medium", 3881043422U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_ancient_large\\tree_ancient_large", 3881108959U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_large\\stone_block_large", 3880060367U), 0);
            await Engine.sleep(6);
        ...
        public async Task _05_outro_01_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3881305570U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 1);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 2);
        ...
        public async Task _05_outro_04_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\carrier_plasma_beam_closeup\\carrier_plasma_beam_closeup", 3882288625U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3881174496U), 0);
        }
        ...
        public async Task _05_outro_05_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3881174496U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3882550773U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3882550773U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\05_outro_rubble\\05_outro_rubble", 3883402754U), 0);
        ...
        public async Task teleport_bridges()
        {
            ...
            Engine.wake(temple_foyer_start);
            Engine.wake(temple_center_start);
            Engine.wake(temple_foyer_retreat);
            Engine.wake(temple_entry_retreat);
            await this.sleep_island_exterior();
            await this.sleep_gondola_02();
        }
