...
#region Fields
        ...
        public scnr_05b_deltatowers(IScriptEngine scriptEngine)
        {
            ...
            this.splashy = GetTag<EffectTag>("effects\\scenarios\\solo\\deltatemple\\elevator_splash", 4279901415U);
            ...
            this.regret_teleport = GetTag<EffectTag>("effects\\gameplay\\regret_teleport", 4280163563U);
            this.regret_blood = GetTag<EffectTag>("effects\\contact\\collision\\blood_aoe\\blood_aoe_human", 4086305306U);
            this.regret_lives = 0;
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\music\\c05_intra1_02_mus", 3831759598U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_01_fol", 3831825135U), default(IGameObject), 1F);
        ...
        {
            await sleep(17);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2010_cor", 3831890672U), default(IGameObject), 1F);
        ...
        {
            await sleep(135);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2020_cor", 3831956209U), cortana.Entity, 1F);
        ...
        {
            await sleep(200);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2030_cor", 3832021746U), cortana.Entity, 1F);
        ...
        {
            await sleep(299);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2040_mas", 3832087283U), chief.Entity, 1F);
        ...
        {
            await sleep(357);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2050_por", 3832152820U), regret.Entity, 1F);
        ...
        public async Task c05_2060_cor()
        {
            ...
            await sleep(30);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2060_cor", 3832218357U), cortana.Entity, 1F);
        ...
        {
            await sleep(622);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2070_mas", 3832283894U), chief.Entity, 1F);
        ...
        {
            await sleep(678);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2080_mir", 3832349431U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task cortana_appear()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\cortana\\cortana_on_off", 3832414968U), cortana_base.Entity, "marker");
        }
        ...
        public async Task c05_intra1_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\music\\c05_intra1_02_mus", 3831759598U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_01_fol", 3831825135U));
            await sleep(this.prediction_offset);
            await this.c05_intra1_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_01", default(IUnit), anchor_flag_intra1a);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra1\\05_intra1", 3833332486U), "chief_01", false, anchor_intra1a.Entity);
            custom_animation_relative(regret.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\05_intra1\\05_intra1", 3833398023U), "regret_01", false, anchor_intra1a.Entity);
            await sleep(5);
            fade_in(1F, 1F, 1F, 15);
            await sleep(94);
            custom_animation_relative(cortana.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\05_intra1\\05_intra1", 3833529097U), "cortana_01", false, anchor_intra1a.Entity);
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_02_fol", 3833660171U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_02_fol", 3833660171U), default(IGameObject), 1F);
        ...
        public async Task c05_2090_mir()
        {
            ...
            await sleep(7);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2090_mir", 3833725708U), miranda.Entity, 1F);
        ...
        {
            await sleep(162);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2100_mir", 3833791245U), miranda.Entity, 1F);
        ...
        {
            await sleep(373);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2110_jon", 3833856782U), johnson.Entity, 1F, "radio_default_loop");
        ...
        {
            await sleep(455);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2120_mir", 3833922319U), miranda.Entity, 1F);
        ...
        {
            await sleep(509);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2130_mir", 3833987856U), miranda.Entity, 1F);
        ...
        {
            await sleep(574);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2140_jon", 3834053393U), johnson.Entity, 1F, "radio_default_loop");
        ...
        public async Task intra1_texture_camera_on()
        {
            ...
            scenery_animation_start_relative(texture_camera.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\05_intra1\\05_intra1", 3834118930U), "texture_camera_02", anchor_intra1b.Entity);
            await sleep(150);
        ...
        public async Task c05_intra1_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_02", default(IUnit), anchor_flag_intra1b);
            custom_animation_relative(miranda.Entity, GetTag<AnimationGraphTag>("objects\\characters\\miranda\\05_intra1\\05_intra1", 3834184467U), "miranda_02", false, anchor_intra1b.Entity);
            custom_animation_relative(johnson.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\05_intra1\\05_intra1", 3836740410U), "johnson_02", false, anchor_intra1b.Entity);
            custom_animation_relative(pilot.Entity, GetTag<AnimationGraphTag>("objects\\characters\\marine\\05_intra1\\05_intra1", 3836740410U), "marine01_02", false, anchor_intra1b.Entity);
            scenery_animation_start_relative(iac_bridge.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\05_intra1\\05_intra1", 3836871484U), "bridge_02", anchor_intra1b.Entity);
            scenery_animation_start_relative(holo_index.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\index_holo_human\\05_intra1\\05_intra1", 3836937021U), "index_holo_human_02", anchor_intra1b.Entity);
            scenery_animation_start_relative(holo_library.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\forerunner\\mount_doom_holo\\05_intra1\\05_intra1", 3837002558U), "mount_doom_holo_02", anchor_intra1b.Entity);
            scenery_animation_start_relative(matte_horizon.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\05_intra1\\05_intra1", 3837068095U), "delta_horizon_02", anchor_intra1b.Entity);
            custom_animation_relative(pelican_01.Entity, GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\05_intra1\\05_intra1", 3837133632U), "pelican_02", false, anchor_intra1b.Entity);
            await sleep(30);
            fade_in(1F, 1F, 1F, 5);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._05_intra1_03_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_03_fol", 3837199169U));
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra1\\foley\\c05_intra1_03_fol", 3837199169U), default(IGameObject), 1F);
        ...
        public async Task c05_2150_mir()
        {
            ...
            await sleep(0);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2150_mir", 3837264706U), default(IGameObject), 1F, "radio_default_loop");
        ...
        {
            await sleep(99);
            sound_impulse_start_effect(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_2160_mir", 3837330243U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task c05_intra1_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra1\\05_intra1", 3833266949U), "05_intra1_03", default(IUnit), anchor_flag_intra1a);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra1\\05_intra1", 3833332486U), "chief_03", false, anchor_intra1a.Entity);
            custom_animation_relative(cortana.Entity, GetTag<AnimationGraphTag>("objects\\characters\\cortana\\05_intra1\\05_intra1", 3833529097U), "cortana_03", false, anchor_intra1a.Entity);
            await sleep(50);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra2\\foley\\c05_intra2_01_fol", 3837395780U), default(IGameObject), 1F);
        ...
        {
            await sleep(275);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3010_cor", 3837461317U), default(IGameObject), 1F);
        ...
        {
            await sleep(359);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3020_cor", 3837526854U), default(IGameObject), 1F);
        ...
        {
            await sleep(513);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_3030_cor", 3837592391U), default(IGameObject), 1F);
        ...
        public async Task c05_intra2()
        {
            ...
            await this._05_intra1_01_predict_stub();
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intra2\\foley\\c05_intra2_01_fol", 3837395780U));
            await sleep(this.prediction_offset);
            await this.c05_intra2_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intra2\\05_intra2", 3837657928U), "05_intra2_01", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intra2\\05_intra2", 3837723465U), "chief_01", false, anchor_outro.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - 15));
            fade_out(1F, 1F, 1F, 15);
            await sleep(15);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\music\\c05_outro_01_mus", 3837789002U), default(IGameObject), 1F);
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_01_fol", 3837854539U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_01_setup()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\covenant_beam", 3837920076U), carrier.Entity, "beam");
        }
        ...
        public async Task c05_outro_scene_01()
        {
            ...
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\music\\c05_outro_01_mus", 3837789002U));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_01_fol", 3837854539U));
            wake(new ScriptMethodReference(c05_outro_problem_actors));
            await sleep(this.prediction_offset);
            await this.c05_outro_01_setup();
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_01", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_01", false, anchor_outro.Entity);
            scenery_animation_start_relative(carrier.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_01", anchor_outro.Entity);
            fade_in(1F, 1F, 1F, 15);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._05_outro_02_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_02_fol", 3839296353U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_02_fol", 3839296353U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_scene_02()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_02", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_02", false, anchor_outro.Entity);
            scenery_animation_start_relative(carrier.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_02", anchor_outro.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._05_outro_03_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_03_fol", 3839361890U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_03_fol", 3839361890U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_scene_03()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_03", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_03", false, anchor_outro.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
            await this._05_outro_04_predict_stub();
            await sleep((short)((float)camera_time() - this.sound_offset));
            sound_impulse_predict(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_04_fol", 3839427427U));
            await sleep((short)camera_time());
        }
        ...
        {
            await sleep(0);
            sound_impulse_start(GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_outro\\foley\\c05_outro_04_fol", 3839427427U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_scene_04()
        {
            ...
            print("start beam");
            camera_set_field_of_view(60F, 0);
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_04", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_04", false, anchor_outro.Entity);
            scenery_animation_start_relative(carrier.Entity, GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\05_outro\\05_outro", 3839230816U), "cruiser_04", anchor_outro.Entity);
            await sleep((short)((float)camera_time() - this.prediction_offset));
        ...
        {
            await sleep(207);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\06_sentinelwall\\cinematic\\x07_0220_grv", 3839492964U), default(IGameObject), 1F);
        ...
        {
            await sleep(426);
            sound_impulse_start(GetTag<SoundTag>("sound\\dialog\\levels\\06_sentinelwall\\cinematic\\x07_0230_grv", 3839558501U), default(IGameObject), 1F);
        ...
        public async Task c05_outro_bubbles()
        {
            ...
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles01");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles04");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles06");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles08");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles09");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles11");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles12");
            effect_new_on_object_marker(GetTag<EffectTag>("effects\\cinematics\\05\\bubbles_debris", 3839624038U), rubble.Entity, "bubbles14");
        }
        ...
        public async Task c05_outro_scene_05()
        {
            ...
            camera_set_animation_relative(GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_outro\\05_outro", 3839099742U), "05_outro_05", default(IUnit), anchor_flag_outro);
            custom_animation_relative(chief.Entity, GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_outro\\05_outro", 3839165279U), "chief_05", false, anchor_outro.Entity);
            scenery_animation_start_relative(rubble.Entity, GetTag<AnimationGraphTag>("objects\\cinematics\\effects\\05_outro_rubble\\05_outro_rubble", 3840017260U), "05_outro_05", anchor_outro.Entity);
            scenery_animation_start_relative(tentacle_capture_01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\05_outro\\05_outro", 3840082797U), "tentacle1_05", anchor_outro.Entity);
            scenery_animation_start_relative(tentacle_capture_02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\gravemind\\tentacle_capture\\05_outro\\05_outro", 3840082797U), "tentacle2_05", anchor_outro.Entity);
            fade_in(0F, 0F, 0F, 60);
        ...
        public async Task music_05b_01_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_01", 4277869768U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_01_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_01", 4277869768U));
        }
        ...
        public async Task music_05b_02_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_02", 4278131916U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_02_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_02", 4278131916U));
        }
        ...
        public async Task music_05b_03_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_03", 4278328527U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_03_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_03", 4278328527U));
        }
        ...
        public async Task music_05b_04_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_04", 4278590675U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_04_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_04", 4278590675U));
        }
        ...
        public async Task music_05b_05_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_05", 4278787286U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_06_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_06", 4278918360U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_06_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_06", 4278918360U));
        }
        ...
        public async Task music_05b_07_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_07", 4279114971U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_08_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_08", 4279311582U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_09_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_09_start_alt()
        {
            ...
            sound_looping_set_alternate(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U), true);
        }
        ...
        public async Task music_05b_09_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_09", 4279442656U));
        }
        ...
        public async Task music_05b_10_start()
        {
            ...
            sound_looping_start(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_10", 4279704804U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05b_10_stop()
        {
            ...
            sound_looping_stop(GetTag<LoopingSoundTag>("scenarios\\solo\\05b_deltatowers\\05b_music\\05b_10", 4279704804U));
        }
        ...
        public async Task tower1_holo_looper()
        {
            await sleep_until(async () =>
            {
                begin_random(async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        custom_animation(regret01.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task assassin_ice_cream()
        {
            ...
            custom_animation_loop(unit(list_get(ai_actors(assassin_elites.Squad), 0)), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3949726198U), "combat:sword:berserk", true);
            custom_animation_loop(unit(list_get(ai_actors(assassin_elites.Squad), 1)), GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 3949726198U), "combat:sword:berserk", true);
            await sleep_until(async () => unit_has_weapon(unit(await this.player0()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4125365358U)) || unit_has_weapon(unit(await this.player1()), GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4125365358U)));
        ...
        public async Task go1to2()
        {
            ...
            if (volume_test_object(vol_elev_shaft_under, await this.player0()) == false && await this.player_count() > 0)
            {
                ...
                effect_new_on_object_marker(GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4266925089U), await this.player0(), "");
            }
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\ambience\\device_machines\\delta_sub\\sub_water_in_out\\sub_impact_water", 4280032489U), default(IGameObject), 1F);
            ...
            sound_impulse_start(GetTag<SoundTag>("sound\\ambience\\device_machines\\delta_sub\\sub_water_in_out\\sub_out_of_water", 4280098026U), default(IGameObject), 1F);
        ...
        public async Task elev_under_monitor()
        {
            ...
            {
                object_teleport(await this.player1(), _1to2_teleport);
                effect_new_on_object_marker(GetTag<EffectTag>("effects\\gameplay\\coop_teleport", 4266925089U), await this.player1(), "");
            }
        ...
        public async Task sunken_holo_looper()
        {
            ...
            await sleep_until(async () =>
            {
                begin_random(async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.sunken_holo_chant = true;
                        custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task sunken_holo_translate()
        {
            ...
            custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_l05_0140_por", true);
            ...
            custom_animation(regret02.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_l05_0150_por", true);
        ...
        public async Task island_holo_looper()
        {
            ...
            await sleep_until(async () =>
            {
                begin_random(async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.island_holo_chant = true;
                        custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_chant6a", true);
        ...
        public async Task island_int_translate()
        {
            ...
            custom_animation(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "regret_l05_0160_por", true);
        ...
        public async Task regret_taunt_01()
        {
            ...
            custom_animation(unit(ai_get_object(regret1.Squad)), GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:point", true);
        ...
        public async Task regret_taunt_02()
        {
            ...
            custom_animation(unit(ai_get_object(regret1.Squad)), GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:cheer", true);
        ...
        public async Task regret_taunt_05()
        {
            ...
            custom_animation(unit(ai_get_object(regret1.Squad)), GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:taunt", true);
            ...
            await sleep_until(async () =>
            {
                ...
                if (unit_in_vehicle(await this.player0()) == true || unit_in_vehicle(await this.player1()) == true)
                {
                    ...
                    else
                    {
                        ...
                        unit_set_enterable_by_player(unit(this.regret_throne), false);
                        custom_animation_loop(fake_corpse.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "throne_d:dead", true);
                        ai_play_line_on_object(fake_corpse.Entity, "1380") // Couldn't generate cast from 'Short' to 'Void'
                        ;
                        await sleep(60);
                        effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\prophet\\regret_death", 4280294637U), fake_corpse.Entity, "body");
                        effect_new_on_object_marker(GetTag<EffectTag>("effects\\objects\\characters\\prophet\\regret_death", 4280294637U), this.regret_throne, "");
                        unit_exit_vehicle(await this.player0(), 1);
                        unit_exit_vehicle(await this.player1(), 1);
                        ...
                        await sleep(150);
                        sound_impulse_start(GetTag<SoundTag>("sound\\vehicles\\damage_effects\\cov_damage_large", 3901163281U), this.regret_throne, 1F);
                    }
                }
                else if (objects_distance_to_object(players(), list_get(ai_actors(regret1.Squad), 0)) < 5F)
                {
        ...
        public async Task regret_test()
        {
            ...
            print("animate him");
            custom_animation_loop(regret03.Entity, GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3885762086U), "combat:any:any:cheer", true);
        }
        ...
        {
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 17);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 19);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_short\\bowl_short", 3841917833U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\prophet\\prophet", 3842573203U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3848733681U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\gravity_throne\\gravity_throne", 3848733681U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium\\stone_block_medium", 3850241032U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            await sleep(1);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_01"), 10, false);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_floodlight\\cov_floodlight", 3851027476U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3851551772U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3851879457U), 0);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 8);
            await sleep(98);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 7);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\cortana\\cortana", 3852076068U), 8);
        ...
        {
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3853255734U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3853255734U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3855090770U), 0);
            await sleep(4);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\delta_horizon", 3859022990U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\index_holo_human\\index_holo_human", 3859350675U), 0);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            await sleep(2);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\forerunner\\mount_doom_holo\\mount_doom_holo", 3860006045U), 0);
            await sleep(3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            await sleep(7);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\water_elevator\\water_elevator", 3861382322U), 0);
            await sleep(16);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_01"), 13, false);
            await sleep(128);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3862168766U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3863545043U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican_rear_gun\\pelican_rear_gun", 3863545043U), 1);
            await sleep(215);
            predict_model_section(GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3862168766U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 61);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 54);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 72);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 56);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 57);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 59);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 74);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 69);
            await sleep(135);
        ...
        public async Task _05_intra2_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\cov_floodlight\\cov_floodlight", 3851027476U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\fp_beam_rifle\\fp_beam_rifle", 3807117686U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 19);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 20);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 29);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 22);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 23);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 24);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 53);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 62);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 56);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 6);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 57);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 58);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 59);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 15);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 21);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 23);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 25);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 30);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 27);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 32);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 9);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 18);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 11);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 14);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine_female\\marine_female", 3868591392U), 16);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3874882944U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\projectiles\\needler_shard\\needler_shard", 3876586906U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 8);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 13);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\elite\\elite", 3871540557U), 10);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola_launch\\gondola_launch", 3876717980U), 2);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\gondola\\gondola\\gondola", 3877373350U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3878290868U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3879404997U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3807773056U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3879404997U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3807773056U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3858498694U), 2);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 1);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_medium_tall\\stone_block_medium_tall", 3849323514U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\fp\\fp", 3868132633U), 1);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3864265950U), 60);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\shotgun\\shotgun", 3869574447U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\plasma_pistol\\plasma_pistol", 3817275921U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 12);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 13);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 15);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\bugger\\bugger", 3870688576U), 3);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\ambient_life\\bird_quadwing\\bird_quadwing", 3879732682U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\stone_block_large\\stone_block_large", 3880060367U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\covenant_carbine\\covenant_carbine", 3878290868U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_short\\bowl_short", 3841917833U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\door_tower\\door_tower", 3850372106U), 0);
            ...
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3840148334U), 3);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            await sleep(150);
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\human\\military\\resupply_capsule\\resupply_capsule_crate\\resupply_capsule_crate", 3880125904U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3786735679U), 2);
        ...
        public async Task _05_outro_01_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3881305570U), 2);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\weapons\\pistol\\needler\\needler", 3875800462U), 1);
            await sleep(185);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05b_deltatowers\\bsp_03"), 28, false);
            ...
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 1);
            await sleep(1);
            predict_model_section(GetTag<RenderModelTag>("objects\\gear\\covenant\\military\\crate_space\\crate_space", 3877963183U), 2);
            await sleep(34);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3881174496U), 0);
            await sleep(20);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05b_deltatowers\\bsp_03"), 41, false);
        ...
        public async Task _05_outro_04_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\solo\\deltatemple\\temple_dynamic\\bowl_tall\\bowl_tall", 3850306569U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\controls\\temp_door_switch\\temp_door_switch", 3860137119U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\effects\\carrier_plasma_beam_closeup\\carrier_plasma_beam_closeup", 3882288625U), 0);
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3881174496U), 0);
        }
        ...
        public async Task _05_outro_05_predict()
        {
            ...
            predict_model_section(GetTag<RenderModelTag>("scenarios\\objects\\special\\null_up\\null_up", 3881174496U), 0);
            await sleep(4);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3882550773U), 0);
            predict_model_section(GetTag<RenderModelTag>("objects\\characters\\gravemind\\tentacle_capture\\tentacle_capture", 3882550773U), 1);
            predict_model_section(GetTag<RenderModelTag>("objects\\cinematics\\effects\\05_outro_rubble\\05_outro_rubble", 3883402754U), 0);
            await sleep(123);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05b_deltatowers\\bsp_03"), 41, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05b_deltatowers\\bsp_03"), 40, false);
            predict_structure_section(GetReference<IBsp>("scenarios\\solo\\05b_deltatowers\\bsp_03"), 2, true);
