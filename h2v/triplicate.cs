...
#region Fields
        ...
        {
            object_destroy(eastbound_train.Entity);
            object_destroy(eastbound_death.Entity);
            object_destroy(westbound_train.Entity);
            object_destroy(westbound_death.Entity);
            await sleep((short)random_range(60, 360));
            if (0 == (short)random_range(0, 2))
            {
