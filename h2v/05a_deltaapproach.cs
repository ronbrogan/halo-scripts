...
#region Fields
        ...
        public scnr_05a_deltaapproach(IScriptEngine scriptEngine)
        {
            ...
            this.straggler_no = 0;
            this.phantom_boom = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\deltatemple\\phantom_explosion", 2155945547U);
        ...
        public async Task x05_score_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_01_mus", 3830842080U), default(IGameObject), 1F);
        ...
        public async Task x05_foley_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_01_fol", 3830907617U), default(IGameObject), 1F);
        ...
        public async Task x05_01_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(x05_score_01));
            Engine.wake(new ScriptMethodReference(x05_foley_01));
            Engine.wake(new ScriptMethodReference(x05_slipspace_open));
            Engine.wake(new ScriptMethodReference(x05_cinematic_lighting_scene_01));
        }
        ...
        public async Task x05_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_01_mus", 3830842080U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_01_fol", 3830907617U));
            await Engine.sleep(this.prediction_offset);
            await this.x05_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_01", default(IUnit), anchor_flag_x05);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x05\\x05", 3831038691U), "iac_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(carrier.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\capital_ship\\x05\\x05", 3831104228U), "capital_ship_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(x05_debris.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\effects\\x05_building_debris\\x05\\x05", 3831169765U), "debris_01", anchor_x05.Entity);
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_02_fol", 3831235302U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_02_fol", 3831235302U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0010_mir", 3831300839U), miranda.Entity, 1F);
        ...
        public async Task x05_0020_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0020_mir", 3831366376U), miranda.Entity, 1F);
        ...
        public async Task x05_0030_no1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0030_no1", 3831431913U), nav_officer.Entity, 1F);
        ...
        public async Task x05_0040_wo1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0040_wo1", 3831497450U), weap_officer.Entity, 1F);
        ...
        public async Task x05_0050_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0050_mir", 3831562987U), miranda.Entity, 1F);
        ...
        public async Task x05_0060_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0060_mir", 3831628524U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task x05_0070_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0070_mir", 3831694061U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task x05_0080_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0080_jon", 3831759598U), johnson.Entity, 1F);
        ...
        public async Task x05_0090_cor()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0090_cor", 3831825135U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0100_no1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0100_no1", 3831890672U), nav_officer.Entity, 1F);
        ...
        public async Task x05_0110_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0110_mir", 3831956209U), miranda.Entity, 1F);
        ...
        public async Task x05_02_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(x05_0010_mir));
            Engine.wake(new ScriptMethodReference(x05_0020_mir));
            Engine.wake(new ScriptMethodReference(x05_0030_no1));
            Engine.wake(new ScriptMethodReference(x05_0040_wo1));
            Engine.wake(new ScriptMethodReference(x05_0050_mir));
            Engine.wake(new ScriptMethodReference(x05_0060_mir));
            Engine.wake(new ScriptMethodReference(x05_0070_mir));
            Engine.wake(new ScriptMethodReference(x05_0080_jon));
            Engine.wake(new ScriptMethodReference(x05_0090_cor));
            Engine.wake(new ScriptMethodReference(x05_0100_no1));
            Engine.wake(new ScriptMethodReference(x05_0110_mir));
            Engine.wake(new ScriptMethodReference(x05_foley_02));
            Engine.wake(new ScriptMethodReference(x05_fov_02));
            Engine.wake(new ScriptMethodReference(x05_05_dof_scene_02));
            Engine.wake(new ScriptMethodReference(x05_light_scene_02_bridge_1));
            Engine.wake(new ScriptMethodReference(x05_light_scene_02_hev_1));
            Engine.wake(new ScriptMethodReference(x05_light_scene_02_bridge_2));
        }
        ...
        public async Task x05_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_02", default(IUnit), anchor_flag_x05);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x05\\x05", 3832021746U), "miranda_02", false, anchor_x05.Entity);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x05\\x05", 3834446615U), "chief_02", false, anchor_x05.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "johnson_02", false, anchor_x05.Entity);
            Engine.custom_animation_relative(nav_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "nav_02", false, anchor_x05.Entity);
            Engine.custom_animation_relative(weap_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "weap_02", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(cigar.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_bent\\x05\\x05", 3834643226U), "cigar_bent_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev01_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev02_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev03_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev04_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(iac_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x05\\x05", 3834774300U), "bridge_02", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_bay.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_hevbay\\x05\\x05", 3834839837U), "hevbay_02", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_03_mus", 3834905374U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_03_fol", 3834970911U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        public async Task x05_score_03()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_03_mus", 3834905374U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_03_fol", 3834970911U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(60);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0120_cor", 3835036448U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_03_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(x05_score_03));
            Engine.wake(new ScriptMethodReference(x05_foley_03));
            Engine.wake(new ScriptMethodReference(x05_0120_cor));
        }
        ...
        public async Task x05_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_03", default(IUnit), anchor_flag_x05);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x05\\x05", 3831038691U), "iac_03", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(x05_debris.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\effects\\x05_building_debris\\x05\\x05", 3831169765U), "debris_03", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(delta_halo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x05\\x05", 3835101985U), "halo_03", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_substance.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\x05\\x05", 3835167522U), "substance_space_03", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_04_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_04_fol", 3835233059U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_04_fol", 3835233059U), default(IGameObject), 1F);
        ...
        public async Task x05_0130_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0130_jon", 3835298596U), johnson.Entity, 1F);
        ...
        public async Task x05_0140_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0140_mir", 3835364133U), miranda.Entity, 1F);
        ...
        public async Task x05_0150_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0150_mir", 3835429670U), miranda.Entity, 1F);
        ...
        public async Task x05_0160_cor()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0160_cor", 3835495207U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0170_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0170_mir", 3835560744U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0180_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0180_mir", 3835626281U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0181_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0181_mir", 3835691818U), miranda.Entity, 1F);
        ...
        public async Task x05_0190_cor()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0190_cor", 3835757355U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0200_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0200_mir", 3835822892U), miranda.Entity, 1F);
        ...
        public async Task x05_0210_wo1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0210_wo1", 3835888429U), weap_officer.Entity, 1F);
        ...
        public async Task x05_0220_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0220_mir", 3835953966U), miranda.Entity, 1F);
        ...
        public async Task x05_texture_camera_scene_04()
        {
            ...
            Engine.scenery_animation_start_relative(texture_camera.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\texture_camera\\x05\\x05", 3836019503U), "texture_camera_04", anchor_x05.Entity);
        }
        ...
        {
            Engine.wake(new ScriptMethodReference(x05_0130_jon));
            Engine.wake(new ScriptMethodReference(x05_0140_mir));
            Engine.wake(new ScriptMethodReference(x05_0150_mir));
            Engine.wake(new ScriptMethodReference(x05_0160_cor));
            Engine.wake(new ScriptMethodReference(x05_0170_mir));
            Engine.wake(new ScriptMethodReference(x05_0180_mir));
            Engine.wake(new ScriptMethodReference(x05_0181_mir));
            Engine.wake(new ScriptMethodReference(x05_0190_cor));
            Engine.wake(new ScriptMethodReference(x05_0200_mir));
            Engine.wake(new ScriptMethodReference(x05_0210_wo1));
            Engine.wake(new ScriptMethodReference(x05_0220_mir));
            Engine.wake(new ScriptMethodReference(x05_texture_camera_scene_04));
            Engine.wake(new ScriptMethodReference(x05_fov_04));
            Engine.wake(new ScriptMethodReference(x05_05_dof_scene_04));
            Engine.wake(new ScriptMethodReference(x05_cinematic_lighting_scene_04));
            Engine.wake(new ScriptMethodReference(x05_light_scene_04_bridge_1));
            Engine.wake(new ScriptMethodReference(x05_light_scene_04_hev_1));
            Engine.wake(new ScriptMethodReference(x05_light_scene_04_bridge_2));
            Engine.wake(new ScriptMethodReference(x05_foley_04));
        }
        ...
        public async Task x05_scene_04()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_04", default(IUnit), anchor_flag_x05);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x05\\x05", 3832021746U), "miranda_04", false, anchor_x05.Entity);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x05\\x05", 3834446615U), "chief_04", false, anchor_x05.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "johnson_04", false, anchor_x05.Entity);
            Engine.custom_animation_relative(nav_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "nav_04", false, anchor_x05.Entity);
            Engine.custom_animation_relative(weap_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "weap_04", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(cigar.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\cigar\\cigar_bent\\x05\\x05", 3834643226U), "cigar_bent_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev01_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev02_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(iac_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x05\\x05", 3834774300U), "bridge_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_bay.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_hevbay\\x05\\x05", 3834839837U), "hevbay_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(delta_halo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x05\\x05", 3835101985U), "halo_04", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_substance.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\x05\\x05", 3835167522U), "substance_space_04", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_05_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_05_fol", 3836085040U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_05_fol", 3836085040U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0230_mir", 3836150577U), default(IGameObject), 1F);
        ...
        {
            Engine.wake(new ScriptMethodReference(x05_0230_mir));
            Engine.wake(new ScriptMethodReference(x05_foley_05));
            Engine.wake(new ScriptMethodReference(x05_cinematic_lighting_scene_05));
        }
        ...
        public async Task x05_scene_05()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_05", default(IUnit), anchor_flag_x05);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x05\\x05", 3831038691U), "iac_05", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(delta_halo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x05\\x05", 3835101985U), "halo_05", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_substance.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\x05\\x05", 3835167522U), "substance_space_05", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_06a_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_06a_mus", 3836216114U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_06a_fol", 3836281651U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(113);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\music\\x05_06a_mus", 3836216114U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_06a_fol", 3836281651U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0240_mir", 3836347188U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task x05_06a_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(x05_score_06a));
            Engine.wake(new ScriptMethodReference(x05_foley_06a));
            Engine.wake(new ScriptMethodReference(x05_0240_mir));
            Engine.wake(new ScriptMethodReference(x05_cinematic_light_scene_06a));
        }
        ...
        public async Task x05_scene_06a()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_06a", default(IUnit), anchor_flag_x05);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x05\\x05", 3834446615U), "chief_06a", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev01_06a", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_bay.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_hevbay\\x05\\x05", 3834839837U), "hevbay_06a", anchor_x05.Entity);
            Engine.cinematic_screen_effect_start(true);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_06b_predict_stub();
            await this.x05_06b_problem_actors();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_06b_fol", 3836412725U));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_06b_fol", 3836412725U), default(IGameObject), 1F);
        ...
        public async Task x05_0250_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0250_mir", 3836478262U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0260_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0260_jon", 3836543799U), johnson.Entity, 1F);
        ...
        public async Task x05_0270_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0270_mir", 3836609336U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task x05_0280_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0280_mir", 3836674873U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task x05_0290_mas()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0290_mas", 3836740410U), chief.Entity, 1F);
        ...
        public async Task x05_0300_wo1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0300_wo1", 3836805947U), weap_officer.Entity, 1F);
        ...
        {
            Engine.wake(new ScriptMethodReference(x05_0250_mir));
            Engine.wake(new ScriptMethodReference(x05_0260_jon));
            Engine.wake(new ScriptMethodReference(x05_0270_mir));
            Engine.wake(new ScriptMethodReference(x05_0280_mir));
            Engine.wake(new ScriptMethodReference(x05_0290_mas));
            Engine.wake(new ScriptMethodReference(x05_0300_wo1));
            Engine.wake(new ScriptMethodReference(x05_foley_06b));
            Engine.wake(new ScriptMethodReference(x05_fov_06b));
            Engine.wake(new ScriptMethodReference(x05_light_scene_06b_bridge_1));
        }
        ...
        public async Task x05_scene_06b()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_06b", default(IUnit), anchor_flag_x05);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\x05\\x05", 3832021746U), "miranda_06b", false, anchor_x05.Entity);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x05\\x05", 3834446615U), "chief_06b", false, anchor_x05.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "johnson_06b", false, anchor_x05.Entity);
            Engine.custom_animation_relative(nav_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "nav_06b", false, anchor_x05.Entity);
            Engine.custom_animation_relative(weap_officer.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\x05\\x05", 3834512152U), "weap_06b", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev01_06b", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev02_06b", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev03_06b", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev04_06b", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(iac_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\x05\\x05", 3834774300U), "bridge_06b", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_bay.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_hevbay\\x05\\x05", 3834839837U), "hevbay_06b", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
        ...
        {
            Engine.wake(new ScriptMethodReference(x05_cinematic_lighting_scene_07));
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_07", default(IUnit), anchor_flag_x05);
            Engine.camera_set_field_of_view(60F, 0);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x05\\x05", 3831038691U), "iac_07", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_substance.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\substance_space\\x05\\x05", 3835167522U), "substance_space_07", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_delta_halo_close.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_halo_close\\x05\\x05", 3836871484U), "delta_halo_close_07", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this.x05_08_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_08_fol", 3836937021U));
            await Engine.sleep((short)Engine.camera_time());
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\x05\\foley\\x05_08_fol", 3836937021U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(9);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\x05_0310_cor", 3837002558U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(40);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_explosive_bolt", 3837068095U), hev_bay.Entity, "explosive_bolt06");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_launch_steam", 3837133632U), hev_bay.Entity, "steam_vent06");
            Engine.print("effects - first hev");
            await Engine.sleep(56);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_explosive_bolt", 3837068095U), hev_bay.Entity, "explosive_bolt05");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_launch_steam", 3837133632U), hev_bay.Entity, "steam_vent05");
            Engine.print("effects - second hev");
            await Engine.sleep(37);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_explosive_bolt", 3837068095U), hev_bay.Entity, "explosive_bolt04");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_launch_steam", 3837133632U), hev_bay.Entity, "steam_vent04");
            Engine.print("effects - second hev");
            await Engine.sleep(29);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_explosive_bolt", 3837068095U), hev_bay.Entity, "explosive_bolt03");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_launch_steam", 3837133632U), hev_bay.Entity, "steam_vent03");
            Engine.print("effects - second hev");
        }
        ...
        {
            await Engine.sleep(320);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_start", 3837264706U), hev_10.Entity, "");
        ...
        {
            Engine.wake(new ScriptMethodReference(x05_0310_cor));
            Engine.wake(new ScriptMethodReference(x05_foley_08));
            Engine.wake(new ScriptMethodReference(destroy_chief));
            Engine.wake(new ScriptMethodReference(effect_hev_release));
            Engine.wake(new ScriptMethodReference(effect_corona));
            Engine.wake(new ScriptMethodReference(x05_effect_shake_01));
            Engine.wake(new ScriptMethodReference(x05_cinematic_lighting_scene_08));
            Engine.wake(new ScriptMethodReference(x05_light_scene_08_space));
        }
        ...
        public async Task x05_scene_08()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\x05\\x05", 3830973154U), "x05_08", default(IUnit), anchor_flag_x05);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\x05\\x05", 3831038691U), "iac_08", anchor_x05.Entity);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\x05\\x05", 3834446615U), "chief_08", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev01_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev02_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev03_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev04_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_05.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev05_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_06.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev06_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(delta_halo.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\forerunner\\industrial\\halo\\x05\\x05", 3835101985U), "halo_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_bay.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_hevbay\\x05\\x05", 3834839837U), "hevbay_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_delta_halo_close.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_halo_close\\x05\\x05", 3836871484U), "delta_halo_close_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_07.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev07_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_08.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev08_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_09.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev09_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_10.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev10_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_11.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev11_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_12.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev12_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_13.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev13_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_14.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev14_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_15.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev15_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_16.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev16_08", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_17.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\x05\\x05", 3834708763U), "hev17_08", anchor_x05.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 5));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_01_fol", 3837330243U), default(IGameObject), 1F);
        ...
        public async Task c05_1010_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_1010_cor", 3837395780U), default(IGameObject), 1F);
        ...
        {
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_02.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_02.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_03.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_03.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_04.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_04.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_05.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_05.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_06.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_06.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_burn", 3837461317U), corona_07.Entity, "");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_reentry_contrail", 3837526854U), corona_07.Entity, "");
        ...
        public async Task effect_chute_pins()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_explosive_bolt", 3837068095U), hev_02.Entity, "cable_release");
        }
        ...
        public async Task effect_retros_01()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_02.Entity, "retro_rocket");
        }
        ...
        public async Task c05_intro_01_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c05_1010_cor));
            Engine.wake(new ScriptMethodReference(c05_intro_foley_01));
            Engine.wake(new ScriptMethodReference(destroy_corona_02));
            Engine.wake(new ScriptMethodReference(effect_burn_contrails));
            Engine.wake(new ScriptMethodReference(hev_unhide));
            Engine.wake(new ScriptMethodReference(effect_chute_pins));
            Engine.wake(new ScriptMethodReference(effect_retros_01));
            Engine.wake(new ScriptMethodReference(c05_intro_dof_01));
            Engine.wake(new ScriptMethodReference(c05_intro_cinematic_light_01));
        }
        ...
        public async Task c05_intro_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_01_fol", 3837330243U));
            await Engine.sleep(this.prediction_offset);
            await this.c05_intro_01_setup();
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intro\\05_intro", 3837920076U), "05_intro_01", default(IUnit), anchor_flag_x05);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intro\\05_intro", 3837985613U), "chief_01", false, anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev01_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev02_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev03_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev04_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_05.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev05_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_06.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev06_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_07.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev07_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(hev_chute.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\hev_chute\\05_intro\\05_intro", 3838116687U), "hev_chute_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry02_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry03_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry04_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_05.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry05_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_06.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry06_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(corona_07.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev_reentry\\05_intro\\05_intro", 3838182224U), "hev_reentry07_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_horizon.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\05_intro\\05_intro", 3838247761U), "delta_horizon_01", anchor_x05.Entity);
            Engine.scenery_animation_start_relative(matte_islands.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\matte_paintings\\delta_islands\\05_intro\\05_intro", 3838313298U), "delta_islands_01", anchor_x05.Entity);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_02_fol", 3838378835U));
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_02_fol", 3838378835U), default(IGameObject), 1F);
        ...
        public async Task effect_retros_02()
        {
            await Engine.sleep(1);
            Engine.print("effect - retro-rockets");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_01.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_02.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_03.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_04.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_05.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_06.Entity, "retro_rocket");
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_retro_rocket", 3837723465U), hev_close_07.Entity, "retro_rocket");
        }
        ...
        public async Task c05_intro_02_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c05_intro_foley_02));
            Engine.wake(new ScriptMethodReference(effect_retros_02));
            Engine.wake(new ScriptMethodReference(effect_retros_03));
            Engine.wake(new ScriptMethodReference(c05_intro_dof_02));
            Engine.wake(new ScriptMethodReference(c05_intro_cinematic_light_02));
            Engine.wake(new ScriptMethodReference(little_alien));
            Engine.wake(new ScriptMethodReference(jackal_shield_activate));
        }
        ...
        public async Task c05_intro_scene_02()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intro\\05_intro", 3837920076U), "05_intro_02", default(IUnit), anchor_flag_intro);
            Engine.custom_animation_relative(grunt_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\grunt\\05_intro\\05_intro", 3838444372U), "grunt_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(jackal_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\jackal\\05_intro\\05_intro", 3838509909U), "jackal_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(intro_turret.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\c_turret_ap\\05_intro\\05_intro", 3838575446U), "turret_02", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev01_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev02_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev03_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev04_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_05.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev05_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_06.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev06_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_07.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev07_02", anchor_intro.Entity);
            await Engine.sleep(5);
            Engine.fade_in(1F, 1F, 1F, 15);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._05_intro_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_03_fol", 3838640983U));
            await Engine.sleep((short)Engine.camera_time());
            Engine.cinematic_screen_effect_stop();
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\05_deltahalo\\c05_intro\\foley\\c05_intro_03_fol", 3838640983U), default(IGameObject), 1F);
        ...
        public async Task c05_1020_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_1020_cor", 3838706520U), default(IGameObject), 1F);
        ...
        public async Task c05_1030_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\05_deltatemple\\cinematics\\c05_1030_cor", 3838772057U), default(IGameObject), 1F);
        ...
        public async Task effect_dust()
        {
            ...
            Engine.effect_new(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_land", 3838837594U), c05_intro_pod_01);
            Engine.print("first pod");
            await Engine.sleep(42);
            Engine.effect_new(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_land", 3838837594U), c05_intro_pod_03);
            Engine.print("second pod");
            await Engine.sleep(29);
            Engine.effect_new(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_land", 3838837594U), c05_intro_pod_02);
        ...
        public async Task effect_hev_door_release()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\cinematics\\05\\hev_door_release", 3838968668U), hev_close_06.Entity, "door_release");
        ...
        {
            await Engine.sleep(280);
            Engine.scenery_animation_start_relative(hev_close_06.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev06_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_07.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev07_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_08.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev08_03", anchor_intro.Entity);
        }
        ...
        public async Task c05_intro_03_setup()
        {
            ...
            Engine.wake(new ScriptMethodReference(c05_1020_cor));
            Engine.wake(new ScriptMethodReference(c05_1030_cor));
            Engine.wake(new ScriptMethodReference(c05_intro_foley_03));
            Engine.wake(new ScriptMethodReference(late_pods));
            Engine.wake(new ScriptMethodReference(effect_dust));
            Engine.wake(new ScriptMethodReference(effect_hev_door_release));
            Engine.wake(new ScriptMethodReference(intro_turret_fire));
            Engine.wake(new ScriptMethodReference(intro_turret_fire_02));
            Engine.wake(new ScriptMethodReference(_05_intro_fov_03_1));
            Engine.wake(new ScriptMethodReference(_05_intro_fov_03_2));
            Engine.wake(new ScriptMethodReference(c05_intro_cinematic_light_03));
        }
        ...
        public async Task c05_intro_scene_03()
        {
            ...
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\05_intro\\05_intro", 3837920076U), "05_intro_03", default(IUnit), anchor_flag_intro);
            Engine.custom_animation_relative(grunt_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\grunt\\05_intro\\05_intro", 3838444372U), "grunt_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(jackal_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\jackal\\05_intro\\05_intro", 3838509909U), "jackal_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(intro_turret.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\c_turret_ap\\05_intro\\05_intro", 3838575446U), "turret_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(intro_turret_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\c_turret_ap\\05_intro\\05_intro", 3838575446U), "turret02_03", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev01_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev02_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev03_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev04_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(hev_close_05.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\hev\\05_intro\\05_intro", 3838051150U), "hev05_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(smg_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\rifle\\smg\\05_intro\\05_intro", 3839034205U), "smg_03", anchor_intro.Entity);
            await Engine.sleep(400);
            Engine.custom_animation_relative(chief_intro.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\05_intro\\05_intro", 3837985613U), "chief_03", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(rocket_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\support_high\\rocket_launcher\\05_intro\\05_intro", 3839099742U), "rocket_03", anchor_intro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - 15));
            Engine.fade_out(1F, 1F, 1F, 15);
            await Engine.sleep(15);
        ...
        public async Task music_05a_01_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_01", 2154569270U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05a_02_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_02", 2154700344U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05a_02_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_02", 2154700344U));
        }
        ...
        public async Task music_05a_03_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_03", 2154896955U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05a_03_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_03", 2154896955U));
        }
        ...
        public async Task music_05a_04_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_04", 2155093566U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05a_04_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_04", 2155093566U), true);
        }
        ...
        public async Task music_05a_04_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_04", 2155093566U));
        }
        ...
        public async Task music_05a_05_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_05", 2155617862U), default(IGameObject), 1F);
        }
        ...
        public async Task music_05a_05_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_05", 2155617862U));
        }
        ...
        public async Task music_05a_06_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\05a_deltaapproach\\05a_music\\05a_06", 2155814473U), default(IGameObject), 1F);
        }
        ...
        public async Task lz_pelican_arrives()
        {
            ...
            Engine.wake(new ScriptMethodReference(music_05a_02_start));
            Engine.wake(new ScriptMethodReference(lz_pelican_timer));
        ...
        public async Task lz_phantom_arrives_01()
        {
            ...
            Engine.wake(new ScriptMethodReference(lz_phantom_01_drop));
        ...
        public async Task lz_phantom_arrives_02()
        {
            ...
            Engine.wake(new ScriptMethodReference(lz_phantom_02_drop));
        ...
        public async Task lz_start()
        {
            ...
            Engine.game_save();
            await Engine.sleep(30);
            Engine.wake(new ScriptMethodReference(music_05a_01_start));
            ...
            if (await this.difficulty_legendary())
            {
                ...
                await Engine.sleep_until(async () => (bool)Engine.ai_trigger_test("done_fighting", LZ_enemies_all) == true);
                Engine.wake(new ScriptMethodReference(lz_pelican));
                Engine.wake(new ScriptMethodReference(objective_lz_clear));
            }
            else
            {
                await Engine.sleep(60);
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(lz_pelican_wait));
        }
        ...
        public async Task overlook_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(overlook_reminder));
            Engine.game_save();
        ...
        public async Task bridge_holo_comment()
        {
            ...
            Engine.wake(new ScriptMethodReference(bridge_cortana_response));
        }
        ...
        public async Task bunker_holo_looper()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.bunker_holo_chant = true;
                        Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant6a", true);
        ...
        public async Task bridge_holo_translate()
        {
            ...
            Engine.ai_dialogue_enable(false);
            await Engine.sleep(60);
            Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_l05_0090_por", true);
            ...
            await Engine.sleep(30);
            Engine.custom_animation(regret01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_l05_0100_por", true);
        ...
        public async Task bunker_upper_spawn_03()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(music_05a_03_start));
        ...
        public async Task bunker_spawn_checker()
        {
            ...
            Engine.sleep_forever(new ScriptMethodReference(bunker_upper_spawn_01));
            Engine.sleep_forever(new ScriptMethodReference(bunker_lower_spawn_01));
            Engine.sleep_forever(new ScriptMethodReference(bunker_turret_remanning));
        }
        ...
        public async Task bridge_pelican_wait()
        {
            ...
            Engine.wake(new ScriptMethodReference(music_05a_04_start));
        }
        ...
        public async Task gimme_tank()
        {
            ...
            Engine.wake(new ScriptMethodReference(bridge_pelican_timer));
        ...
        public async Task bridges_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(bunker_spawn_checker));
            Engine.wake(new ScriptMethodReference(bridge_ghosts_by_phantom));
            Engine.wake(new ScriptMethodReference(bunker_turret_remanning));
            ...
            Engine.wake(new ScriptMethodReference(music_05a_02_stop));
            Engine.device_set_position(da_bridge.Entity, 1F);
            await Engine.sleep(60);
            Engine.wake(new ScriptMethodReference(bridge_cortana_comment));
            Engine.wake(new ScriptMethodReference(bridge_activate_reminder));
            ...
            Engine.wake(new ScriptMethodReference(music_05a_03_stop));
            Engine.wake(new ScriptMethodReference(bridge_pelican_run));
            Engine.wake(new ScriptMethodReference(lights));
            Engine.ai_set_orders(all_allies, bridge_tank_wait);
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(farside_ghosts_spawn));
            ...
            Engine.ai_dialogue_enable(true);
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(bridge_holo_translate));
            Engine.wake(new ScriptMethodReference(bridge_pelican_wait));
            ...
            Engine.wake(new ScriptMethodReference(bridge_banshee_spawn));
            Engine.wake(new ScriptMethodReference(bridge_spare_ghost_spawn));
        ...
        public async Task winding_path_start()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(waterfall_toggle));
            ...
            Engine.wake(new ScriptMethodReference(w_path_turret_deploy));
            await Engine.sleep_until(async () =>
            {
        ...
        public async Task old_temple_entrance_start()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(_05a_title1));
            Engine.wake(new ScriptMethodReference(music_05a_04_start_alt));
            Engine.wake(new ScriptMethodReference(temple_ent_turret_spawn));
            ...
            Engine.wake(new ScriptMethodReference(temple_ent_ghost_alert));
            ...
            Engine.wake(new ScriptMethodReference(temple_ent_veh_spawn));
        ...
        public async Task arbiter_envy()
        {
            ...
            Engine.custom_animation_loop(Engine.unit(Engine.list_get(Engine.ai_actors(envy_elites.Squad), 0)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4194441168U), "combat:rifle:berserk", true);
            Engine.custom_animation_loop(Engine.unit(Engine.list_get(Engine.ai_actors(envy_elites.Squad), 1)), Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4194441168U), "combat:rifle:berserk", true);
            await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4162655741U)) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4162655741U)));
        ...
        public async Task old_temple_pelican_arrives()
        {
            ...
            await Engine.sleep(90);
            Engine.wake(new ScriptMethodReference(old_temple_pelican_timer));
            Engine.cs_vehicle_speed(1F);
        ...
        public async Task old_temple_center()
        {
            ...
            Engine.game_save();
            Engine.sleep_forever(new ScriptMethodReference(old_temple_near_right));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_far_left));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_far_right));
            ...
            Engine.wake(new ScriptMethodReference(old_temple_middle_ally));
        ...
        public async Task old_temple_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(music_05a_04_stop));
            Engine.game_save();
            ...
            Engine.wake(new ScriptMethodReference(old_temple_below));
            Engine.wake(new ScriptMethodReference(old_temple_center));
            Engine.wake(new ScriptMethodReference(old_temple_vehicle_spawn));
            Engine.wake(new ScriptMethodReference(old_temple_middle_reminder));
            Engine.wake(new ScriptMethodReference(old_temple_turret_reman));
            if (await this.difficulty_legendary())
            {
                Engine.wake(new ScriptMethodReference(arbiter_envy));
            }
        ...
        public async Task old_temple_holo_translate()
        {
            ...
            Engine.ai_dialogue_enable(false);
            await Engine.sleep(60);
            Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_l05_0110_por", true);
            ...
            await Engine.sleep(30);
            Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_l05_0120_por", true);
        ...
        public async Task courtyard_holo_looper()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.court_holo_chant = true;
                        Engine.custom_animation(regret02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant6a", true);
        ...
        public async Task old_temple_courtyard()
        {
            ...
            Engine.wake(new ScriptMethodReference(courtyard_holo_looper));
            Engine.game_save();
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(old_temple_holo_translate));
            if ((short)Engine.ai_living_count(old_temple_court_all) < 8)
            {
            ...
            Engine.wake(new ScriptMethodReference(old_temple_debris_reminder));
        ...
        public async Task grotto_cortana_comment()
        {
            ...
            await Engine.sleep(30);
            Engine.wake(new ScriptMethodReference(music_05a_05_start));
            Engine.ai_dialogue_enable(true);
        ...
        public async Task grotto_start()
        {
            ...
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(_05a_title2));
            ...
            Engine.wake(new ScriptMethodReference(grotto_extra_checkpoint));
            ...
            Engine.wake(new ScriptMethodReference(grotto_buggers_reinforce));
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_grotto_far_top, Engine.players()) == true);
            Engine.game_save();
            Engine.wake(new ScriptMethodReference(grotto_reminder));
            ...
            Engine.wake(new ScriptMethodReference(music_05a_05_stop));
            Engine.game_save();
        ...
        public async Task temple_approach_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(approach_cortana_comment));
            Engine.wake(new ScriptMethodReference(approach_reminder));
            ...
            Engine.wake(new ScriptMethodReference(music_05a_06_start));
        ...
        public async Task tower1_holo_looper()
        {
            ...
            await Engine.sleep_until(async () =>
            {
                Engine.begin_random(async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant1a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2b", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant2c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant3c", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant5a", true);
                    ...
                    async () =>
                {
                    ...
                    {
                        this.tower1_holo_chant = true;
                        Engine.custom_animation(regret03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\prophet\\prophet", 3886548530U), "regret_chant6a", true);
        ...
        public async Task long_pause_point()
        {
            ...
            Engine.cs_custom_animation(Engine.GetTag<AnimationGraphTag>("objects\\characters\\elite\\elite", 4194441168U), "combat:rifle:warn", 1F, true);
        ...
        public async Task tower1_start()
        {
            ...
            Engine.wake(new ScriptMethodReference(tower1_hg_warn));
        ...
        public async Task ally_order_monitor()
        {
            ...
            Engine.wake(new ScriptMethodReference(bridge_bunker_backup));
        ...
        {
            Engine.sleep_forever(new ScriptMethodReference(lz_start));
            Engine.sleep_forever(new ScriptMethodReference(lz_turret_track));
            Engine.sleep_forever(new ScriptMethodReference(lz_turret_reminder));
            Engine.sleep_forever(new ScriptMethodReference(lz_pelican));
            Engine.sleep_forever(new ScriptMethodReference(lz_pelican_wait));
            Engine.sleep_forever(new ScriptMethodReference(lz_phantom_03_start));
        }

        [ScriptMethod(346, Lifecycle.Static)]
        public async Task sleep_bridge()
        {
            Engine.sleep_forever(new ScriptMethodReference(overlook_start));
            Engine.sleep_forever(new ScriptMethodReference(overlook_reminder));
            Engine.sleep_forever(new ScriptMethodReference(bridges_start));
            Engine.sleep_forever(new ScriptMethodReference(crack_spawn));
            Engine.sleep_forever(new ScriptMethodReference(bunker_upper_spawn_01));
            Engine.sleep_forever(new ScriptMethodReference(bunker_upper_spawn_03));
            Engine.sleep_forever(new ScriptMethodReference(bunker_lower_spawn_01));
            Engine.sleep_forever(new ScriptMethodReference(bunker_turret_remanning));
            Engine.sleep_forever(new ScriptMethodReference(bunker_spawn_checker));
            Engine.sleep_forever(new ScriptMethodReference(bridge_ghosts_by_phantom));
            Engine.sleep_forever(new ScriptMethodReference(farside_ghosts_spawn));
            Engine.sleep_forever(new ScriptMethodReference(bridge_phantom_reinforce_01a));
            Engine.sleep_forever(new ScriptMethodReference(bridge_phantom_reinforce_01b));
            Engine.sleep_forever(new ScriptMethodReference(bridge_phantom_reinforce_02a));
            Engine.sleep_forever(new ScriptMethodReference(bridge_phantom_reinforce_02b));
            Engine.sleep_forever(new ScriptMethodReference(bridge_cortana_comment));
            Engine.sleep_forever(new ScriptMethodReference(bridge_wraith_warning));
            Engine.sleep_forever(new ScriptMethodReference(bridge_activate_reminder));
            Engine.sleep_forever(new ScriptMethodReference(bunker_holo_looper));
            Engine.sleep_forever(new ScriptMethodReference(bridge_holo_translate));
            Engine.sleep_forever(new ScriptMethodReference(bridge_pelican_wait));
            Engine.sleep_forever(new ScriptMethodReference(bridge_cross_reminder));
            Engine.sleep_forever(new ScriptMethodReference(bridge_banshee_spawn));
            Engine.sleep_forever(new ScriptMethodReference(bridge_spare_ghost_spawn));
        }

        [ScriptMethod(347, Lifecycle.Static)]
        public async Task sleep_winding_path()
        {
            Engine.sleep_forever(new ScriptMethodReference(winding_path_start));
        }

        [ScriptMethod(348, Lifecycle.Static)]
        public async Task sleep_temple_ent()
        {
            Engine.sleep_forever(new ScriptMethodReference(old_temple_entrance_start));
            Engine.sleep_forever(new ScriptMethodReference(temple_ent_ghost_alert));
            Engine.sleep_forever(new ScriptMethodReference(temple_ent_veh_spawn));
            Engine.sleep_forever(new ScriptMethodReference(temple_ent_reminder));
            Engine.sleep_forever(new ScriptMethodReference(temple_ent_arch));
        }

        [ScriptMethod(349, Lifecycle.Static)]
        public async Task sleep_tunnel()
        {
            Engine.sleep_forever(new ScriptMethodReference(tunnel_start));
        }

        [ScriptMethod(350, Lifecycle.Static)]
        public async Task sleep_old_temple()
        {
            Engine.sleep_forever(new ScriptMethodReference(old_temple_start));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_near_right));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_far_left));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_far_right));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_below));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_center));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_courtyard));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_vehicle_spawn));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_pelican));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_phantom_01));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_phantom_02));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_turret_reman));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_perimeter_nuke));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_middle_ally));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_playfight));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_debris_comment));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_middle_comment));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_debris_reminder));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_holo_translate));
            Engine.sleep_forever(new ScriptMethodReference(courtyard_holo_looper));
            Engine.sleep_forever(new ScriptMethodReference(old_temple_archaeologist));
        }

        [ScriptMethod(351, Lifecycle.Static)]
        public async Task sleep_grotto()
        {
            Engine.sleep_forever(new ScriptMethodReference(grotto_start));
            Engine.sleep_forever(new ScriptMethodReference(grotto_buggers_reinforce));
            Engine.sleep_forever(new ScriptMethodReference(grotto_cortana_comment));
            Engine.sleep_forever(new ScriptMethodReference(grotto_ally_comments));
            Engine.sleep_forever(new ScriptMethodReference(grotto_reminder));
            Engine.sleep_forever(new ScriptMethodReference(grotto_pool));
            Engine.sleep_forever(new ScriptMethodReference(grotto_extra_checkpoint));
        }

        [ScriptMethod(352, Lifecycle.Static)]
        public async Task sleep_approach()
        {
            Engine.sleep_forever(new ScriptMethodReference(temple_approach_start));
            Engine.sleep_forever(new ScriptMethodReference(approach_reminder));
        }
        ...
        public async Task mission()
        {
            ...
            await Engine.sleep(1);
            Engine.wake(new ScriptMethodReference(_05a_title0));
            Engine.wake(new ScriptMethodReference(objective_lz_set));
            Engine.wake(new ScriptMethodReference(kill_volumes));
            Engine.wake(new ScriptMethodReference(lz_start));
            Engine.wake(new ScriptMethodReference(ally_order_monitor));
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_overlook, Engine.players()) == true);
            Engine.wake(new ScriptMethodReference(overlook_start));
            Engine.wake(new ScriptMethodReference(bridges_start));
            Engine.wake(new ScriptMethodReference(objective_bridge_set));
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_winding_path, Engine.players()) == true);
            Engine.wake(new ScriptMethodReference(winding_path_start));
            Engine.wake(new ScriptMethodReference(old_temple_entrance_start));
            Engine.wake(new ScriptMethodReference(objective_bridge_clear));
            Engine.wake(new ScriptMethodReference(objective_ruins_set));
            await this.sleep_intro();
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_tunnel_01, Engine.players()) == true);
            Engine.wake(new ScriptMethodReference(tunnel_start));
            Engine.wake(new ScriptMethodReference(old_temple_start));
            Engine.wake(new ScriptMethodReference(old_temple_courtyard));
            await this.sleep_bridge();
            await this.sleep_winding_path();
            await Engine.sleep_until(async () => Engine.volume_test_objects(vol_grotto, Engine.players()) == true);
            Engine.wake(new ScriptMethodReference(grotto_start));
            ...
            Engine.wake(new ScriptMethodReference(temple_approach_start));
            Engine.wake(new ScriptMethodReference(tower1_start));
            Engine.wake(new ScriptMethodReference(objective_ruins_clear));
            Engine.wake(new ScriptMethodReference(objective_tower1_set));
        ...
        {
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 4);
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_x05"), 0, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad\\inamberclad", 3839165279U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\generic\\space\\space", 3785490476U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\x05_building_debris\\x05_building_debris", 3840344945U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3846177738U), 2);
            await Engine.sleep(5);
        ...
        public async Task x05_02_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev_door\\hev_door", 3850830865U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3850896402U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_hevbay\\inamberclad_hevbay", 3854107715U), 0);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3855221844U), 0);
            await Engine.sleep(15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_leafy\\tree_leafy_small\\tree_leafy_small", 3850306569U), 0);
            await Engine.sleep(25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3855483992U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3855483992U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3855483992U), 2);
            await Engine.sleep(215);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 74);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 69);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\cigar\\cigar_bent\\cigar_bent", 3862103229U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\x05_building_debris\\x05_building_debris", 3840344945U), 0);
            await Engine.sleep(215);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 1);
        ...
        {
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\substance_space\\substance_space", 3862430914U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\effects\\x05_building_debris\\x05_building_debris", 3840344945U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\forerunner\\industrial\\halo\\halo", 3862824136U), 0);
            await Engine.sleep(27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3855221844U), 0);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev_chute\\hev_chute", 3863348432U), 0);
        }
        ...
        public async Task x05_04_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3847488478U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\texture_camera\\texture_camera", 3863413969U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3850896402U), 0);
            await Engine.sleep(63);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3855483992U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\crewman\\crewman", 3855483992U), 1);
        ...
        public async Task x05_06b_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_halo_close\\delta_halo_close", 3863741654U), 0);
        }
        ...
        {
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_islands\\delta_islands", 3863938265U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\matte_paintings\\delta_horizon\\delta_horizon", 3864134876U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev_reentry\\hev_reentry", 3864331487U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev_chute\\hev_chute", 3863348432U), 0);
            await Engine.sleep(75);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3855221844U), 0);
            await Engine.sleep(4);
        ...
        public async Task _05_intro_02_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\deltatemple\\sky_bsp_00\\sky_bsp_00", 3782934533U), 4);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\c_turret_ap\\c_turret_ap", 3865117931U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\c_turret_ap\\c_turret_ap", 3865117931U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\jackal\\jackal", 3866428671U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 20);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 22);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3870295354U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3860989100U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 14);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\plasma_grenade\\plasma_grenade", 3870295354U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_leafy\\tree_leafy_small\\tree_leafy_small", 3850306569U), 1);
            await Engine.sleep(76);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 1);
            await Engine.sleep(60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\jackal_shield\\jackal_shield", 3870950724U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\melee\\jackal_shield\\jackal_shield", 3870950724U), 1);
        }
        ...
        public async Task _05_intro_03_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\grunt\\grunt", 3868656929U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev_door\\hev_door", 3850830865U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3857319028U), 6);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_00"), 16, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\c_turret_ap\\c_turret_ap", 3865117931U), 10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\c_turret_ap\\c_turret_ap", 3865117931U), 11);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3786604605U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_bush\\tree_bush", 3870819650U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_00"), 59, false);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\grenade\\frag_grenade\\frag_grenade", 3871147335U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3871475020U), 0);
            await Engine.sleep(2);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\tree_ancient\\tree_branch\\tree_branch", 3870885187U), 0);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher", 3807576445U), 2);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_00"), 90, true);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\beam_rifle\\beam_rifle", 3872654686U), 0);
            await Engine.sleep(2);
            ...
            await Engine.sleep(89);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\special\\invisible_box1x2x2\\invisible_box1x2x2", 3873637741U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_00"), 98, true);
            await Engine.sleep(15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\support_high\\rocket_launcher\\rocket_launcher", 3807576445U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\smg\\smg", 3786604605U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\hev\\hev", 3849454588U), 0);
            await Engine.sleep(22);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\05a_deltaapproach\\bsp_00"), 88, true);
            await Engine.sleep(2);
