namespace OpenH2.Scripts.Generatedscenarios.multi
{
    ...
    [OriginScenario("scenarios\\multi\\turf\\turf")]
    public partial class scnr_turf : ScenarioScriptBase
    {
#region Fields
        string data_mine_mission_segment;
        public scnr_turf(IScriptEngine scriptEngine)
        {
        ...
        [ScriptMethod(23, Lifecycle.Startup)]
        public async Task mission_main()
        {
            await this.cinematic_fade_from_black();
        }
    }
}