...
#region Fields
        ...
        public scnr_03a_oldmombasa(IScriptEngine scriptEngine)
        {
            ...
            this.g_e11_pod_impact_effect = Engine.GetTag<EffectTag>("effects\\scenarios\\solo\\earthcity\\e11_insertion_pod_impact", 4267187237U);
 ...
 == "normal";
        ...
        public async Task c03_intro_score_01()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\music\\c03_intro_01_mus", 3833987856U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_01_fol", 3834053393U), default(IGameObject), 1F);
        ...
        public async Task c03_1010_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1010_cor", 3834118930U), default(IGameObject), 1F);
        ...
        public async Task c03_1011_cor()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1011_cor", 3834184467U), default(IGameObject), 1F);
        ...
        public async Task c03_1020_mir()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1020_mir", 3834250004U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c03_1021_mir()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1021_mir", 3834315541U), miranda.Entity, 1F);
        ...
        public async Task c03_1030_jon()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1030_jon", 3834381078U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c03_1040_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1040_jon", 3834446615U), johnson.Entity, 1F);
        ...
        public async Task c03_1050_och_1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1050_och", 3834512152U), pilot.Entity, 1F);
        ...
        {
            await Engine.sleep(684);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1050_och", 3834512152U), copilot.Entity, 1F);
        ...
        public async Task c03_intro_01_setup()
        {
            ...
            Engine.wake(c03_intro_score_01);
            Engine.wake(c03_intro_foley_01);
            Engine.wake(c03_intro_sound_scene1_01);
            Engine.wake(c03_intro_sound_scene1_02);
            Engine.wake(c03_intro_sound_scene1_03);
            Engine.wake(c03_intro_sound_scene1_04);
            Engine.wake(c03_1010_cor);
            Engine.wake(c03_1011_cor);
            Engine.wake(c03_1020_mir);
            Engine.wake(c03_1021_mir);
            Engine.wake(c03_1030_jon);
            Engine.wake(c03_1040_jon);
            Engine.wake(c03_1050_och_1);
            Engine.wake(c03_1050_och_2);
            Engine.wake(c03_intro_shake_01_1);
            Engine.wake(c03_intro_shake_01_2);
            Engine.wake(c03_intro_shake_01_3);
            Engine.wake(cinematic_light_01_city_01);
            Engine.wake(cinematic_light_01_pelican_01);
            Engine.wake(cinematic_light_01_iac_01);
            Engine.wake(cinematic_light_01_city_02);
            Engine.wake(cinematic_light_01_pelican_02);
        }
        ...
        public async Task c03_intro_scene_01()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\music\\c03_intro_01_mus", 3833987856U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_01_fol", 3834053393U));
            await Engine.sleep(this.prediction_offset);
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intro\\03_intro", 3834577689U), "03_intro_01", default(IUnit), anchor_flag_intro);
            await this.c03_intro_01_setup();
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intro\\03_intro", 3834643226U), "mc_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "johnson_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(miranda.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\miranda\\03_intro\\03_intro", 3834839837U), "miranda_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine1_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(copilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine2_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel1_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel2_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel3_01", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel4_01", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(iac.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad\\03_intro\\03_intro", 3837330243U), "iac_01", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(iac_bridge.Entity, Engine.GetTag<AnimationGraphTag>("objects\\cinematics\\human\\inamberclad_bridge\\03_intro\\03_intro", 3837395780U), "iac_bridge_01", anchor_intro.Entity);
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_02_fol", 3837461317U));
        ...
        public async Task intro_hogs()
        {
            ...
            Engine.cs_run_command_script(intro_hog_01.driver, cs_hog_01);
            Engine.cs_run_command_script(intro_hog_02.driver, cs_hog_02);
            Engine.cs_run_command_script(intro_hog_03.driver, cs_hog_03);
            Engine.cs_run_command_script(intro_hog_04.driver, cs_hog_04);
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_02_fol", 3837461317U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1060_cor", 3837526854U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c03_1070_cor()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1070_cor", 3837592391U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c03_1080_mrs()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1080_mrs", 3837657928U), spotter.Entity, 1F, "radio_default_in");
        ...
        public async Task c03_1090_dp1()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1090_dp1", 3837723465U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task c03_intro_02_setup()
        {
            ...
            Engine.wake(c03_intro_sound_scene2_01);
            Engine.wake(c03_intro_sound_scene2_03);
            Engine.wake(c03_intro_sound_scene2_04);
            Engine.wake(c03_intro_sound_scene2_05);
            Engine.unit_set_emotional_state(sniper.Entity, "pensive", 0.5F, 0);
            Engine.unit_set_emotional_state(spotter.Entity, "pain", 0.5F, 0);
            Engine.wake(c03_intro_foley_02);
            Engine.wake(c03_1060_cor);
            Engine.wake(c03_1070_cor);
            Engine.wake(c03_1080_mrs);
            Engine.wake(c03_1090_dp1);
            Engine.wake(intro_hogs);
            Engine.wake(erase_hogs);
            Engine.wake(c03_intro_shake_02);
            Engine.wake(c03_intro_fov_01);
        ...
        {
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intro\\03_intro", 3834577689U), "03_intro_02", default(IUnit), anchor_flag_intro);
            await this.c03_intro_02_setup();
            Engine.pvs_set_object(pelican_01.Entity);
            Engine.custom_animation_relative(sniper.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "sniper_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(spotter.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "spotter_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel1_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel2_02", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel3_02", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(sniper_rifle.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\rifle\\sniper_rifle\\03_intro\\03_intro", 3837789002U), "sniper_rifle_02", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(scope.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\human\\military\\spotting_scope\\03_intro\\03_intro", 3837854539U), "scope_02", anchor_intro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._03_intro_03_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_03_fol", 3837920076U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_03_fol", 3837920076U), default(IGameObject), 1F);
        ...
        public async Task c03_1100_dp1()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1100_dp1", 3837985613U), pilot.Entity, 1F);
        ...
        public async Task c03_1110_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1110_jon", 3838051150U), johnson.Entity, 1F);
        ...
        public async Task c03_1120_jon()
        {
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1120_jon", 3838116687U), johnson.Entity, 1F);
        ...
        public async Task c03_1130_lhd()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1130_lhd", 3838182224U), default(IGameObject), 1F, "radio_default_in");
        ...
        public async Task c03_1140_lhd()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1140_lhd", 3838247761U), default(IGameObject), 1F, "radio_default_out");
        ...
        public async Task c03_1150_dp2()
        {
            ...
            Engine.sound_impulse_start_effect(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1150_dp2", 3838313298U), default(IGameObject), 1F, "radio_default_loop");
        ...
        public async Task c03_intro_03_setup()
        {
            ...
            Engine.wake(c03_intro_foley_03);
            Engine.wake(c03_intro_sound_scene3_01);
            Engine.wake(c03_intro_sound_scene3_02);
            Engine.wake(c03_intro_sound_scene3_03);
            Engine.wake(c03_1100_dp1);
            Engine.wake(c03_1110_jon);
            Engine.wake(c03_1120_jon);
            Engine.wake(c03_1130_lhd);
            Engine.wake(c03_1140_lhd);
            Engine.wake(c03_1150_dp2);
            Engine.wake(save_dof_01);
            Engine.wake(show_trees_pelican);
            Engine.wake(c03_intro_shake_03);
            Engine.wake(cinematic_lighting_scene_03);
            Engine.wake(cinematic_light_troopbay_03_01);
            Engine.wake(cinematic_light_chief_03_01);
            Engine.wake(cinematic_light_street_03_01);
        }
        ...
        {
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intro\\03_intro", 3834577689U), "03_intro_03", default(IUnit), anchor_flag_intro);
            await this.c03_intro_03_setup();
            Engine.pvs_set_object(pelican_01.Entity);
            Engine.custom_animation_relative(chief.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\masterchief\\03_intro\\03_intro", 3834643226U), "mc_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(johnson.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "johnson_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine1_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(copilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine2_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(odst_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "odst1_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(odst_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "odst2_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(odst_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "odst3_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(odst_04.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "odst4_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel1_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel2_03", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel3_03", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(helmet.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\helmet_odst\\03_intro\\03_intro", 3838378835U), "helmet_03", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(sniper_rifle.Entity, Engine.GetTag<AnimationGraphTag>("objects\\weapons\\rifle\\sniper_rifle\\03_intro\\03_intro", 3837789002U), "sniper_rifle_03", anchor_intro.Entity);
            await Engine.sleep((short)((float)Engine.camera_time() - this.prediction_offset));
            await this._03_intro_04_predict_stub();
            await Engine.sleep((short)((float)Engine.camera_time() - this.sound_offset));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_04_fol", 3838444372U));
            await Engine.sleep((short)Engine.camera_time());
        ...
        public async Task intro_scarab_gun_charge()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\scenarios\\objects\\covenant\\military\\scarab\\scarab_beam_charging", 3838509909U), scarab.Entity, "primary_trigger");
        }
        ...
        public async Task effect_pelican_hit_01()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit", 3838903131U), pelican_01.Entity, "johnson");
        }
        ...
        public async Task effect_pelican_impact_01()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit_small", 3840082797U), pelican_03.Entity, "light_cockpit_back");
            await Engine.sleep(5);
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit_small", 3840082797U), pelican_03.Entity, "hardpoint_left");
        }
        ...
        public async Task effect_pelican_impact_02()
        {
            ...
            Engine.effect_new_on_object_marker(Engine.GetTag<EffectTag>("effects\\generic\\explosions_air\\human_vehicle_air_hit", 3838903131U), pelican_03.Entity, "johnson");
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), intro_junction_flag_01);
        }
        ...
        public async Task effect_blow_railings()
        {
            ...
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), intro_railing_flag_01);
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), intro_railing_flag_02);
            await Engine.sleep(5);
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), intro_railing_flag_03);
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), intro_railing_flag_04);
        }
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\cinematics\\03_earthcity\\c03_intro\\foley\\c03_intro_04_fol", 3838444372U), default(IGameObject), 1F);
        ...
        {
            await Engine.sleep(0);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\cinematic\\c03_1160_dp2", 3840213871U), pilot.Entity, 1F);
        ...
        public async Task effect_big_foot()
        {
            ...
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), bus_flag_01);
            Engine.damage_new(Engine.GetTag<DamageEffectTag>("objects\\weapons\\grenade\\frag_grenade\\damage_effects\\frag_grenade_explosion", 3840148334U), bus_flag_02);
        }
        ...
        public async Task c03_intro_04_setup()
        {
            ...
            Engine.wake(c03_intro_foley_04);
            Engine.wake(c03_1160_dp2);
            Engine.wake(c03_intro_fov_02);
            Engine.wake(c03_intro_shake_04);
            Engine.wake(intro_scarab_gun_charge);
            Engine.wake(intro_scarab_gun_fire);
            Engine.wake(intro_scarab_turret_fire);
            Engine.wake(effect_big_foot);
            Engine.wake(effect_pelican_hit_01);
            Engine.wake(effect_pelican_impact_01);
            Engine.wake(effect_pelican_impact_02);
            Engine.wake(effect_blow_railings);
            Engine.wake(cinematic_lighting_scene_04);
            Engine.wake(cinematic_light_street_04_01);
        }
        ...
        {
            Engine.camera_set_animation_relative(Engine.GetTag<AnimationGraphTag>("objects\\characters\\cinematic_camera\\03_intro\\03_intro", 3834577689U), "03_intro_04", default(IUnit), anchor_flag_intro);
            await this.c03_intro_04_setup();
            Engine.pvs_set_object(pelican_01.Entity);
            Engine.custom_animation_relative(pilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine1_04", false, anchor_intro.Entity);
            Engine.custom_animation_relative(copilot.Entity, Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\03_intro\\03_intro", 3834708763U), "marine2_04", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_01.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel1_04", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_02.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel2_04", false, anchor_intro.Entity);
            Engine.custom_animation_relative(pelican_03.Entity, Engine.GetTag<AnimationGraphTag>("objects\\vehicles\\pelican\\03_intro\\03_intro", 3837264706U), "pel3_04", false, anchor_intro.Entity);
            Engine.scenery_animation_start_relative(scarab.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\03_intro\\03_intro", 3840279408U), "scarab_04", anchor_intro.Entity);
            Engine.scenery_animation_start_relative(scarab_turret.Entity, Engine.GetTag<AnimationGraphTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\03_intro\\03_intro", 3840344945U), "scarab_upper_gun_04", anchor_intro.Entity);
        ...
        public async Task chief_recovery_sequence()
        {
            ...
            )
            {
                ...
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\mission\\l03_9000_cor", 3840410482U), default(IGameObject), 1F);
            ...
            )
            {
                ...
                await Engine.sleep(30);
                Engine.fade_in(0F, 0F, 0F, 30);
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\mission\\l03_9030_cor", 3840476019U), default(IGameObject), 1F);
                await Engine.sleep(35);
                Engine.fade_out(0F, 0F, 0F, 30);
                await Engine.sleep(45);
                Engine.fade_in(0F, 0F, 0F, 20);
            ...
            )
            {
                ...
                await Engine.sleep(30);
                Engine.fade_in(0F, 0F, 0F, 30);
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\mission\\l03_9020_cor", 3840541556U), default(IGameObject), 1F);
                await Engine.sleep(35);
                Engine.fade_out(0F, 0F, 0F, 30);
                await Engine.sleep(45);
                Engine.fade_in(0F, 0F, 0F, 20);
            ...
            )
            {
                ...
                await Engine.sleep(30);
                Engine.fade_in(0F, 0F, 0F, 30);
                Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\dialog\\levels\\03_earthcity\\mission\\l03_9010_cor", 3840607093U), default(IGameObject), 1F);
                await Engine.sleep(35);
                Engine.fade_out(0F, 0F, 0F, 30);
                await Engine.sleep(45);
                Engine.fade_in(0F, 0F, 0F, 20);
        ...
        public async Task music_03a_01_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_01", 4264762368U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_01_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_01", 4264762368U));
        }
        ...
        public async Task music_03a_02_stop_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_02", 4264958979U), false);
        }
        ...
        public async Task music_03a_02_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_02", 4264958979U));
            Engine.sleep_forever(music_03a_02_stop_alt);
        }
        ...
        public async Task music_03a_02_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_02", 4264958979U), true);
            Engine.wake(music_03a_02_stop_alt);
        }
        ...
        public async Task music_03a_02_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_02", 4264958979U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_03_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_03", 4265352201U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_03_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_03", 4265352201U));
        }
        ...
        public async Task music_03a_04_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_04", 4265614349U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_04_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_04", 4265614349U));
        }
        ...
        public async Task music_03a_05_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_05", 4265810960U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_05_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_05", 4265810960U));
        }
        ...
        public async Task music_03a_06_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_06", 4266073108U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_06_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_06", 4266073108U));
        }
        ...
        public async Task music_03a_065_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_065", 4266269719U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_065_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_065", 4266269719U));
        }
        ...
        public async Task music_03a_065_start_alt()
        {
            ...
            Engine.sound_looping_set_alternate(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_065", 4266269719U), true);
            Engine.wake(music_03a_065_stop);
        }
        ...
        public async Task music_03a_066_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_066", 4266597404U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_067_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_067", 4266728478U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_067_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_067", 4266728478U));
        }
        ...
        public async Task music_03a_07_start()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_07", 4266925089U), default(IGameObject), 1F);
        }
        ...
        public async Task music_03a_07_stop()
        {
            ...
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("scenarios\\solo\\03a_oldmombasa\\03a_music\\03a_07", 4266925089U));
        }
        ...
        public async Task cs_e13_cov_creep0_end0()
        {
            ...
            await Engine.sleep(150);
            Engine.cs_queue_command_script(this.ai_current_actor, cs_e13_cov_creep0_unload);
        }
        ...
        public async Task cs_e13_cov_creep0_drive1()
        {
            ...
            {
                Engine.cs_queue_command_script(this.ai_current_actor, cs_e13_cov_creep0_end0);
                this.g_e13_creep_end0_free = false;
            }
            else if (this.g_e13_creep_end1_free == true)
            {
                Engine.cs_queue_command_script(this.ai_current_actor, cs_e13_cov_creep0_end1);
                this.g_e13_creep_end1_free = false;
            }
            else if (this.g_e13_creep_end2_free == true)
            {
                Engine.cs_queue_command_script(this.ai_current_actor, cs_e13_cov_creep0_end2);
        ...
        public async Task cs_e13_cov_creep0_0_decision()
        {
            ...
            {
                Engine.cs_queue_command_script(this.ai_current_actor, cs_e13_cov_creep0_drive1);
        ...
        {
            Engine.cs_run_command_script(this.ai_current_squad, cs_e13_mars_continue);
        }
        ...
        public async Task e13_cov_creep0_main()
        {
            ...
            Engine.wake(music_03a_067_stop);
            Engine.wake(music_03a_07_start);
            ...
            Engine.wake(e13_cov_creep0_ghost_aux);
            Engine.cs_queue_command_script(e13_cov_creep0_0.creep0, cs_e13_cov_creep0_0_decision);
            Engine.cs_queue_command_script(e13_cov_creep0_1.creep0, cs_e13_cov_creep0_1_decision);
            Engine.cs_queue_command_script(e13_cov_creep0_2.creep0, cs_e13_cov_creep0_2_decision);
        ...
        public async Task e13_mars_warthog0_main()
        {
            ...
            Engine.cs_run_command_script(e13_mars_warthog0.Squad, cs_e13_mars_warthog0_drive);
        }
        ...
        public async Task e13_main()
        {
            ...
            Engine.game_save();
            Engine.wake(e13_mars_warthog0_main);
            Engine.wake(e13_cov_creep0_main);
            Engine.wake(e13_cov_ghosts1_main);
        }
        ...
        public async Task e12_event_scarab_gun()
        {
            ...
            Engine.wake(e12_cov_ghosts0_main);
            await Engine.sleep(60);
        ...
        public async Task e12_event_scarab()
        {
            ...
            Engine.wake(e12_event_warthog);
            await Engine.sleep(26);
            Engine.wake(e12_event_scarab_gun);
            Engine.wake(music_03a_066_start);
            Engine.wake(music_03a_067_start);
        ...
        public async Task e12_mars_warthog1_main()
        {
            ...
            Engine.cs_run_command_script(e12_mars_warthog0.Squad, cs_e12_mars_horrible_cleanup);
            await Engine.sleep(15);
        ...
        public async Task e12_mars_warthog0_main()
        {
            ...
            Engine.cs_run_command_script(e12_mars_warthog0.Squad, cs_e12_mars_warthog0_cleanup);
            await Engine.sleep(15);
            Engine.game_save();
        ...
        public async Task e12_main()
        {
            ...
            Engine.wake(e13_main);
            Engine.wake(e12_cov_inf0_main);
            Engine.wake(e12_cov_creep0_main);
            Engine.wake(e12_cov_ghosts0_main);
            Engine.wake(e12_mars_warthog0_main);
            Engine.wake(e12_mars_warthog1_main);
            Engine.wake(e12_mars_inf0_main);
            Engine.wake(e12_mars_inf1_main);
            Engine.wake(e12_event_scarab);
            Engine.wake(e12_cortana_dialog);
            await Engine.sleep_until(async () => this.g_e13_started);
            Engine.sleep_forever(e12_cov_inf0_main);
            Engine.sleep_forever(e12_cov_creep0_main);
            Engine.sleep_forever(e12_cov_ghosts0_main);
            Engine.sleep_forever(e12_mars_warthog0_main);
            Engine.sleep_forever(e12_mars_warthog1_main);
            Engine.sleep_forever(e12_mars_inf0_main);
            Engine.sleep_forever(e12_mars_inf1_main);
            Engine.sleep_forever(e12_event_scarab);
            Engine.sleep_forever(e12_cortana_dialog);
        ...
        {
            Engine.print("honk");
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U), Engine.ai_vehicle_get_from_starting_location(e11_mars_warthog0.warthog0), 1.5F);
            await Engine.sleep(30);
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U));
        }
        ...
        public async Task cs_e11_warthog_approach()
        {
            ...
            Engine.wake(e11_warthog_approach_horn);
        ...
        public async Task e11_cov_phantom0_main()
        {
            ...
            Engine.cs_run_command_script(e10_cov_phantom0.phantom0, cs_e11_cov_phantom0_exit);
            await Engine.sleep(120);
            Engine.game_save();
        ...
        public async Task e11_cov_inf1_main()
        {
            ...
            if (!(Engine.volume_test_objects(tv_e11_near_exit, Engine.players())))
            {
                ...
                Engine.wake(e11_cov_inf1_0_insertion0);
                await Engine.sleep(20);
                Engine.wake(e11_cov_inf1_0_insertion1);
                await Engine.sleep(10);
                if ((short)Engine.ai_living_count(covenant1) < 10)
                {
                    Engine.wake(e11_cov_inf1_0_insertion2);
                }
            }

            await Engine.sleep_until(async () => Engine.volume_test_objects(tv_e11_near_exit, Engine.players()), 10);
            Engine.wake(e11_cov_inf1_1_insertion0);
            await Engine.sleep(15);
            Engine.wake(e11_cov_inf1_1_insertion1);
            await Engine.sleep(7);
            if ((short)Engine.ai_living_count(covenant1) < 10)
            {
                Engine.wake(e11_cov_inf1_1_insertion2);
            }

            await Engine.sleep(25);
            if ((short)Engine.ai_living_count(covenant1) < 10)
            {
                Engine.wake(e11_cov_inf1_1_insertion3);
            }
        }
        ...
        public async Task e11_main()
        {
            ...
            Engine.wake(objective4_set);
            Engine.wake(e11_mars_inf0_main);
            Engine.wake(e11_mars_warthog0_main);
            Engine.wake(e11_cov_inf1_main);
            Engine.wake(e11_cov_inf2_main);
            Engine.wake(e11_cov_ghosts0_main);
            Engine.wake(e11_cov_phantom0_main);
            Engine.wake(e11_dialog);
            Engine.wake(e11_miranda_dialog);
            Engine.wake(e11_warthog_for_the_masses);
            await Engine.sleep_until(async () => this.g_e12_started);
            Engine.sleep_forever(e11_mars_inf0_main);
            Engine.sleep_forever(e11_mars_warthog0_main);
            Engine.sleep_forever(e11_cov_inf0_main);
            Engine.sleep_forever(e11_cov_inf1_main);
            Engine.sleep_forever(e11_cov_inf2_main);
            Engine.sleep_forever(e11_cov_ghosts0_main);
            Engine.sleep_forever(e11_cov_phantom0_main);
            Engine.sleep_forever(e11_dialog);
        ...
        {
            Engine.print("honk");
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U), this.g_e10_warthog, 1.5F);
            await Engine.sleep(30);
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U));
        }
        ...
        {
            Engine.cs_approach_player(10F, 100F, 100F);
            Engine.wake(e10_warthog_approach_horn);
            Engine.cs_vehicle_speed(0.5F);
            Engine.cs_approach_player(5F, 100F, 100F);
            await Engine.sleep_until(async () => await this.player_in_vehicle() || Engine.objects_distance_to_object(Engine.players(), Engine.ai_get_object(this.ai_current_actor)) > 10F || !(Engine.unit_in_vehicle(Engine.ai_get_unit(this.ai_current_actor))));
        }
        ...
        public async Task e10_cov_phantom0_main()
        {
            ...
            Engine.cs_run_command_script(e10_cov_phantom0.phantom0, cs_e10_cov_phantom0_exit);
            await Engine.sleep(120);
            Engine.game_save();
        }
        ...
        public async Task e10_main()
        {
            ...
            Engine.wake(e10_mars_warthog0_main);
            Engine.wake(e10_cov_inf0_main);
            Engine.wake(e10_cov_inf1_main);
            Engine.wake(e10_cov_ghosts0_main);
            Engine.wake(e10_cov_phantom0_main);
            await Engine.sleep_until(async () => this.g_e11_started);
            Engine.sleep_forever(e10_mars_warthog0_main);
            Engine.sleep_forever(e10_cov_inf0_main);
            Engine.sleep_forever(e10_cov_inf1_main);
            Engine.sleep_forever(e10_cov_ghosts0_main);
        ...
        {
            Engine.print("honk");
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U), this.g_e8_warthog, 1.5F);
            await Engine.sleep(30);
            Engine.sound_looping_stop(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U));
        }
        ...
        public async Task cs_e9_warthog_follow()
        {
            ...
            {
                Engine.cs_approach_player(10F, 100F, 100F);
                Engine.wake(e9_warthog_approach_horn);
                Engine.cs_vehicle_speed(0.5F);
                Engine.cs_approach_player(5F, 100F, 100F);
        ...
        public async Task e9_cortana_dialog()
        {
            ...
            await Engine.sleep_until(async () => Engine.ai_scene("e9_beach_chatter_scene", cs_e9_beach_chatter_scene, e9_mars_warthog0.Squad), 30, 300);
        }
        ...
        {
            Engine.sleep_forever(e9_retreat_checkpoint0);
            await Engine.sleep_until(async () => Engine.volume_test_objects(tv_e9_retreat_checkpoint, Engine.players()), this._30_seconds);
            Engine.game_save();
        }
        ...
        public async Task e9_cov_inf0_main()
        {
            ...
            Engine.wake(e9_retreat_checkpoint0);
        }
        ...
        public async Task e9_mars_warthog0_main()
        {
            ...
            Engine.cs_run_command_script(e9_mars_warthog0.Squad, cs_e9_warthog_abort);
            ...
            if (!(await this.player_in_vehicle()))
            {
                ...
                Engine.cs_run_command_script(Engine.object_get_ai(Engine.vehicle_driver(this.g_e8_warthog)), cs_e9_warthog_follow);
            }
        }
        ...
        public async Task e9_main()
        {
            ...
            Engine.wake(e9_music);
            Engine.wake(chapter_title1);
            Engine.wake(objective3_set);
            Engine.wake(e9_cov_inf0_main);
            Engine.wake(e9_cov_inf1_main);
            Engine.wake(e9_cov_ghosts0_main);
            Engine.wake(e9_cov_shadow0_main);
            Engine.wake(e9_mars_warthog0_main);
            Engine.wake(e9_cortana_dialog);
            Engine.wake(e9_warthog_navpoint);
            Engine.wake(e9_warthog_navpoint_kill);
            Engine.wake(e9_music);
            await Engine.sleep_until(async () => this.g_e10_started);
            Engine.sleep_forever(e9_cov_inf0_main);
            Engine.sleep_forever(e9_cov_inf1_main);
            Engine.sleep_forever(e9_cov_ghosts0_main);
            Engine.sleep_forever(e9_cov_shadow0_main);
            Engine.sleep_forever(e9_mars_warthog0_main);
            Engine.sleep_forever(e9_cortana_dialog);
            Engine.sleep_forever(e9_retreat_checkpoint0);
            Engine.sleep_forever(e9_retreat_checkpoint1);
        ...
        public async Task cs_e8_mars_warthog0_entry()
        {
            ...
            Engine.sound_looping_start(Engine.GetTag<LoopingSoundTag>("sound\\vehicles\\warthog\\warthog_horn\\warthog_horn", 4137555070U), Engine.ai_vehicle_get(this.ai_current_actor), 1.5F);
        ...
        {
            await Engine.sleep_until(async () => Engine.ai_scene("e8_warthog_intro_scene", cs_e8_warthog_intro_scene, e8_mars_warthog0.warthog0) || (short)Engine.ai_living_count(e8_mars_warthog0.warthog0) <= 0, 5, this.two_minutes);
        }
        ...
        public async Task e8_mars_inf0_main()
        {
            ...
            Engine.cs_run_command_script(e8_mars_inf0.Squad, cs_e8_mars_inf0_no_assholes);
        }
        ...
        public async Task e8_main()
        {
            ...
            Engine.game_save();
            Engine.wake(music_03a_04_stop);
            Engine.wake(objective2_clear);
            Engine.wake(e9_main);
            Engine.wake(e10_main);
            Engine.wake(e11_main);
            Engine.wake(e8_mars_inf0_main);
            Engine.wake(e8_cov_inf0_main);
            Engine.wake(e8_cov_inf1_main);
            Engine.wake(e8_cov_inf2_main);
            Engine.wake(e8_cov_phantom0_main);
            Engine.wake(e8_cov_ghosts0_main);
            Engine.wake(e8_mars_warthog0_main);
            ...
            await Engine.sleep_until(async () => this.g_e10_started);
            Engine.sleep_forever(e8_mars_inf0_main);
            Engine.sleep_forever(e8_cov_inf0_main);
            Engine.sleep_forever(e8_cov_inf1_main);
            Engine.sleep_forever(e8_cov_inf2_main);
            Engine.sleep_forever(e8_cov_phantom0_main);
            Engine.sleep_forever(e8_cov_ghosts0_main);
            Engine.sleep_forever(e8_mars_warthog0_main);
        ...
        public async Task e7_cov_inf0_main()
        {
            ...
            Engine.cs_run_command_script(e7_cov_inf0.Squad, cs_e7_abort);
            Engine.ai_set_blind(e7_cov_inf0.Squad, false);
        }
        ...
        public async Task e7_mars_inf0_main()
        {
            ...
            Engine.cs_run_command_script(e7_mars_inf0.Squad, cs_e7_hide);
            Engine.ai_disregard(Engine.ai_actors(e7_mars_inf0.Squad), true);
            Engine.ai_scene("e7_hotel_hall_scene0", cs_e7_hotel_hall_scene0, e7_mars_inf0.Squad) // Couldn't generate cast from 'Boolean' to 'Void'
            ;
            await Engine.sleep_until(async () => await this.oes_e7_spring_ambush(), 2);
            Engine.cs_run_command_script(e7_mars_inf0.Squad, cs_e7_abort);
        ...
        public async Task e6_cov_inf1_main()
        {
            ...
            await Engine.sleep_until(async () => Engine.ai_scene("e6_hotel_grunt_scene", cs_e6_hotel_grunt_scene, e6_cov_inf1.Squad), 30, this.two_minutes);
        }
        ...
        public async Task e6_mars_inf1_main()
        {
            ...
            await Engine.sleep_until(async () => Engine.ai_scene("e6_hotel_greeting_scene", cs_e6_hotel_greeting_scene, e6_mars_inf1.marine0) || (short)Engine.ai_living_count(e6_mars_inf1.marine0) <= 0 || Engine.volume_test_objects(tv_e6_hotel_entrance, Engine.players()), 5);
            await Engine.sleep(20);
            Engine.cs_run_command_script(e6_mars_inf1.marine1, cs_e6_mars_inf1_abort);
            Engine.game_save();
            await Engine.sleep_until(async () => Engine.volume_test_objects(tv_e6_hotel_entrance, Engine.players()), 15);
            Engine.cs_run_command_script(e6_mars_inf1.marine0, cs_e6_mars_inf1_abort);
        }
        ...
        public async Task e6_main()
        {
            ...
            Engine.game_save();
            Engine.wake(music_03a_03_stop);
            Engine.wake(e7_main);
            Engine.wake(e6_mars_inf0_main);
            Engine.wake(e6_mars_inf1_main);
            ...
            Engine.sleep_forever(e6_mars_inf0_main);
            Engine.sleep_forever(e6_mars_inf1_main);
        ...
        public async Task e5b_main()
        {
            ...
            if (!((bool)Engine.game_reverted()))
            {
                ...
                await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4183693118U)) && Engine.volume_test_object(tv_e5b_main, await this.player0()), 5);
                await Engine.sleep(30);
                await this.e5b_reset_player();
                Engine.wake(e5b_inf0_main);
                Engine.wake(e5b_resetter);
            }
        }
        ...
        public async Task e5_main()
        {
            ...
            Engine.wake(music_03a_03_stop);
            Engine.wake(e5_mars_inf0_main);
            Engine.wake(e5_cov_inf0_main);
            Engine.wake(e5_cov_inf1_main);
            Engine.wake(e5_cov_inf2_main);
            Engine.wake(e5_cov_inf3_main);
            Engine.wake(e5_cov_inf4_main);
            ...
            Engine.sleep_forever(e5_mars_inf0_main);
            Engine.sleep_forever(e5_cov_inf0_main);
            Engine.sleep_forever(e5_cov_inf1_main);
            Engine.sleep_forever(e5_cov_inf2_main);
            Engine.sleep_forever(e5_cov_inf3_main);
            await Engine.sleep_until(async () => (short)Engine.structure_bsp_index() == 1 || this.g_e5b_started);
        ...
        public async Task e4_main()
        {
            ...
            Engine.game_save();
            Engine.wake(music_03a_03_start);
            Engine.wake(e5_main);
            Engine.wake(e5b_main);
            Engine.wake(objective1_clear);
            Engine.wake(objective2_set);
            Engine.wake(e4_mars_inf0_main);
            Engine.wake(e4_cov_inf0_main);
            Engine.wake(e4_cov_inf1_main);
            Engine.wake(e4_cov_inf2_main);
            Engine.wake(e4_cov_snipers0_main);
            await Engine.sleep_until(async () => this.g_e5_started || this.g_e6_started);
            Engine.sleep_forever(e4_mars_inf0_main);
            Engine.sleep_forever(e4_cov_inf0_main);
            Engine.sleep_forever(e4_cov_inf1_main);
            Engine.sleep_forever(e4_cov_snipers0_main);
        ...
        {
            await Engine.sleep_until(async () => Engine.ai_scene("e3_sniper_intro_scene", cs_e3_sniper_intro_scene, e3_mars), 30, 450);
        }
        ...
        public async Task cs_e3_cov_inf0_1_intro()
        {
            ...
            Engine.wake(e3_mars_sniper_scene);
            await Engine.sleep(30);
        ...
        public async Task cs_e3_mars_johnson_exit()
        {
            ...
            ;
            await Engine.sleep(20);
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\marine", 3834970911U), "combat:rifle:wave", true);
        ...
        public async Task e3_mars_pelican0_main()
        {
            ...
            Engine.cs_run_command_script(e3_mars_pelican0.pelican0, cs_e3_mars_pelican0_entry);
            await Engine.sleep_until(async () => this.g_e3_johnson_in_pelican, 5);
            Engine.cs_run_command_script(e3_mars_pelican0.pelican0, cs_e3_mars_pelican0_exit);
        }
        ...
        public async Task e3_mars_johnson_main()
        {
            ...
            if (!(Engine.volume_test_objects(tv_e3_johnson_required, Engine.ai_actors(e3_mars_johnson.Squad))))
            {
                ...
                Engine.cs_run_command_script(e3_mars_johnson.Squad, cs_e3_mars_johnson_teleport);
            }

            await Engine.sleep_until(async () => this.g_e3_mars_pelican0_arrived, 15);
            Engine.wake(objective1_clear);
            Engine.cs_run_command_script(e3_mars_johnson.Squad, cs_e3_mars_johnson_exit);
            ...
            await Engine.sleep_until(async () => !(Engine.cs_command_script_queued(e3_mars_johnson.Squad, cs_e3_mars_johnson_exit)), 1);
            ...
            {
                Engine.cs_run_command_script(e3_mars_johnson.Squad, cs_e3_mars_johnson_slam);
            }
        ...
        public async Task e3_main()
        {
            ...
            Engine.game_save();
            Engine.wake(music_03a_01_stop);
            Engine.wake(music_03a_02_stop);
            Engine.wake(objective1_set);
            Engine.wake(e4_main);
            Engine.wake(e6_main);
            Engine.wake(e3_mars_inf0_main);
            Engine.wake(e3_mars_inf1_main);
            Engine.wake(e3_mars_johnson_main);
            Engine.wake(e3_mars_pelican0_main);
            Engine.wake(e3_cov_inf0_main);
            await Engine.sleep_until(async () => this.g_e4_started || this.g_e6_started);
            Engine.sleep_forever(e3_mars_inf0_main);
            Engine.sleep_forever(e3_mars_inf1_main);
            Engine.sleep_forever(e3_cov_inf0_main);
            Engine.sleep_forever(e3_mars_sniper_scene);
        ...
        public async Task cs_e2_cov_hunters0_taunt()
        {
            ...
            {
                Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\hunter\\hunter", 4214692103U), "combat:unarmed:shakefist", true);
                await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
            }
        }
        ...
        {
            Engine.cs_queue_command_script(this.ai_current_actor, cs_e2_cov_hunters0_taunt);
            ...
            {
                Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\hunter\\hunter", 4214692103U), "combat:unarmed:taunt", true);
                await Engine.sleep(Engine.unit_get_custom_animation_time(Engine.ai_get_unit(this.ai_current_actor)));
            }
        ...
        {
            Engine.custom_animation(Engine.ai_get_unit(this.ai_current_actor), Engine.GetTag<AnimationGraphTag>("objects\\characters\\marine\\marine", 3834970911U), "combat:rifle:hold", true);
            await Engine.sleep(10);
        ...
        public async Task e2_dialog()
        {
            ...
            Engine.cs_run_command_script(e2_mars_johnson.Squad, cs_e2_mars_johnson0_dialogue0);
        ...
        public async Task e2_cov_hunters0_main()
        {
            ...
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\materials\\hard\\metal_thin\\metal_thin_large", 4190902188U));
            Engine.sound_impulse_predict(Engine.GetTag<SoundTag>("sound\\visual_effects\\explosion_medium_metal_bits", 4267383848U));
            await Engine.sleep(30);
            Engine.device_set_position(e2_hunter_door.Entity, 0.5F);
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\materials\\hard\\metal_thin\\metal_thin_large", 4190902188U), e2_hunter_door_sound_source.Entity, 1F);
            Engine.object_damage_damage_section(e2_hunter_door.Entity, "body_hit0", 1.1F);
            Engine.object_create(e2_hunter_smoke);
            await Engine.sleep(60);
            Engine.wake(e2_dialog);
            ...
            Engine.sound_impulse_start(Engine.GetTag<SoundTag>("sound\\visual_effects\\explosion_medium_metal_bits", 4267383848U), e2_hunter_door_sound_source.Entity, 1F);
            await Engine.sleep(1);
            ...
            Engine.wake(music_03a_01_stop);
            Engine.wake(music_03a_02_start_alt);
        ...
        public async Task e2_mars_inf0_main()
        {
            ...
            Engine.cs_run_command_script(e2_mars_inf0.Squad, cs_e2_mars_inf0_watch);
        }
        ...
        public async Task e2_mars_johnson_main()
        {
            ...
            Engine.cs_run_command_script(e2_mars_johnson.Squad, cs_e2_mars_johnson0_watch);
            await Engine.sleep_until(async () => (short)Engine.ai_spawn_count(e2_cov_hunters0.Squad) > 0);
            await Engine.sleep_until(async () => (short)Engine.ai_living_count(e2_cov_hunters0.Squad) <= 0);
            Engine.cs_run_command_script(e2_mars, cs_e2_mars_continue);
        }
        ...
        public async Task e2_main()
        {
            ...
            Engine.game_save();
            Engine.wake(e2_cov_hunters0_main);
            Engine.wake(e2_mars_inf0_main);
            Engine.wake(e2_mars_johnson_main);
            await Engine.sleep_until(async () => this.g_e3_started);
            Engine.sleep_forever(e2_mars_inf0_main);
            Engine.sleep_forever(e2_mars_johnson_main);
            Engine.sleep_forever(e2_cov_inf0_main);
            Engine.sleep_forever(e2_cov_hunters0_main);
            Engine.sleep_forever(e2_dialog);
        ...
        {
            return Engine.unit_has_weapon(Engine.ai_get_unit(e1_mars_johnson.johnson0), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\sniper_rifle\\sniper_rifle.weapon", 4174845623U)) || Engine.unit_has_weapon(Engine.ai_get_unit(e1_mars_johnson.johnson0), Engine.GetTag<BaseTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle.weapon", 3788570715U));
        }
        ...
        public async Task e1_mars_pelican0_main()
        {
            ...
            Engine.cs_run_command_script(e1_mars_pelican0.pelican0, cs_e1_mars_pelican0_entry);
        ...
        public async Task e1_cov_phantom0_main()
        {
            ...
            Engine.cs_run_command_script(e1_cov_phantom0_0.phantom0, cs_e1_cov_phantom0_0_entry);
            Engine.sleep_forever();
            Engine.ai_place(e1_cov_phantom0_1.Squad);
            Engine.wake(music_03a_01_start);
        }
        ...
        public async Task e1_cov_inf2_main()
        {
            ...
            if (!(await this.difficulty_normal()))
            {
                Engine.wake(e1_cov_snipers0_main);
            }
            ...
            Engine.game_save();
            await Engine.sleep(30);
            Engine.wake(e1_cov_phantom0_main);
            Engine.wake(e1_cov_inf4_main);
        }
        ...
        public async Task e1_cov_inf0_main()
        {
            ...
            Engine.object_type_predict(Engine.GetTag<BaseTag>("objects\\characters\\grunt\\grunt", 4075753849U));
        ...
        public async Task e1_mars_johnson_main()
        {
            ...
            Engine.cs_run_command_script(e1_mars_johnson.Squad, cs_e1_mars_johnson_entry);
            ...
            Engine.cs_run_command_script(e1_mars_johnson.Squad, cs_e1_mars_johnson_finale);
            ...
            Engine.wake(music_03a_02_start);
        }
        ...
        public async Task e1_key()
        {
            ...
            await Engine.sleep_until(async () => Engine.unit_has_weapon(Engine.unit(await this.player0()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4183693118U)) && Engine.volume_test_object(tv_e1_ghost_key, await this.player0()) || Engine.unit_has_weapon(Engine.unit(await this.player1()), Engine.GetTag<BaseTag>("objects\\weapons\\multiplayer\\ball\\head_sp.weapon", 4183693118U)) && Engine.volume_test_object(tv_e1_ghost_key, await this.player1()));
        ...
        public async Task e1_main()
        {
            ...
            Engine.wake(e8_main);
            Engine.wake(e12_main);
            Engine.wake(e1_mars_johnson_main);
            Engine.wake(e1_mars_inf0_main);
            Engine.wake(e1_mars_inf1_main);
            Engine.wake(e1_cov_inf0_main);
            Engine.wake(e1_cov_phantom0_main);
            Engine.wake(e1_mars_pelican0_main);
            Engine.wake(e1_key);
            await Engine.sleep_until(async () => this.g_e2_started);
            Engine.sleep_forever(e1_cov_snipers0_main);
            await Engine.sleep_until(async () => this.g_e3_started);
            Engine.sleep_forever(e1_mars_johnson_main);
            Engine.sleep_forever(e1_mars_inf0_main);
            Engine.sleep_forever(e1_mars_inf1_main);
            Engine.sleep_forever(e1_cov_inf0_main);
            Engine.sleep_forever(e1_cov_inf1_main);
            Engine.sleep_forever(e1_cov_inf2_main);
            Engine.sleep_forever(e1_cov_inf3_main);
            Engine.sleep_forever(e1_cov_inf4_main);
            Engine.sleep_forever(e1_cov_phantom0_main);
        ...
        public async Task _03_intro_01_predict()
        {
            ...
            await Engine.sleep(8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad\\inamberclad", 3840672630U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\pelican\\pelican", 3841852296U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788111956U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788111956U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788111956U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788111956U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\cinematic_newmombasa\\cinematic_newmombasa", 3788111956U), 4);
            await Engine.sleep(113);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\capital_ship\\capital_ship", 3843359647U), 2);
            await Engine.sleep(2);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3844866998U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3844866998U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3844866998U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3844866998U), 19);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\masterchief\\masterchief", 3844866998U), 19);
            await Engine.sleep(91);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\cinematics\\human\\inamberclad_bridge\\inamberclad_bridge", 3846570960U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3850109958U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\miranda\\miranda", 3850109958U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bsp1\\bsp1", 3782934533U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bsp1\\bsp1", 3782934533U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\skies\\solo\\earthcity\\bsp1\\bsp1", 3782934533U), 2);
            await Engine.sleep(6);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 55);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 66);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 71);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 74);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 69);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 58);
        }
        ...
        public async Task _03_intro_02_predict()
        {
            ...
            await Engine.sleep(130);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 53);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 65);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 56);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 71);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 72);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\sniper_rifle\\sniper_rifle", 3856401510U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_a\\concrete_chunk_a", 3856860269U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\human\\military\\spotting_scope\\spotting_scope", 3857515639U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3857843324U), 1);
            ...
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 107);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 108);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 109);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 110);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 111);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 112);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 113);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 114);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 115);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\turrets\\chaingun\\chaingun", 3862103229U), 3);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 38);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 39);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 40);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 41);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 55);
            await Engine.sleep(4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 54);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 55);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 56);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 57);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 58);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 59);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 60);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 61);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 62);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\turrets\\chaingun\\chaingun", 3862103229U), 2);
            ...
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 4);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 7);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 8);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\turrets\\chaingun\\chaingun", 3862103229U), 1);
            await Engine.sleep(7);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 66);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 67);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 69);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 70);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 119);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 120);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 122);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 123);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 15);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\warthog\\warthog", 3859678360U), 16);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 2);
            await Engine.sleep(3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3857843324U), 0);
            await Engine.sleep(4);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 17, false);
            await Engine.sleep(6);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 6, true);
            await Engine.sleep(2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hor_facade\\sign_hor_facade", 3862824136U), 0);
            await Engine.sleep(1);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 0, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3863020747U), 0);
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 24, true);
            await Engine.sleep(10);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 22, true);
        ...
        public async Task _03_intro_03_predict()
        {
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 2);
            await Engine.sleep(10);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\helmet_standard\\helmet_standard", 3863413969U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 62);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 72);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 56);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\battle_rifle\\battle_rifle", 3788701789U), 2);
            await Engine.sleep(1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 0);
            await Engine.sleep(16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 1);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 9, true);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 14, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 73);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\sniper_rifle\\sniper_rifle", 3856401510U), 2);
            await Engine.sleep(35);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 13, true);
            await Engine.sleep(3);
        ...
        public async Task _03_intro_04_predict()
        {
            ...
            await Engine.sleep(4);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 15, false);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 16);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 17);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 18);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 19);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 20);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 21);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 22);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 23);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 24);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 25);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 26);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 27);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 28);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 29);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 30);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab", 3863479506U), 31);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\weapons\\rifle\\plasma_rifle\\plasma_rifle", 3864790246U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\residential\\holo_panels\\holo_scarab_full\\holo_scarab_full", 3865707764U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_main_gun\\scarab_main_gun", 3866494208U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3867149578U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3867477263U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3857843324U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3868067096U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\vent_wall_a\\vent_wall_a", 3869508910U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3863020747U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hor_facade\\sign_hor_facade", 3862824136U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3844408239U), 0);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 13, false);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 2);
            await Engine.sleep(13);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3867477263U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_a\\concrete_chunk_a", 3856860269U), 0);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 20, false);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 18, false);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 24, false);
            ...
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 24, true);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 21, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 6);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 7);
            await Engine.sleep(9);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\civilian\\garbage\\civ_wheel\\civ_wheel", 3870033206U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3867477263U), 3);
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 5, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\covenant\\military\\scarab\\scarab_upper_gun\\scarab_upper_gun", 3867149578U), 0);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\nature\\trees\\palmtrees\\palmtree_a\\palmtree_a", 3859154064U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3863020747U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hor_facade\\sign_hor_facade", 3862824136U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3844408239U), 0);
            await Engine.sleep(12);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\phantom\\turrets\\chin_gun\\chin_gun", 3866821893U), 4);
            ...
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\vehicles\\civilian\\panel_truck\\panel_truck", 3867477263U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_vert_facade\\sign_vert_facade", 3857843324U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\junction_box_lg\\junction_box_lg", 3868067096U), 3);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 2);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\railing\\railing", 3869771058U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3863020747U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hog\\sign_hog", 3863020747U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\signage\\sign_hor_facade\\sign_hor_facade", 3862824136U), 1);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("objects\\characters\\marine\\marine", 3852076068U), 71);
            await Engine.sleep(19);
            ...
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 9, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\junction_box_lg_garbage2\\junction_box_lg_garbage2", 3870426428U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\road_objects\\garbage\\junction_box_lg_garbage1\\junction_box_lg_garbage1", 3870491965U), 0);
            await Engine.sleep(2);
            Engine.predict_structure_section(Engine.GetReference<IBsp>("scenarios\\solo\\03a_oldmombasa\\earthcity_cine_intro_bsp"), 8, true);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_a\\concrete_chunk_a", 3856860269U), 0);
            await Engine.sleep(14);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_c\\concrete_chunk_c", 3870557502U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_b\\concrete_chunk_b", 3870885187U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_f\\concrete_chunk_f", 3870950724U), 0);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\solo\\earthcity\\concrete_chunks\\concrete_chunk_d\\concrete_chunk_d", 3871016261U), 0);
            await Engine.sleep(5);
            Engine.predict_model_section(Engine.GetTag<RenderModelTag>("scenarios\\objects\\cinematics\\cinematic_anchor\\cinematic_anchor", 3844408239U), 0);
        }
    }
